...
| --- | --- | --- |
| [[Actions/Balance\|Balance]] `pf2:1` | Untrained | You move across a narrow surface or uneven ground, attempting an Acrobatics check against its Balance DC. |
| [[Actions/Tumble Through\|Tumble Through]] `pf2:1` | Untrained | You Stride up to your Speed. |
| [[Actions/Maneuver in Flight\|Maneuver in Flight]] `pf2:1` | Trained | You try a difficult maneuver while flying. |
| [[Actions/Squeeze\|Squeeze]] | Trained | You contort yourself to squeeze through a space so small you can barely fit through. |
| **Arcana** | **Proficiency** | **Summary** |
| [[Actions/Recall Knowledge\|Recall Knowledge (Arcana)]] `pf2:1` | Untrained | You attempt a skill check to try to remember a bit of knowledge regarding a topic related to that skill. |
| [[Actions/Borrow an Arcane Spell\|Borrow an Arcane Spell]] | Trained | If you're an arcane spellcaster who prepares from a spellbook, you can attempt to prepare a spell from someone else's spellbook. |
...
| [[Actions/Climb\|Climb]] `pf2:1` | Untrained | You move up, down, or across an incline. |
| [[Actions/Force Open\|Force Open]] `pf2:1` | Untrained | Using your body, a lever, or some other tool, you attempt to forcefully open a door, window, container or heavy gate. |
| [[Actions/Grapple\|Grapple]] `pf2:1` | Untrained | You attempt to grab an opponent with your free hand. |
| [[Actions/High Jump\|High Jump]] `pf2:2` | Untrained | You Stride, then make a vertical Leap and attempt a DC 30 Athletics check check to increase the height of your jump. |
| [[Actions/Long Jump\|Long Jump]] `pf2:2` | Untrained | You Stride, then make a horizontal Leap and attempt an Athletics check to increase the length of your jump. |
| [[Actions/Reposition\|Reposition]] `pf2:1` | Untrained | You muscle a creature or object around. |
| [[Actions/Shove\|Shove]] `pf2:1` | Untrained | You push an opponent away from you. |
| [[Actions/Swim\|Swim]] `pf2:1` | Untrained | You propel yourself through water. |
| [[Actions/Trip\|Trip]] `pf2:1` | Untrained | You try to knock an opponent to the ground. |
| [[Actions/Disarm\|Disarm]] `pf2:1` | Trained | You try to knock something out of an opponent's grasp. |
| **Crafting** | **Proficiency** | **Summary** |
| [[Actions/Recall Knowledge\|Recall Knowledge (Crafting)]] `pf2:1` | Untrained | You attempt a skill check to try to remember a bit of knowledge regarding a topic related to that skill. |
| [[Actions/Repair\|Repair]] | Untrained | You spend 10 minutes attempting to fix a damaged item, placing the item on a stable surface and using the repair kit with both hands. |
| [[Actions/Craft\|Craft]] | Trained | You can make an item from raw materials. |
| [[Actions/Earn Income\|Earn Income]] | Trained | You use one of your skills to make money during downtime. |
| [[Actions/Identify Alchemy\|Identify Alchemy]] | Trained | You can identify the nature of an alchemical item with 10 minutes of testing using alchemist's tools. |
