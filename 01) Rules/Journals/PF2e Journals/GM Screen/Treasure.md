...
**Sidebar(s)** [[.f2wr86966A0oUUA0|Adjusting Treasure]]
...
*   If there are no magic item shops or other ways to purchase items and formulas, make all the permanent items core items. In this case, it might work better for your game to use [[.SnSGU7DPiogZ9JOr|Automatic Bonus Progression]] to eliminate the need for core items.
