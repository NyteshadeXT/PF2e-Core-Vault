...
abilities_top:
  - name: ""
  - name: "Description"
    desc: "Thassilonian runes set with onyx erupt with negative energy and thunderous roars at the presence of a living creature."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 35 Thievery check (master) to destroy the key rune, DC 37 Arcana check (master) to harmlessly discharge the runes, or [[Spells/Dispel Magic|Dispel Magic]] (7th level; counteract DC 31) to counteract the trap"
attacks:
  - name: ""
