...
cssClasses: pf2e
aliases: "Compendium.pf2e.shadows-at-sundown-bestiary.Actor.0jAkZcP5559iO0wo" 
tags:
...
perception:
  - name: "Perception"
    desc: "+27; Darkvision"
languages: "Chthonian, Common, Diabolic, Jotun, Necril, Shadowtongue, Thassilonian, Varisian"
skills:
  - name: "Skills"
    desc: "Acrobatics: +27, Arcana: +29, Athletics: +25, Deception: +27, Occultism: +27, Society: +25, Stealth: +29, Thassilon Lore: +29"
abilityMods: [6, 8, 4, 8, 4, 6]
speed: 25 feet,  fly 25 feet
sourcebook: "_Pathfinder Adventure: Shadows at Sundown_"
ac: 37
armorclass:
  - name: AC
    desc: "37; __Fort__ +25, __Ref__ +29, __Will__ +27"
hp: 210
health:
  - name: ""
  - name: HP
    desc: "210, coffin restoration, fast healing 15, void healing; __Immunities__  death effects,  disease,  paralyzed,  poison,  sleep; __Resistances__ physical 15 (except magical silver weapons or magical weapons shedding bright light)"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Bands of Force (Greater)|Bracers of Armor II]], [[Equipment/Ring of Wizardry (Type IV)|Ring of Wizardry (Type IV)]]"
abilities_mid:
  - name: ""
  ...
  - name: "Slip Into Shadows"
    desc: "`pf2:r` (divine) **Trigger** Aliriel succeeds at a save against an effect that is not a darkness or light effect\n**Effect** Aliriel disappears into shadows at the last moment, critically succeeding at the save instead."
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Claw +29 (agile, magical)\n__Damage__  3d10 + 12 slashing plus grab"

  - name: "Wizard Spells Prepared"
    desc: "DC 36, attack +28; __8th __  _[[Spells/Desiccate|Horrid Wilting]]_, _[[Spells/Quandary|Maze]]_; __7th __  _[[Spells/Eclipse Burst|Eclipse Burst]]_; __6th __  _[[Spells/Cursed Metamorphosis|Baleful Polymorph]]_, _[[Spells/Vampiric Exsanguination|Vampiric Exsanguination]]_, _[[Spells/Wall of Force|Wall of Force]]_; __5th __  _[[Spells/Toxic Cloud|Cloudkill]]_, _[[Spells/Mind Probe|Mind Probe]]_, _[[Spells/Sending|Sending]]_, _[[Spells/Umbral Journey|Shadow Walk]]_; __4th __  _[[Spells/Translocate|Dimension Door]]_, _[[Spells/Nightmare|Nightmare]]_; __3rd __  _[[Spells/Blindness|Blindness]]_, _[[Spells/Mind Reading|Mind Reading]]_, _[[Spells/Slow|Slow]]_; __2nd __  _[[Spells/Deafness|Deafness]]_, _[[Spells/Dispel Magic|Dispel Magic]]_, _[[Spells/Mirror Image|Mirror Image]]_, _[[Spells/Ghostly Carrier|Spectral Hand]]_; __1st __  _[[Spells/Grim Tendrils|Grim Tendrils]]_, _[[Spells/Force Barrage|Magic Missile]]_, _[[Spells/Enfeeble|Ray of Enfeeblement]]_, _[[Spells/Sure Strike|True Strike]]_\n__Cantrips__  __(8th)__ _[[Spells/Void Warp|Chill Touch]]_, _[[Spells/Detect Magic|Detect Magic]]_, _[[Spells/Electric Arc|Electric Arc]]_, _[[Spells/Telekinetic Hand|Mage Hand]]_, _[[Spells/Prestidigitation|Prestidigitation]]_"

  - name: "Wizard School Spells"
    desc: "3 Focus Points, DC 36, attack +28; __8th __  _[[Spells/Call of the Grave|Call of the Grave]]_, _[[Spells/Overstuff|Overstuff]]_, _[[Spells/Take its Course|Take its Course]]_"

  - name: "Rituals"
    desc: "_[[Spells/Call Spirit|Call Spirit]]_, _[[Spells/Create Undead|Create Undead]]_, _[[Spells/Binding Circle|Planar Binding]]_"
