...
abilities_top:
  - name: ""
  - name: "Description"
    desc: "The sand conceals a rune that summons an invisible stalker into this yard."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 25 Acrobatics check to approach without triggering the trap followed by DC 25 Arcana check (expert) or DC 27 Thievery check (expert) to erase the rune, or [[Spells/Dispel Magic|Dispel Magic]] (4th level; counteract DC 25) to counteract the rune"
attacks:
  - name: ""
