...
health:
  - name: ""
  - name: HP
    desc: "120; __Immunities__  bleed,  paralyzed,  poison,  sleep,  swarm mind; __Weaknesses__ area damage 10, splash damage 10; __Resistances__ bludgeoning 5, electricity 10, piercing 10, slashing 10"
abilities_top:
  - name: ""
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Tendril +19 (reach 60 feet, versatile b)\n__Damage__  2d8 + 9 piercing"
  ...
  - name: "Battle Form"
    desc: "`pf2:2` (concentrate,polymorph) **Requirements** The nanoshard swarm is in swarm form\n**Effect** The nanoshard swarm coalesces into a Huge shape that looks like a humanoid or beast and can hold items. In battle form, its Speed is 15 feet, it's [[Conditions/Clumsy 1|Clumsy 1]], and it has the following Strike.\n**Melee** `pf2:1` limb (reach 20 feet), **Damage** 4d8+9 bludgeoning"

  - name: "[[Bestiary Ability Glossary/Engulf|Engulf (Swarm Form)]]"
    desc: "`pf2:2`  DC 27 Reflex check, 2d8 + 6 bludgeoning damage, Escape DC 27, Rupture 18\n"
