...
cssClasses: pf2e
aliases: "Compendium.pf2e.lost-omens-impossible-lands-bestiary.Actor.gZ2qX5vbWg7otMVT" 
tags:
...
abilities_mid:
  ...
  - name: "Vulnerable to Banishment"
    desc: "  Casting a [[Spells/Banishment|Banishment]] spell on a Quantium golem disrupts its connection to the Crux of Nex. If targeted by such a spell, the golem is [[Conditions/Enfeebled 1|Enfeebled 1]] and [[Conditions/Slowed 1|Slowed 1]] for 1d4 rounds."

attacks:
  - name: ""

  - name: "Melee"
    desc: "`pf2:1` Bastard Sword +39 (magical, two-hand d12)\n__Damage__  3d8 + 18 slashing"

  - name: "Ranged"
    desc: "`pf2:1` Eye Beam +36 (magical, range 120 feet)\n__Damage__  4d8 acid 4d8 fire"
