...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.9qjXP1Lho1UmAihJ" 
tags:
...
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Warhammer|+1 Striking Warhammer]], [[Equipment/Artisan's Toolkit (Sterling)|Artisan's Tools (Sterling)]]"
abilities_mid:
  - name: ""
attacks:
  - name: ""
  ...
  - name: "Melee"
    desc: "`pf2:1` Warhammer +20 (magical, shove)\n__Damage__  2d8 + 11 bludgeoning 1d6 spirit"

  - name: "Melee"
    desc: "`pf2:1` Fist +17 (agile, magical)\n__Damage__  1d8 + 5 bludgeoning 1d6 spirit"

  - name: "Divine Innate Spells"
    desc: "DC 27, attack +17; __5th __  _[[Spells/Telekinetic Haul|Telekinetic Haul]]_; __4th __  _[[Spells/Dispel Magic|Dispel Magic]]_, _[[Spells/Divine Wrath|Divine Wrath]]_, _[[Spells/Lightning Bolt|Lightning Bolt (x3)]]_; __3rd __  _[[Spells/Haste|Haste (x3)]]_, _[[Spells/Paralyze|Paralyze]]_; __2nd __  _[[Spells/Telekinetic Maneuver|Telekinetic Maneuver]]_; __1st __  _[[Spells/Sure Strike|True Strike (At Will)]]_\n__Cantrips__  __(4th)__ _[[Spells/Telekinetic Projectile|Telekinetic Projectile]]_"

  - name: "Crystalline Dust Form"
    desc: "`pf2:1` (polymorph) The axiomite shifts between its humanoid form and that of a cloud of crystalline dust in which strange symbols and equations flash.\nIn this form it gains a fly Speed of 40 feet and can fit through even tiny apertures, similarly to [[Spells/Vapor Form|Vapor Form]]. It can cast spells, but it can't make melee or ranged attacks in this state.\nIt can return to its humanoid form by using this action while in crystalline dust form.\n[[Bestiary Effects/Effect_ Crystalline Dust Form|Effect: Crystalline Dust Form]]"
