---
title: "Chimera (Red Dragon)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.ScNPruIwcIJNuSHb" 
tags:
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Dragon Jaws +20 ()\n__Damage__  2d6 + 9 piercing 2d6 fire"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane) The chimera breathes a 30-foot cone of fire that deals 9d6 fire damage to all creatures in the area (DC 26 Reflex check save).\nThe chimera can't use Breath Weapon again for 1d4 rounds."

  - name: "Draconic Bite"
    desc: "  A chimera's red dragon head deals an extra 2d6 fire damage _(already included)_."
