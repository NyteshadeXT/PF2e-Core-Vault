---
title: "Ancient White Dragon (Spellcaster)"
...
statblock: inline
name: "Ancient White Dragon (Spellcaster)"
level: 15
license: OGL
---
...
abilities_mid:
  ...
  - name: "Freezing Blood"
    desc: "`pf2:r` (arcane,cold) **Trigger** An adjacent creature deals piercing or slashing damage to the dragon.\n**Effect** The dragon's blood sprays on the creature, dealing 3d6 cold damage. A creature that takes cold damage in this way is [[Conditions/Slowed 1|Slowed 1]] for 1 round."
...
name: Ancient White Dragon (Spellcaster)
creatures:
  - 1: Ancient White Dragon (Spellcaster)
```
