---
title: "Blue Viper (Level 16)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.fists-of-the-ruby-phoenix-bestiary.Actor.SF6OlCfNiHvtJQjw" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +31, Athletics: +18, Deception: +25, Diplomacy: +23, Stealth: +29, Thievery: +27"
abilityMods: [0, 5, 6, 5, 2, 1]
speed: 25 feet
sourcebook: "_Pathfinder #167: Ready? Fight!_"
ac: 36
armorclass:
  - name: AC
    desc: "36; __Fort__ +30, __Ref__ +29, __Will__ +24"
hp: 300
health:
  - name: ""
  - name: HP
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Shortsword +29 (agile, finesse, magical, versatile s)\n__Damage__  3d6 + 8 piercing"

  - name: "Ranged"
    desc: "`pf2:1` Greater Acid Flask +31 (acid, alchemical, bomb, consumable, range increment 20 feet, splash)\n__Damage__  1 acid 3d6 acid 3 acid"

  - name: "Ranged"
    desc: "`pf2:1` Greater Alchemist&#x27;s Fire +31 (alchemical, bomb, consumable, fire, range increment 20 feet, splash)\n__Damage__  3d8 fire 3 fire 3 fire"

  - name: "Ranged"
    desc: "`pf2:1` Greater Bottled Lightning +31 (alchemical, bomb, consumable, electricity, range increment 20 feet, splash)\n__Damage__  3d6 electricity 3 electricity"

  - name: "Ranged"
    desc: "`pf2:1` Greater Frost Vial +31 (alchemical, bomb, cold, consumable, range increment 20 feet, splash)\n__Damage__  3d6 cold 3 cold"
