...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Fist +27 (agile, magical, reach 15 feet, unholy)\n__Damage__  3d8 + 12 bludgeoning 2d6 acid"

  - name: "Ranged"
    desc: "`pf2:1` Acid Missile +29 (acid, magical, range increment 60 feet, reload 0, unholy)\n__Damage__  3d8 + 10 acid"

  - name: "Ranged"
    desc: "`pf2:1` Shortbow +31 (deadly 2d10, range increment 60 feet, unholy)\n__Damage__  3d6 piercing"
