...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 24 Thievery check (expert) to erase a rune, or [[Spells/Dispel Magic|Dispel Magic]] (3rd level; counteract DC 24) to dispel a rune; all three runes must be erased or dispelled to disable the trap."
attacks:
  - name: ""
