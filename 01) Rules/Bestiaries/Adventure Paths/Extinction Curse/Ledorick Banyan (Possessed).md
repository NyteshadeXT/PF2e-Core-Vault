---
title: "Ledorick Banyan (Possessed)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.extinction-curse-bestiary.Actor.xGTl3DVCD0etE6MU" 
tags:
...
armorclass:
  - name: AC
    desc: "36; __Fort__ +28, __Ref__ +26, __Will__ +22"
hp: 260
health:
  - name: ""
  - name: HP
...
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Composite Longbow|+1 Striking Composite Longbow]], [[Equipment/Ranseur|Bokrug's Lashing Tail]], [[Equipment/Chain Shirt|+1 Resilient Chain Shirt]], [[Equipment/Ring of Sustenance|Ring of Sustenance]], [[Equipment/Healing Potion (Moderate)|Healing Potion (Moderate)]], 40x [[Equipment/Arrows|Arrows]]"
abilities_mid:
  - name: ""
  ...
  - name: "Possessed"
    desc: "  Ledorick is possessed by the dybbuk [[Extinction Curse/Lyrt Cozurn|Lyrt Cozurn]], and he is controlled by the dybbuk. However, Ledorick's personality is strong; each time Ledorick takes Hit Point damage, Lyrt takes half of this damage as well (reduced by his Resistances, if applicable)."
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Ranseur +29 (disarm, magical, reach)\n__Damage__  3d10 + 13 piercing"
