...
abilities_top:
  - name: ""
  - name: "Description"
    desc: "The haze conceals a rune that summons a krooth in front of the door to area B10."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 24 Acrobatics check to approach without triggering the trap followed by DC 26 Thievery check (expert) to erase the rune, or [[Spells/Dispel Magic|Dispel Magic]] (4th level; counteract DC 24) to counteract the rune."
attacks:
  - name: ""
