...
abilities_mid:
  - name: ""
  - name: "Dreadful Spite"
    desc: "`pf2:r`  **Trigger** The wight cultist is reduced to 0 Hit Points\n**Effect** The wight makes a Strike before being destroyed. It doesn't gain any temporary HP from drain life on this Strike. A creature hit by this Strike is also [[Conditions/Doomed 1|Doomed 1]] for 1 minute."
...
attacks:
  ...
  - name: "Drain Life"
    desc: " (divine) When the wight damages a living creature with its claw or ranseur Strike, the wight gains 12 temporary Hit Points and the creature must succeed at a DC 29 Fortitude check save or become [[Conditions/Drained 1|Drained 1]]. Further damage dealt by the wight increases the amount of drain by 1 on a failed save, to a maximum of [[Conditions/Drained 1|Drained 4]]."

  - name: "Wight Spawn"
    desc: " (divine) A living humanoid slain by a wight's claw or ranseur Strike rises as a wight after 1d4 rounds. This wight spawn is under the command of the wight that killed it. It doesn't have drain life or wight spawn and becomes [[Conditions/Clumsy 1|Clumsy 2]] for as long as it is a wight spawn. If the creator of the wight spawn dies, the wight spawn becomes a full-fledged, autonomous wight; it regains its free will, gains drain life and wight spawn, and is no longer clumsy."
