...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 40 Thievery check (master) to remove the animating magic without triggering the trap, or [[Spells/Dispel Magic|Dispel Magic]] (8th level; counteract DC 38) to counteract the animating magic"
attacks:
  - name: ""
