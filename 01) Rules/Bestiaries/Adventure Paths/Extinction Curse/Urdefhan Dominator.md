---
title: "Urdefhan Dominator"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.extinction-curse-bestiary.Actor.5G8Iokror8QtBhbx" 
tags:
...
armorclass:
  - name: AC
    desc: "35; __Fort__ +25, __Ref__ +25, __Will__ +29"
hp: 250
health:
  - name: ""
  - name: HP
    desc: "250, void healing; __Immunities__  disease,  fear effects; __Weaknesses__ vitality 15"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Rhoka Sword|+2 Striking Rhoka Sword]]"
  - name: "Eyes of the Enthralled"
    desc: "`pf2:1` (concentrate) **Requirements** The urdefhan dominator has a creature dominated with its [[Spells/Dominate|Dominate]] innate spell\n**Effect** The urdefhan taps into the dominated creature's sight, hearing, and any other senses it has. The urdefhan can change back and forth from its own senses to the target's senses as a single action, which has the concentrate trait."
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Rhoka Sword +26 (fatal d10, magical, two-hand d12)\n__Damage__  2d8 + 10 slashing"

  - name: "Melee"
    desc: "`pf2:1` Jaws +26 (agile)\n__Damage__  4d6 + 10 piercing plus wicked-bite"
