...
perception:
  - name: ""
  - name: "Stealth DC 35" 
    desc: "(master) to notice runes marked on the floor."
abilities_top:
  - name: ""
  - name: "Description"
    desc: "Barely visible runes are etched into the stone floor in a 20-foot diameter circle."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 36 Acrobatics check to approach without triggering the trap followed by DC 34 Occultism check (expert) or DC 38 Thievery check (master) to erase the rune, or [[Spells/Dispel Magic|Dispel Magic]] (8th level; counteract DC 34) to counteract the rune."
attacks:
  - name: ""
