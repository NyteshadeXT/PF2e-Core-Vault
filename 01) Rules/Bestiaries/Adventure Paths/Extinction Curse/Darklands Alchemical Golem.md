---
title: "Darklands Alchemical Golem"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.extinction-curse-bestiary.Actor.bJUlb2DxT1xyaYAp" 
tags:
...
armorclass:
  - name: AC
    desc: "29; __Fort__ +22, __Ref__ +21, __Will__ +17"
hp: 170
health:
  - name: ""
  - name: HP
    desc: "170; __Immunities__  acid,  bleed,  death effects,  disease,  doomed,  drained,  fatigued,  healing,  nonlethal attacks,  paralyzed,  poison,  sickened,  spirit,  unconscious,  vitality,  void,  mental; __Resistances__ physical 12 (except adamantine or bludgeoning)"
abilities_top:
  - name: ""
...
abilities_mid:
  ...
  - name: "Alchemical Chambers"
    desc: "  An alchemical golem's body contains six alchemical chambers filled with different substances. When an alchemical golem ability calls upon a randomly determined alchemical effect, roll 1d6 and consult the following:\n| 1d6 | Alchemical Effect |\n| --- | --- |\n| 1 | Acid Damage |\n| 2 | Cold Damage |\n| 3 | Electricity Damage |\n| 4 | Fire Damage |\n| 5 | Poison Damage |\n| 6 | Sickness: DC 28 Fortitude check save or [[Conditions/Sickened 1|Sickened 1]] ([[Conditions/Sickened 1|Sickened 2]] on a critical failure) |"

  - name: "Alchemical Rupture"
    desc: "  When an alchemical golem takes physical damage from a critical hit or is affected by a [[Spells/Shatter|Shatter]] spell, one glass chamber within its body shatters, spewing alchemical liquid in a 5-foot emanation.\nRoll on the alchemical chambers list to determine which one shatters-on a roll of 1-5, creatures in the area take 10d6 damage of the appropriate type (DC 30 Reflex check). On a roll of 6, creatures must instead save against the sickness effect.\n| 1d6 | Alchemical Effect |\n| --- | --- |\n| 1 | 10d6 acid damage DC 30 Reflex check |\n| 2 | 10d6 cold damage DC 30 Reflex check |\n| 3 | 10d6 electricity damage DC 30 Reflex check |\n| 4 | 10d6 fire damage DC 30 Reflex check |\n| 5 | 10d6 poison damage DC 30 Reflex check |\n| 6 | Sickness: DC 28 Fortitude check save or [[Conditions/Sickened 1|Sickened 1]] ([[Conditions/Sickened 1|Sickened 2]] on a critical failure) |"

  - name: "Crystalline Construction"
    desc: "  Crafted in areas where glass is rare, the Darklands alchemical golem instead incorporates crystalline components. The golem's vulnerable to shatter ability functions only for [[Spells/Shatter|Shatter]] spells of at least 4th level."
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Syringe +24 (magical, reach 10 feet)\n__Damage__  2d10 + 8 piercing plus alchemical-injection"

  - name: "Ranged"
    desc: "`pf2:1` Bomb +22 (magical, thrown 20 ft.)\n__Damage__ "
