...
perception:
  - name: ""
  - name: "Stealth DC 50" 
    desc: "(master) to notice that the hairline cracks on the passage walls actually form runes."
abilities_top:
  - name: ""
  - name: "Description"
    desc: "Nearly imperceptible runes set off an explosion at the point a thief is most unable to receive aid."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 45 Thievery check (master) or [[Spells/Dispel Magic|Dispel Magic]] (10th level, counteract DC 50) to counteract the runes"
attacks:
  - name: ""
  ...
  - name: "Reset"
    desc: "The trap resets in 1 minute."
```
