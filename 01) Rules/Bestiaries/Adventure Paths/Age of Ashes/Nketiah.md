...
cssClasses: pf2e
aliases: "Compendium.pf2e.age-of-ashes-bestiary.Actor.NK49bh04355Lgz5r" 
tags:
...
languages: "Common, Draconic, Elven, Empyrean, Fey, Mwangi"
skills:
  - name: "Skills"
...
armorclass:
  - name: AC
    desc: "23; __Fort__ +8, __Ref__ +13, __Will__ +12; +1 status to all saves vs. mental"
hp: 74
health:
  - name: ""
  - name: HP
    desc: "74; __Immunities__  sleep"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Longbow|+1 Striking Longbow]], [[Equipment/Verdant Staff|Verdant Staff]], [[Equipment/Studded Leather Armor|Studded Leather Armor]], 2x [[Equipment/Black Adder Venom|Black Adder Venom]], 20x [[Equipment/Arrows|Arrows]]"
abilities_mid:
  - name: ""
attacks:
  - name: ""
  ...
  - name: "Primal Innate Spells"
    desc: "DC 24, attack +14\n__Cantrips__  __(3rd)__ _[[Compendium.pf2e.spells-srd.Item.kl2q6JvBZwed4B6v|Dancing Lights]]_, _[[Spells/Detect Magic|Detect Magic]]_, _[[Spells/Vitality Lash|Disrupt Undead]]_, _[[Spells/Tangle Vine|Tanglefoot]]_"

  - name: "Bard Composition Spells"
    desc: "2 Focus Points, DC 24, attack +14; __3rd __  _[[Spells/Counter Performance|Counter Performance]]_, _[[Spells/Loremaster's Etude|Loremaster's Etude]]_\n__Cantrips__  __(3rd)__ _[[Spells/Uplifting Overture|Inspire Competence]]_, _[[Spells/Courageous Anthem|Inspire Courage]]_"

  - name: "Arborean Arm"
    desc: " (primal) This magical limb functions in all ways as Nketiah's original arm. The arm can extend a vine to attack in melee, and using the arm, Nketiah has a climb Speed of 20 feet and Climbs as if she had master proficiency in Athletics. Finally, the arm's primal magic allows her to use the spells from her verdant staff as if she had all of those spells on her spell list."

  - name: "Woodland Elf"
    desc: "  Nketiah can move at half her Speed on a successful Climb check and at full Speed on a critical success. She can always [[Actions/Take Cover|Take Cover]] within forest terrain to gain cover, even if she's not next to a wall or obstacle."

  - name: "Woodland Stride"
    desc: "  Nketiah ignores difficult terrain caused by plants."
