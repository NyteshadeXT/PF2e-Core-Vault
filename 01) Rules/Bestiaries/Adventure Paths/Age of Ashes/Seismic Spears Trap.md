...
abilities_top:
  - name: ""
  - name: "Description"
    desc: "Lines of searing lava lance through the area, causing targets to shake as if caught in an earthquake and potentially become petrified."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 43 Thievery check (master) to disable the wards or [[Spells/Dispel Magic|Dispel Magic]] (9th level; counteract DC 38) to counteract the ward."
attacks:
  - name: ""
  ...
  - name: "No MAP"
    desc: "passive The Seismic Spear Strikes do not apply a MAP."
