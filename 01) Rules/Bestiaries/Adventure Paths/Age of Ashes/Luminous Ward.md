...
abilities_top:
  - name: ""
  - name: "Description"
    desc: "A burst of radiance explodes from the door."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 40 Thievery check (master) to disable the wards or [[Spells/Dispel Magic|Dispel Magic]] (9th level; counteract DC 38) to counteract the ward"
attacks:
  - name: ""
