---
title: "Vice-Chancellor Vikroti Stroh"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.blood-lords-bestiary.Actor.KJm77VlSLPNpukcI" 
tags:
...
perception:
  - name: "Perception"
    desc: "+33; Darkvision"
languages: "Chthonian, Common, Diabolic, Draconic, Kelish, Necril, Osiriani"
skills:
  - name: "Skills"
    desc: "Academia Lore: +35, Arcana: +35, Crafting: +35, Deception: +31, Diplomacy: +31, Intimidation: +31, Religion: +35, Society: +35, Stealth: +31"
abilityMods: [4, 6, 5, 9, 9, 6]
speed: 25 feet
sourcebook: "_Pathfinder #186: Ghost King&#x27;s Rage_"
ac: 39
armorclass:
  - name: AC
    desc: "39; __Fort__ +27, __Ref__ +28, __Will__ +36"
hp: 245
health:
  - name: ""
  - name: HP
    desc: "245, void healing, rejuvenation; __Immunities__  cold,  death effects,  disease,  paralyzed,  poison,  unconscious; __Resistances__ physical 20 (except magical bludgeoning)"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Wand of the Snowfields (7th-Level Spell)|Wand of the Snowfields (7th-Level Spell)]]"
abilities_mid:
  - name: ""
...
attacks:
  ...
  - name: "Cold Beyond Cold"
    desc: "  Vikroti's hand Strike deals cold damage, and the target is [[Conditions/Slowed 1|Slowed 2]]. A successful DC 44 Fortitude check save reduces this to [[Conditions/Slowed 1|Slowed 1]] (or negates on a critical success)."

  - name: "Counterspell"
    desc: "`pf2:r`  **Trigger** A creature casts a spell Vikroti has prepared\n**Effect** Vikroti expends a prepared spell to counter the triggering creature's casting of that same spell. She loses her spell slot as if she'd cast the triggering spell. Vikroti then attempts to counteract the triggering spell."

  - name: "Death's Chill"
    desc: " (aura,cold) 15 feet. Vikroti is surrounded by an unnatural chill. Creatures that enter or begin their turn within the aura take 5d10 cold damage and are [[Conditions/Clumsy 1|Clumsy 2]] (DC 37 Fortitude check)."

  - name: "[[Creature Family Ability Glossary/(Lich) Drain Soul Cage|Drain Soul Cage]]"
    desc: "  **Frequency** once per day\n**Effect** Vikroti taps into her _[[Equipment/Lich Soul Cage|Soul Cage's]]_ power to cast any arcane spell up to the highest level she can cast, even if the spell being cast isn't one of her prepared spells. Her _soul cage_ doesn't need to be present for her to use this ability."

  - name: "Steady Spellcasting"
    desc: "  If a reaction would disrupt Vikroti's spellcasting action, Vikroti attempts a DC 15 Flat check. On a success, the action isn't disrupted."
...
name: Vice-Chancellor Vikroti Stroh
creatures:
  - 1: Vice-Chancellor Vikroti Stroh
```
