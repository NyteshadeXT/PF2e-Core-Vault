...
cssClasses: pf2e
aliases: "Compendium.pf2e.stolen-fate-bestiary.Actor.KxJBLDk06713Aupl" 
tags:
...
attacks:
  ...
  - name: "[[Creature Family Ability Glossary/(Harrowkin) Harrowkin Suit|Harrowkin Suit (Stars)]]"
  ...
  - name: "Summon Servants"
    desc: "`pf2:3` (occult) **Frequency** once per day\n**Effect** The Queen Mother calls forth dozens of her servants. These servants can speak the same languages as the Queen Mother. She can command her servants as a free action, and they can undertake the same basic actions as an [[Bestiary 1/Phantasmal Minion|Unseen Servant]]. On the Queen's command, the servants can gather into a troop to protect their queen in a process that takes 1 round (use statistics for a [[Bestiary 3/Terra-Cotta Garrison|Terra-Cotta Garrison]]). The servant troop fights to the death to defend their queen."
