---
title: "All-Seeing Hajeck"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.stolen-fate-bestiary.Actor.okLgvERf3ul8JxKk" 
tags:
...
skills:
  - name: "Skills"
    desc: "Arcana: +21, Deception: +25, Diplomacy: +23, Fortune-Telling Lore: +25, Occultism: +23, Performance: +23, Society: +21, Thievery: +21"
abilityMods: [4, 5, 5, 5, 4, 7]
speed: 30 feet,  climb 30 feet,  swim 30 feet
sourcebook: "_Pathfinder #191: The Destiny War_"
ac: 31
armorclass:
  - name: AC
    desc: "31; __Fort__ +21, __Ref__ +23, __Will__ +22; +1 status to all saves vs. magic"
hp: 215
health:
  - name: ""
  - name: HP
    desc: "215; __Immunities__  controlled; __Resistances__ mental 10"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Harrow Deck (Common)|Harrow Deck (Common)]]"
abilities_mid:
  - name: ""
  - name: "Harrowbound"
    desc: "  Hajeck can only exist in the Harrow Court. If she leaves the plane, either willingly or by succumbing to an effect that forces her into a different plane, she instead immediately reappears somewhere in Harrowheart and becomes [[Conditions/Drained 1|Drained 2]]."
