---
title: "Animated Cookware Swarm"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.season-of-ghosts-bestiary.Actor.WHb1ycftTkk1QNoJ" 
tags:
...
attacks:
  ...
  - name: "Slice and Pound"
    desc: "`pf2:1` (magical) Each enemy in the animated cookware swarm's space takes 1d6 points of bludgeoning or slashing damage (DC 17 Reflex check save)."
...
name: Animated Cookware Swarm
creatures:
  - 1: Animated Cookware Swarm
```
### Description
Variant animated silverware swarm
