...
cssClasses: pf2e
aliases: "Compendium.pf2e.season-of-ghosts-bestiary.Actor.dGKC9fWrGLTI7zP3" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +5, Intimidation: +4"
abilityMods: [-5, 3, 0, -3, 3, 0]
speed:  fly 40 feet
...
health:
  - name: ""
  - name: HP
    desc: "6; __Immunities__  disease,  paralyzed,  poison,  precision; __Resistances__ all damage 1 (except force or ghost touch; double resistance vs. non-magical)"
abilities_top:
  - name: ""
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Beak +7 (finesse, force, magical)\n__Damage__  1d6 force"
