...
health:
  - name: ""
  - name: "HP"
    desc: "100; __Hardness__ 25; __Immunities__  object immunities,  critical hits,  precision"
perception:
  - name: ""
  - name: "Stealth DC 37" 
    desc: "(expert)"
abilities_top:
  - name: ""
  - name: "Description"
    desc: "A hidden needle delivers a magical poison to anyone trying to open the door."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 32 Thievery check (master) to jam the needle in its housing or [[Spells/Dispel Magic|Dispel Magic]] (6th level, counteract DC 30) to dispel the magical poison."
attacks:
  - name: ""
