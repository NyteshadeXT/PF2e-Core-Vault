...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Warhammer +38 (magical, shove)\n__Damage__  3d8 + 20 bludgeoning"

  - name: "Ranged"
    desc: "`pf2:1` Dagger +34 (agile, finesse, magical, thrown 10 ft., versatile s)\n__Damage__  1d4 + 20 piercing"
  ...
  - name: "Crystallize Blood"
    desc: "`pf2:2` (divine) Ulressia channels her warped powers over crystals through her blade and into a creature's body, partially crystallizing its blood.\nUlressia makes a melee dagger Strike. On a hit, the creature takes damage as normal and must also roll a DC 41 Fortitude check save.\n**Critical Success** The creature is unaffected.\n**Success** The creature is [[Conditions/Drained 1|Drained 1]].\n**Failure** The creature is [[Conditions/Drained 1|Drained 1]], plus [[Conditions/Slowed 1|Slowed 1]] for 1 round.\n**Critical Failure** The creature is [[Conditions/Drained 1|Drained 2]], plus [[Conditions/Slowed 1|Slowed 1]] for 1d4 rounds."

  - name: "Stunning Strike"
    desc: "`pf2:1`  **Requirements** Ulressia hit a foe earlier this turn with a weapon Strike\n**Effect** Ulressia makes a weapon Strike against the foe. On a success, the foe must succeed at a DC 41 Fortitude check save or become [[Conditions/Stunned 1|Stunned 1]]. On a critical failure, the foe is [[Conditions/Stunned 1|Stunned 2]] instead."
