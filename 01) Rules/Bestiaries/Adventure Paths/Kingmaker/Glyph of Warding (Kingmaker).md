---
title: Glyph of Warding (Kingmaker)
noteType: pf2eHazard
tags:
  - magical
  - trap
...
abilities_top:
  - name: ""
  - name: "Description"
    desc: "An hourglass-shaped glyph flashes with mauve light, then seems to quickly drain its sand away, as if to indicate time has suddenly run out."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 34 Thievery check (trained) to remove the glyph without triggering it, or [[Spells/Dispel Magic|Dispel Magic]] (7th level, counteract DC 34) to counteract the glyph."
attacks:
  - name: ""
