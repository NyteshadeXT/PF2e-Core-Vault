...
health:
  - name: ""
  - name: HP
    desc: "450; __Immunities__  acid,  auditory,  cold,  critical hits,  electricity,  fire,  force,  mental,  petrified,  poison,  precision,  sonic,  unconscious,  visual"
abilities_top:
  - name: ""
...
attacks:
  ...
  - name: "Prismatic Touch"
    desc: " (arcane) A creature hit by the prismatic ooze's pseudopod or Grabbed by the prismatic ooze at the start of the ooze's turn experiences an additional effect depending on which color the ooze is at that moment. The creature is then immune to Prismatic Touch until the start of the ooze's next turn.\nRoll 1d8 to determine which color affects the target. If the color has been counteracted (see Prismatic Vulnerability), then Prismatic Touch has no effect. Each effect is DC 38.\n*   **1\. Red**: 3d6 fire damage (basic Reflex save)\n*   **2\. Orange**: 3d8 acid damage (basic Reflex save)\n*   **3\. Yellow**: 4d6 electricity damage  (basic Reflex save)\n*   **4\. Green**: 2d6 poison damage plus Enfeebled 1 for 1 minute (basic Fortitude save; no enfeebled on a success)\n*   **5\. Blue**: Flesh to Stone Will\n*   **6\. Indigo**: _Warp Mind_ Will\n*   **7\. Violet**: The target is Slowed 1 for 1 minute. A successful Will save negates; on a critically failed save, the target is sent to another plane, with the effect of _Plane Shift_.\n*   **8\. Potent Strike:** The target is affected by two colors-roll twice, rerolling duplicates or results of 8."

  - name: "Consume Magic"
    desc: "`pf2:1`  **Requirements** A creature Grabbed by the prismatic ooze is affected by an ongoing spell;\n**Effect** The prismatic ooze attempts to counteract (counteract modifier +27 and counteract level 8) the highest-level spell affecting the grabbed creature. If successful, the spell is counteracted and the prismatic ooze regains 30 Hit Points."

  - name: "Dazzling Burst"
    desc: "`pf2:1` (visual) **Frequency** once per minute;\n**Effect** Each creature in a 30-foot burst must attempt a Fortitude save. A creature is Dazzled for 1 round on a success, Blinded for 1 round on a failure, and blinded for 1 minute on a critical failure."
