---
title: "Springjaw Doll"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.battlezoo-bestiary-pf2e.pf2e-battlezoo-bestiary.Actor.81ikSl9fGtratx2B" 
tags:
...
armorclass:
  - name: AC
    desc: "16; __Fort__ +10, __Ref__ +7, __Will__ +2"
hp: 25
health:
  - name: ""
  - name: HP
    desc: "25; __Immunities__  bleed,  death effects,  disease,  doomed,  drained,  fatigued,  healing,  mental,  nonlethal attacks,  paralyzed,  poison,  sickened,  unconscious,  spirit,  vitality,  void; __Weaknesses__ electricity 3"
abilities_top:
  - name: ""

  - name: "Nondescript Doll"
...
attacks:
  ...
  - name: "Gnaw"
    desc: "  A creature grabbed by the springjaw doll's jaw takes 1d4 persistent bleed damage as long as it is grabbed."
...
**Springjaw Doll Creature 1**

**Monster Parts** 3.5/7/13 gp

**Eligible Refinements** weapons (bludgeoning, piercing), armor (light), perception item, skill items (Athletics, Stealth)

**Eligible Imbued Properties** bane, dexterity, energy resistant (negative, positive), sensory (darkvision), sonic, strength, wild
