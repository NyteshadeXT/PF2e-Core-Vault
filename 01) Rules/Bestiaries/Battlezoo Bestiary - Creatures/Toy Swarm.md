...
attacks:
  ...
  - name: "Miniature Barrage"
    desc: "`pf2:1`  Each enemy in the toy swarm's space takes 1d6 piercing damage (basic Reflex save). Creatures that fail their save also take 1d4 persistent bleed damage."
