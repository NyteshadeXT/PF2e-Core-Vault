...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 18 Occultism check (trained) or DC 18 Religion check (trained) to convince the spirit of the wood the message has been understood"
attacks:
  - name: ""
