...
abilities_top:
  - name: ""
  - name: "Description"
    desc: "Ornate full-length mirrors with fiendish filigree depict the image of Fasiel ibn Sazadin in villainous triumph over his enemies."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 27 Stealth check (trained) to approach a mirror without showing up in the reflection, followed by DC 25 Thievery check to cover mirror or dispel magic (3nd level; counteract DC 25) to counteract the binding"
attacks:
  - name: ""
