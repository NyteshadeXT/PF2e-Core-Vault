...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "Two DC 25 Survival check (trained) checks to find roots and tree limbs sturdy enough for everyone to use as escape paths ends the hazard's threat to all creatures in the area"
attacks:
  - name: ""
