...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 28 Crafting check or DC 28 Thievery check (expert) to rig up a dummy or other object to distract one of the trap's sensors, or DC 26 Nature check (trained) to temporarily befuddle one of the sensors with knowledge of primal magic.\nAlternatively, inserting the correct key into an alcove's keyhole disables that alcove's sensor."
attacks:
  - name: ""
