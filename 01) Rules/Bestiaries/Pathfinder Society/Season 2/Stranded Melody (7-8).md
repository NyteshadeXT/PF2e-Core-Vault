...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 27 Performance check (expert) twice to duplicate the melody and appease the elemental, or DC 30 Arcana check (expert) and then DC 27 Diplomacy check (trained) to guide the elemental through a planar tear elsewhere in the manor. Each attempt to Disable the hazard requires two actions, and each successful check to Disable removes one action from the hazard's routine."
attacks:
  - name: ""
