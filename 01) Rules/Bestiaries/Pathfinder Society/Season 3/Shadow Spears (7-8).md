...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 27 Thievery check (trained) to remove pieces from the mosaic without triggering the magic or [[Spells/Dispel Magic|Dispel Magic]] (4th level; counteract DC 23) to counteract the rune"
attacks:
  - name: ""
  - name: "Melee"
