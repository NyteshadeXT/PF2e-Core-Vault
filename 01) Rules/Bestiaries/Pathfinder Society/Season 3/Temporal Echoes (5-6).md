---
title: "Temporal Echoes (5-6)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-3-bestiary.Actor.2jiOLCpHekITyQTQ" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +10, Athletics: +11, Stealth: +10"
...
armorclass:
  - name: AC
    desc: "20; __Fort__ +9, __Ref__ +14, __Will__ +11"
hp: 60
health:
  - name: ""
  - name: HP
...
attacks:
  ...
  - name: "Temporal Shudder"
    desc: "`pf2:2` (occult) The temporal echo screams, causing time to shudder and bend around it. All creatures in a 10-foot emanation take 5d6 mental damage (DC 18 Will check save). Creatures that fail the saving throw are also [[Conditions/Slowed 1|Slowed 1]] for 1 round. The echo can't use Temporal Shudder again for 1d4 rounds."
