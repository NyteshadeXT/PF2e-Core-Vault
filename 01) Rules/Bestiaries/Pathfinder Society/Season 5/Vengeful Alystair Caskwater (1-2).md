---
title: "Vengeful Alystair Caskwater (1-2)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-5-bestiary.Actor.nMMRUST4ow0kcbTy" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +8, Athletics: +2, Crafting: +10, Society: +4, Stealth: +10"
...
armorclass:
  - name: AC
    desc: "19; __Fort__ +13, __Ref__ +8, __Will__ +7"
hp: 50
health:
  - name: ""
  - name: HP
...
abilities_mid:
  ...
  - name: "[[Actor.gWYbmi3JoXdSn3ch.Item.h0VU0sBf5jz6KCu1|The Void's Revenge]]"
    desc: " (curse,divine) A creature that slays Alystair is subjected to a [[Spells/Mariner's Curse|Mariner's Curse]] spell with a DC 19 Will check save. The curse ends if the draugr is buried in a calm sea or after 1 week passes."

attacks:
  - name: ""

  - name: "Melee"
    desc: "`pf2:1` Greatsword +12 (versatile p)\n__Damage__  1d10 + 6 slashing plus grotesque-gift"
...
name: Vengeful Alystair Caskwater (1-2)
creatures:
  - 1: Vengeful Alystair Caskwater (1-2)
```
### Description
