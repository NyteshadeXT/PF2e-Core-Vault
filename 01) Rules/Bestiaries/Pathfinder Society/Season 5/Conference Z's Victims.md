...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 30 Medicine check or Society to determine 287's first or surname through the journal text or DC 32 Occultism check or Religion to connect with the spiritual energy bound to the journal to find her name. Two successes are needed, one for each part of 287's name."
attacks:
  - name: ""
