---
title: "Ancient Underworld Dragon (Spellcaster)"
...
attacks:
  ...
  - name: "Scorch Earth"
    desc: "`pf2:2` (arcane,fire) The dragon plunges their body into the ground, Burrows up to their Speed, and then scorches the land within a 60-foot emanation.\nCreatures underground or on the surface in the area take 8d6 fire damage (DC 37 Fortitude check save), and those who critically fail become [[Conditions/Enfeebled 1|Enfeebled 1]] for 1 minute."
...
name: Ancient Underworld Dragon (Spellcaster)
creatures:
  - 1: Ancient Underworld Dragon (Spellcaster)
```
