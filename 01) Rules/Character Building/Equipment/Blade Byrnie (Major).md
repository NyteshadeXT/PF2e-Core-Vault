...
tags:
  ...
  - trait/common
  - category/light
aliases: "Compendium.pf2e.equipment-srd.Item.fHkVbTtjhITsE2NJ"
license: OGL
---
# Blade Byrnie (Major)
## Item 19
...
**Effect** You pull a link from the armor, which transforms into a _+3 greater striking [[Equipment/Dagger|Dagger]]_. The dagger disappears and reappears as a link in the armor after you Strike with it, or at the end of this turn if you don't make a Strike. You can Activate the blade byrnie in place of an Interact action to draw a weapon for abilities such as the [[Quick Draw|Quick Draw]] feat.
