...
You can use [[Prescient Planner|Prescient Planner]] even if you have already used it after purchasing goods, and you can use it as a single action instead of a 2-action activity, during which you [[Actions/Interact|Interact]] to draw the item.
