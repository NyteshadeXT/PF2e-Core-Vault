...
You become an expert in Nature and can use Nature instead of Crafting to [[Actions/Craft|Craft]] herbal items. You don't need to be trained in Crafting or have the [[Alchemical Crafting|Alchemical Crafting]] feat to do so, and you can use a [[Equipment/Healer's Toolkit|Healer's Toolkit]] instead of an [[Equipment/Alchemist's Toolkit|Alchemist's Toolkit]].

**Special** You can't select another dedication feat until you have gained two other feats from the [[Compendium.pf2e.journals.JournalEntry.vx5FGEG34AxI2dow.JournalEntryPage.Rrjz5tMJtyVEQnh8|Herbalist]] archetype.
