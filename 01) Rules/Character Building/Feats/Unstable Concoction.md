...
When you use [[01) Rules/Character Building/Feats/Quick Alchemy|Quick Alchemy]], you can create an alchemical item from your formula book whose level is up to 2 higher than your advanced alchemy level. You can spend up to 3 additional batches of [[Class Features/Infused Reagents|Infused Reagents]] when creating this item to stabilize it.
