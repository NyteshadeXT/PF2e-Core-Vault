...
tags:
  - trait/rare
aliases: "Compendium.pf2e.backgrounds.Item.uker8dnTA7WhzXSR"
license: OGL
---
# Close Ties
...
You're trained in the Diplomacy skill and the Tea Lore skill. You gain the [[Specialty Crafting|Specialty Crafting]] skill feat (choose a specialty associated with your allied NPC), and your allied NPC begins with an attitude of friendly toward the party (rather than indifferent, which is the initial norm for all Willowshore NPCs).

[[Adventure-Specific Actions/Seasonal Boon (Close Ties)|Seasonal Boon (Close Ties)]]
