...
Your deviant abilities are of the dragon classification. You gain the [[Consume Energy|Consume Energy]] deviant feat with the cold type. As a quirk, your deviant abilities manifest in a silver hue, and when you use a deviant ability you absorb the color silver from your surroundings. The absorbed color returns to your surroundings within an hour.

Choose two ability boosts. One must be to **Charisma** or **Dexterity**, and one is a free ability boost.

You're trained in the Thievery skill and the Games Lore skill. You gain the [[Subtle Theft|Subtle Theft]] skill feat.
