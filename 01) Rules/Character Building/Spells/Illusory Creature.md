...
tags:
  ...
  - trait/common
  - remaster
aliases: "Compendium.pf2e.spells-srd.Item.f8SBoXiXQjlCKqly" 
---
# Illusory Creature  `pf2:2`  
## Spell 2
...
Any creature that touches the image or uses the [[Actions/Seek|Seek]] action to examine it can attempt to disbelieve your illusion. When a creature disbelieves the illusion, it recovers from half the damage it had taken from it (if any) and doesn't take any further damage from it.
