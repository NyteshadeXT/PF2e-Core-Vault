...
tags:
  ...
  - trait/shadow
  - trait/common
aliases: "Compendium.pf2e.spells-srd.Item.VTb0yI6P1bLkzuRr" 
---
# Shadow Raid  `pf2:3`  
## Spell 7
### [[concentrate]][[illusion]][[manipulate]][[01) Rules/Bestiaries/Bestiary 1/Shadow]]
...
**Duration** 1 minute
* * * 
You spin illusions of flying shadows throughout the area. The shadows strike and cavort, harming your foes and blocking their vision with twisting shadow. Enemies in the area when you Cast the Spell take 6d8 bludgeoning, piercing, or slashing damage, with a Reflex check or Will check save, as shadows explode into being. You choose the damage type when you Cast the Spell, and each creature chooses the type of save it attempts before it rolls the save. The shadows then persist in the area for 1 minute, dealing 3d8 damage of the type you chose to any enemy that ends its turn in the area. All creatures are [[Conditions/Concealed|Concealed]] to enemies in the area, as the illusory shadows swarm over them and block light.
