...
tags:
  ...
  - trait/uncommon
  - ritual
aliases: "Compendium.pf2e.spells-srd.Item.3DB3F2hIx2dMbX8n" 
---
# The World's a Stage   
## Ritual 5
### [uncommon](uncommon "Uncommon Rarity Trait")[[fortune]]

**Cast** 1 day**Cost** costumes and a stage large enough to fit all casters;
...
**Critical Failure** The performance is a dramatic and horrendous botch, and fate strikes out at the casters. You and each secondary caster are [[Conditions/Doomed 1|Doomed 1]] for the next month, and this condition can't be removed by anything less than a wish or similarly powerful magic.
