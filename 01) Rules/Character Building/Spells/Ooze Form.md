...
tags:
  ...
  - trait/polymorph
  - trait/common
aliases: "Compendium.pf2e.spells-srd.Item.0gdZrT9lwO17EIxc" 
---
# Ooze Form  `pf2:2`  
## Spell 3
...
*   [[Spell Effects/Spell Effect_ Ooze Form (Black Pudding)|Black Pudding]] Speed 15 feet, climb 15 feet;
    *   **Melee** `pf2:1` pseudopod, **Damage** 2d6+5 bludgeoning and 1d8 acid.
*   [[Spell Effects/Spell Effect_ Ooze Form (Gelatinous Cube)|Gelatinous Cube]] Speed 15 feet;
    *   **Melee** `pf2:1` cube face, **Damage** 1d6+5 acid;
    *   a creature hit by your cube face Strike must succeed at a Fortitude save against your spell DC or be [[Conditions/Stunned 1|Stunned 1]] (or [[Conditions/Paralyzed|Paralyzed]] for 1 round on a critical failure); this save has the incapacitation trait.
*   [[Spell Effects/Spell Effect_ Ooze Form (Gray Ooze)|Gray Ooze]] Speed 15 feet, climb 15 feet, swim 15 feet
    
    *   **Melee** `pf2:1` pseudopod, **Damage** 1d6+5 bludgeoning and 1d6 acid, and you can spend an action after a hit to [[Bestiary Ability Glossary/Grab|Grab]] the target.

*   [[Spell Effects/Spell Effect_ Ooze Form (Ochre Jelly)|Ochre Jelly]] Speed 15 feet, climb 10 feet; resistance 5 to electricity;
    *   **Melee** `pf2:1` pseudopod, **Damage** 1d8+5 bludgeoning and 1d8 acid, and you can spend an action after a hit to [[Bestiary Ability Glossary/Grab|Grab]] the target.
