...
tags:
  ...
  - trait/common
  - remaster
aliases: "Compendium.pf2e.spells-srd.Item.1K6AYGisvo9gqdhs" 
---
# Elemental Form  `pf2:2`  
## Spell 5
...
*   **Water**
    ...
    *   **Melee `pf2:1`** wave, **Damage** 1d12 bludgeoning, and you can spend an action immediately after a hit to push the target 5 feet with the effects of a successful [[Actions/Shove|Shove]].
*   **Wood**
...
[[Spell Effects/Spell Effect_ Elemental Form|Spell Effect: Elemental Form]]
