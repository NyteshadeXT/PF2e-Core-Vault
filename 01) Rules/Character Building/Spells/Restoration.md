...
tags:
  ...
  - trait/manipulate
  - trait/common
aliases: "Compendium.pf2e.spells-srd.Item.SnaLVgxZ9ryUFmUr" 
---
# Restoration   
## Spell 2
### [[concentrate]][[exploration]][[healing]][[manipulate]]
...
*   **Reduce a Condition** Reduce the value of the target's [[Conditions/Clumsy 1|Clumsy]], [[Conditions/Enfeebled 1|Enfeebled]], or [[Conditions/Stupefied 1|Stupefied]] condition by 2. You can instead reduce two of the listed conditions by 1 each.

* * *

**Heightened (4th)** Add [[Conditions/Drained 1|Drained]] to the list of conditions you can reduce. When you lessen a toxin, reduce the stage by two. You also gain a third option that allows you to reduce the target's [[Conditions/Doomed 1|Doomed]] value by 1. You can't use this to reduce a permanent Doomed condition.
