...
tags:
  ...
  - trait/manipulate
  - trait/common
aliases: "Compendium.pf2e.spells-srd.Item.DcmWrD0V5PWQQyDm" 
---
# Variable Gravity  `pf2:2`  
## Spell 4
...
*   **High Gravity** You become encumbered. You gain a +2 status bonus to your saving throws and DCs to resist forced movement and attempts to knock you [[Conditions/Prone|Prone]]. You reduce the distance forced movement moves you by half or 10 feet, whichever is more. You can only jump half as high and far. Rather than the normal calculation for falling damage, you take bludgeoning damage equal to the distance you fall. Abilities that adjust how much falling damage you take still apply. [[Spell Effects/Spell Effect_ Variable Gravity (High Gravity)|Spell Effect: Variable Gravity (High Gravity)]]
