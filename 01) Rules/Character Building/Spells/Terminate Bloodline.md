...
tags:
  ...
  - trait/uncommon
  - ritual
aliases: "Compendium.pf2e.spells-srd.Item.yUM5OYeMY8971b2S" 
---
# Terminate Bloodline   
## Ritual 6
...
**Cost** a bodily sample from the target, and valuables belonging to the target worth a total value of 100 gp × the spell rank × the target's level
**Primary Check** Occultism (master)
**Secondary Checks** Society
**Range** 10 miles
**Targets** 1 creature of a level no greater than double the terminate bloodline ritual&#x27;s level
* * * 
...
**Stage 2** [[Conditions/Fatigued|Fatigued]] (1 week)

**Stage 3** fatigued and [[Conditions/Drained 1|Drained 1]] (1 day)

**Stage 4** fatigued and [[Conditions/Drained 1|Drained 3]] (1 day)
