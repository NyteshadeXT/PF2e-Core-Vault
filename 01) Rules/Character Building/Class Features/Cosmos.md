...
You are treated as one size smaller for wind effects. You gain a +2 status bonus against [[Actions/Trip|Trip]] attempts, you only take half as much damage from falls, and you gain the effects of the [[Powerful Leap|Powerful Leap]] and [[Quick Jump|Quick Jump]] skill feats. You weigh only half as much, and your Bulk, should someone need to carry you, is also half as much.
...
You can walk on liquids as if they were solid; you gain the effects of the [[Cloud Jump|Cloud Jump]] skill feat; and you don't leave tracks, trigger weight-sensitive pressure plates, or otherwise connect with the ground below you.
