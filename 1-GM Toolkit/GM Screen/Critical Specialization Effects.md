...
| **Bow** | If the target of the critical hit is adjacent to a surface, it gets stuck to that surface by the missile. The target is [[Immobilized\|Immobilized]] and must spend an [[Actions/Interact\|Interact]] action to attempt a DC 10 Athletics check check to pull the missile free; it can't move from its space until it succeeds. The creature doesn't become stuck if it is incorporeal, is liquid (like a water elemental or some oozes), or could otherwise escape without effort. |
...
| **Flail** | The target is knocked [[Prone\|Prone]]. |
...
| **Sling** | The target must succeed at a Fortitude save against your class DC or be [[Stunned\|Stunned]] 1. |
| **Spear** | The weapon pierces the target, weakening its attacks. The target is [[Clumsy\|Clumsy]] 1 until the start of your next turn. |
| **Sword** | The target is made off-balance by your attack, becoming [[Off-Guard\|Off-Guard]] until the start of your next turn. |