...
> 
> The first step in upgrading weapons with monster parts is gathering suitable parts. After a battle, a player with the proper harvesting tools (either [[chimeric-harvesting-tools|Monster Harvesting Tools]] or [[superior-chimeric-harvesting-tools|Superior Monster Harvesting Tools]]) can spend 10 minutes per size category of the creature gathering the monsters’ parts beginning with small. 
>
> ### Standard Harvest
...
>>>| **Targeted Harvest Check Result** | `INPUT[inlineSelect(option(1, Critical Success), option(0.003, Success), option(0.002, Failure), option(0.001, Critical Failure)):refineRoll]`|
>>>| **Harvest Result** | `VIEW[({refineRoll} >= 1 ? "The GM randomly selects 2 rare parts from the creatures Harvest Table." : ({refineRoll} >= 0.003 ? "The GM randomly selects 1 rare part from the creatures Harvest Table." : ({refineRoll} >= 0.002 ? "No rare parts are recovered, but you gain 1d4 additional monster parts due to incidental salvage." : ({refineRoll} <= 0.001 ? "The corpse is too degraded to yield more value.  No additional parts are harvested." : ""))))]` |
>>
...
>> The party’s alchemist, Mira, has just returned from a brutal encounter in the fungal depths of the Hollow Scar. Among the spoils: parts from a [[great-wroggi|Great Wroggi]]—notably its **venom sac**, **spiny hide**, and a **glowing gland** from beneath its throat. While the rest of the party rests, Mira unfurls her [[superior-chimeric-harvesting-tools|Superior Chimeric Harvesting Tools]] and sets up her tent for experimentation. Her first attempt yields nothing—but she notes how the venom destabilizes under heat. On her second attempt, she adjusts her process. By the third, she begins to understand the creature’s inner workings. When she finally succeeds, the formula comes together quickly—her earlier failures guiding the breakthrough. The Great Wroggi is a level 6 Beast, so Mira attempts a [[Skills#Nature|Nature]] or [[skills#Arcana]] check against DC 20. Though she fails her first attempt, her continued experimentation grants her a +1 bonus on her next attempt. After multiple attempts and mounting insight, she succeeds and records the new formula in her codex.
> 
> A character may attempt to discover a unique crafting formula tied to a specific creature by conducting magical or alchemical experimentation with its harvested parts. This process requires 8 hours of downtime and must be performed using either [[chimeric-harvesting-tools|Chimeric Harvesting Tools]] or [[superior-chimeric-harvesting-tools|Superior Monster Harvesting Tools]]. At the end of this period, the character attempts a skill check using [[Skills#Arcana|Arcana]], [[Skills#Nature|Nature]], [[Skills#Crafting|Crafting]], or an appropriate [[Skills#Lore|Lore]] skill, as determined by the creature’s traits. 
> 
> Discovery is a process of trial, error, and growing understanding. Even failed attempts contribute toward eventual success. Each time a character attempts Discovery using parts from a specific creature, track their Discovery Progress for that creature.
> 
> ### Progress Rules
> - Each attempt consumes 25% of the Discovery Cost in monster parts (20% with [[superior-chimeric-harvesting-tools|Superior Monster Harvesting Tools]]).
> - On a failed attempt, the character gains +2 cumulative circumstance bonus to future Discovery checks for that creature and you recover 10% of the parts used as stabilized residue which may be reused normally. On a Critical Failure, no materials can be recovered.
> - This bonus increases by +2 for every additional 25% of the Discovery Cost invested through failed attempts.
> - Discovery Progress resets when a formula is successfully discovered.
> 
> Once a character has invested monster parts equal to 100% of the Discovery Cost across multiple attempts the next Discovery attempt is automatically treated as a Success (not a Critical Success) ensuring that persistent experimentation always leads to a breakthrough.
> 
...
>>| **Check Result** | `INPUT[inlineSelect(option(1, Critical Success), option(0.003, Success), option(0.002, Failure), option(0.001, Critical Failure)):discoveryRoll]`|
>>| **Consequence** | `VIEW[({discoveryRoll} >= 1 ? "Discover 2 new formulas from the creature." : ({discoveryRoll} >= 0.003 ? "Discover 1 new formula." : ({discoveryRoll} >= 0.002 ? "No formula discovered; gain Discovery Progress and recover partial materials." : ({discoveryRoll} <= 0.001 ? "No formula discovered; parts are consumed, and the crafter becomes Clumsy 1 for 1 hour due to magical backlash or cognitive fatigue." : ""))))]` |
>
>>[!column | 2 no-t]
...
>>> | d6 | Backlash Effect |
>>> |----|------------------|
>>> | 1  | Crafter becomes [[Clumsy\|Clumsy 1]] for 24 hours. |
>>> | 2  | Crafter is [[Fatigued]] until they rest for 8 hours. |
>>> | 3  | Crafter is [[Stupefied\|Stupefied 1]] for 24 hours. |
...
>>> | 6  | Arcane backlash damages the [[bestial-crafter’s-codex\|Bestial Crafter’s Codex]], preventing use until repaired (Crafting DC 20 to repair). |
