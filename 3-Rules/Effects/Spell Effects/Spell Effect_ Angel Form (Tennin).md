...
title: "Spell Effect: Angel Form (Tennin)"
cssclasses: pf2e,pf2e-spell
tags:
  - trait/common
aliases: "Compendium.pf2e.spell-effects.Item.qcrUH9YItV0eujQB"
license: OGL
---
# Spell Effect: Angel Form (Tennin)
## Level 7
### 
...
*   **Tennin** Speed 30 feet, fly 60 feet; can Step into difficult terrain and use land and fly Speeds to Step;
    ...
    *   **Melee** `pf2:1` fist (agile, holy, magical, nonlethal), **Damage** 1d6+12 bludgeoning plus 1d6 cold and 1d6 spirit.
