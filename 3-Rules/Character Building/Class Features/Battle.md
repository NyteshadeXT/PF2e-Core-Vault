...
**Granted Spells** cantrip: [[Spells/Shield|Shield]]; 1st: [[Spells/Sure Strike|Sure Strike]]; 2nd: [[Spells/Telekinetic Maneuver|Telekinetic Maneuver]]; 4th: [[Spells/Weapon Storm|Weapon Storm]]

**Revelation Spells** initial: [[Spells/Weapon Trance|Weapon Trance]]; advanced: [[Spells/Battlefield Persistence|Battlefield Persistence]]; greater: [[Spells/Revel in Retribution|Revel in Retribution]]
