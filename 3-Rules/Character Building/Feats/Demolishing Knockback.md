...
If the forced movement doesn't cause the target to collide with an object, the target must succeed at a Reflex check saving throw against your class DC or be knocked [[Prone|Prone]] at the end of the movement.
