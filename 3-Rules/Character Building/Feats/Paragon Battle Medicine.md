...
When you successfully use Battle Medicine, you can also reduce the target's [[Sickened|Sickened]], [[Enfeebled|Enfeebled]], or [[Clumsy|Clumsy]] condition by 1 (this has no effect if you are subject to an effect continually applying the clumsy condition, like enlarge).

If you are legendary in Medicine, you can choose to reduce the target's [[Frightened|Frightened]] or [[Stunned|Stunned]] condition by 1 instead, and if you have the [[Feats/Godless Healing|Godless Healing]] feat, you can choose to reduce the target's [[Stupefied|Stupefied]] or [[Drained|Drained]] condition by 1 instead.
