...
tags:
  ...
  - trait/manipulate
  - trait/rare
aliases: "Compendium.pf2e.spells-srd.Item.z39jFoNJrobyn3MQ" 
---
# Undertaker  `pf2:2`  
## Spell 9
### [rare](rare "Rare Rarity Trait")[[concentrate]][[death]][[manipulate]]
...
**Failure** The target takes 80 void damage. If the target is in contact with solid ground, the ground in the target's space churns and cracks open into an open but shallow grave. The target is knocked [[Conditions/Prone|Prone]], and that space is treated as difficult terrain until the grave is filled in.
