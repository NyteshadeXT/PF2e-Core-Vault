...
tags:
  ...
  - trait/manipulate
  - trait/uncommon
aliases: "Compendium.pf2e.spells-srd.Item.xxhS66k68u5iIOHC" 
---
# Upheaval  `pf2:2`  
## Spell 9
...
**Success** The creature takes half the collapse damage and falls [[Conditions/Prone|Prone]].

**Failure** The creature takes the full collapse damage and falls prone.

**Critical Failure** The creature takes the full collapse damage and is [[Conditions/Restrained|Restrained]] by debris until it successfully Escapes (DC equal to the spell's save DC).
