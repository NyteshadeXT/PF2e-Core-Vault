...
tags:
  ...
  - trait/uncommon
  - ritual
aliases: "Compendium.pf2e.spells-srd.Item.nEXkk85BQu1cREa4" 
---
# Garden of Death   
## Ritual 4
### [uncommon](uncommon "Uncommon Rarity Trait")[[consecration]][[plant]][[poison]]
...
**Secondary Checks** Crafting, Medicine
**Area** 40-foot burst
**Duration** 1 year
* * * 
...
The maximum level of plants or animals called by the ritual is equal to its spell rank, and the called plants and animals can use the ritual's spell DC instead of their own poison DC, whichever is higher. The garden's residents don't willingly use their poison on you or the secondary casters, but you don't otherwise control or command them.

* * *

**Critical Success** A poisonous garden forms, and you and the secondary casters gain a +2 circumstance bonus to Nature or Crafting checks to deal with the plants or animals, such as feeding them or harvesting poison from them. [[Spell Effects/Spell Effect_ Garden of Death (Critical Success)|Spell Effect: Garden of Death (Critical Success)]]
