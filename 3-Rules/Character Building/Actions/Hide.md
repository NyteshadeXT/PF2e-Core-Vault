...
You huddle behind cover or greater cover or deeper into concealment to become [[Hidden|Hidden]], rather than [[Observed|Observed]]. The GM rolls your [[Actions/hide|hide]]{Stealth} check in secret and compares the result to the Perception DC of each creature you're observed by but that you have cover or greater cover against or are [[3-Rules/Conditions/Concealed|Concealed]] from. You get a +2 circumstance bonus to your check if you have standard cover (or +4 from greater cover).

* * *

**Success** If the creature could see you, you're now [[Hidden|Hidden]] from it instead of [[Observed|Observed]]. If you were hidden from or [[Undetected|Undetected]] by the creature, you retain that condition.
