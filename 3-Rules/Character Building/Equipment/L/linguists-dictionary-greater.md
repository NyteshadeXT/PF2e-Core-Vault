...
mechanics1: "The grimoire absorbs knowledge of one language translated this way (caster's choice if more than one), allowing its bearer to communicate on a rudimentary level in that language even after the spell's duration has elapsed. The _greater linguist's dictionary_ can hold three languages at a time."
powerTitle2:
actionEconomy2:
type2:
frequency2:
