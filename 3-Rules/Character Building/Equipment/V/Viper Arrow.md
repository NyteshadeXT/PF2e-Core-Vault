...
After an activated viper arrow hits a target, the arrow transforms into a [[3-Rules/Bestiaries/Bestiary 1/V/Viper|Viper]]. The target is affected by the viper's poison, as if it had been bitten. The viper then lands in an open space adjacent to the target.
