...
description: "Carved in this wooden disc is a humanoid eye, painted in muted shades
  ...
  undetected, the DC of your flat check to target it is 3 if the target is concealed
  or 9 if it's hidden or undetected.  **Activate** Cast a Spell  * * *  **Effect**
  You cast [[Spells/Detect Magic|Detect Magic]].  **Activate** Cast a Spell  **Frequency**
  once per day  * * *  **Effect** You cast [[Spells/Clairvoyance|Clairvoyance]]."
powerTitle1:
actionEconomy1:
type1:
frequency1:
