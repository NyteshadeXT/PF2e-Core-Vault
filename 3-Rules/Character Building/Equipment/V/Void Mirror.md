...
tags:
  ...
  - trait/magical
  - trait/unique
aliases: "Compendium.pf2e.equipment-srd.Item.YiitcoNxawdhTO1e"
license: OGL
---
# Void Mirror
## Item 20
...
**Research** Accumulate 12 RP by making DC 20 Occultism check (expert) checks when Researching (1 week per attempt)
...
**Research** Accumulate 12 RP by making DC 30 Occultism check (master) checks when Researching (1 month per attempt)
...
**Critical Failure** As failure, but magical feedback from the failed activation causes the user to become [[Conditions/Stunned|Stunned 3]].

* * *

**Activate** 7 days (Interact)

**Research** Accumulate 12 RP by making DC 40 Occultism check (legendary) checks when Researching (1 year per attempt)
