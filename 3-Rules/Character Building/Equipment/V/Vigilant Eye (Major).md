...
*   **Weapon** When you make a Strike with the weapon against a target that's [[3-Rules/Conditions/Concealed|Concealed]], hidden, or undetected, the DC of your flat check to target it is 2 if the target is concealed or 8 if it's hidden or undetected.
