...
Void shackles can be placed on incorporeal creatures as if they were not incorporeal. An incorporeal creature manacled by _void shackles_ cannot pass through solid objects. Even a soul can be [[Restrained|Restrained]] via _void shackles_, provided the soul was of a 17th- or lower-level creature in life. A soul held in _void shackles_ cannot move on to the afterlife, cannot become undead, and can be transported by simply transporting the shackles.
