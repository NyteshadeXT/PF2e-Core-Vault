...
**Effect** You fire the _breath blaster_, dealing 10d6 damage of the appropriate type in the appropriate area. Creatures in the area must attempt a DC 38 Reflex check save (or DC 38 Fortitude check save if the damage is poison).
