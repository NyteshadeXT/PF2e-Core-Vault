...
**Effect** You fire the breath blaster, dealing 4d6 untyped damage of the appropriate type in the appropriate area. Creatures in the area must attempt a DC 24 Reflex check save (or DC 24 Fortitude check save if the damage is poison).
