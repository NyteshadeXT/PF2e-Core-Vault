...
A keg contains 5,000 doses of black powder and can be detonated in the same way as a [[Black Powder (Horn)|Black Powder (Horn)]]. As long as the keg is mostly full (at least 4,000 doses remaining) this deals 3d6 fire damage in a @Template\[burst|distance:20\] (DC 20 Reflex check save). Detonating multiple kegs can increase the area, but not the damage, of this effect; detonating a keg and any horns at the same time in an overlapping area also doesn't increase the damage.
