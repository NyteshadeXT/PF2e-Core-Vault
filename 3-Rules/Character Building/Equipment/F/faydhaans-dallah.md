...
trait07: ""
trait08: ""
image: zz-Attachments/faydhaans-dallah.png
level: 14
weight: 1
value: "4250"
subvalue: "gp"
...
license: "ORC"
identify:
description: "Noble faydhaan shuyookhs serve coffee brewed in ornate dallahs such as this one to welcome guests in their courts. Most nobles have their kitchen staff import the beans at great expense from other planes then roast the beans with local ingredients gathered on the Plane of Water to create a brew unique to their locale. A _faydhaan's dallah_ has the name of a specific faydhaan shuyookh engraved on the bottom and typically comes with six drinking cups, a platter, and a selection of coffee beans."
powerTitle1: "brew"
actionEconomy1: 3
...
powerTitle2: "Faydhaan's Hospitality"
actionEconomy2: 2
type2: "([[concentrate]])"
frequency2: "once per day"
requirement2: "You used the dallah's activation to brew a batch of coffee today"
trigger2:
mechanics2: "You speak the name of the faydhaan shuyookh inscribed on the dallah. You don't need to be holding the dallah to use this activation. The shuyookh transmutes the coffee within the body of each creature who partook from the batch you brewed, choosing a single common potion of 6th level or lower, which grants them all the benefits of that potion. Typically, the shuyookh chooses a [[healing-potion-(moderate)|Healing Potion (Moderate)]], [[potion-of-resistance-(lesser)|Potion of Resistance (Lesser)]], or [[potion-of-swimming|Potion of Swimming]]."
craft:
