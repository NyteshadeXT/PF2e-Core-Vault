...
license: "ORC"
identify:
description: "Identical feathers radiate from the center of this spellheart, held in place by woven straw. The spell attack roll of any spell cast by Activating this item is +14, and the spell DC is 24.\n\n**Armor** You gain a +1 item bonus to [[Skills#Acrobatics|Acrobatics]] checks and resistance 5 to falling damage.\n**Weapon** After you cast an air spell by Activating the _wreath_, you can Fly 5 feet as a single action, or you can Fly 25 feet as a free action if the spell you cast wasn't a cantrip. This must be your next action, and if you don't have a fly Speed, you must end the flight on solid ground or fall."
...
trigger2:
mechanics2: "You cast [[Wall of Wind]]."
craft:
