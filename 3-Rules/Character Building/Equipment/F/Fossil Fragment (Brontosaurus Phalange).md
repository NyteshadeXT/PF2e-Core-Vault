...
This massive toe bone becomes a [[3-Rules/Bestiaries/Bestiary 1/B/Brontosaurus|Brontosaurus]] when activated. It can be called upon no more than four times per month. The skeleton remains for 24 hours if used as a beast of burden or for transport. If it attempts an attack or otherwise engage in combat, it reverts to its fragment form after 1d4 rounds.
