...
Each draft of faerie dragon liqueur has a different flavor. For 1 hour after you drink it, you can use a single action to breathe out a 15-foot cone of euphoric gas. Each creature in the cone must attempt a DC 29 Will check save. After you use this breath weapon, you can't do so again for 1d4 rounds.
