...
When you [[Actions/Perform|Perform]] with the fiddle, you can choose to create a harsh and discordant note. You critically fail the Performance check, shred the strings of the fiddle, and create an 8th-rank [[Spells/Noise Blast|Noise Blast]], with a @Template\[emanation|distance:40\] around you instead of a @Template\[burst|distance:10\]. The fiddle can't be played again until the strings are replaced at a cost of 200 gp.
