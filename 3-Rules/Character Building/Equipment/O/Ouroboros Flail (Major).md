...
**Effect** The head of the flail wraps around the target of the triggering Strike and drags it in your direction. The target must succeed at a DC 43 Fortitude check save or be pulled adjacent to you. A creature pulled in is then [[Grabbed|Grabbed]] by the flail until the end of your next turn unless you move, your target Escapes (DC 43), or you use the flail.
