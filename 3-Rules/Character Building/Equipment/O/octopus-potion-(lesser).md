...
description: "**Activate** `pf2:1` (manipulate)  Eight flailing octopus arms covered
  ...
  arms disappear and the potion's effects end.  The Athletics modifier is +12 and
  the Escape DC is 20.      | bludgeoning damage equal to the potion's level immediately
