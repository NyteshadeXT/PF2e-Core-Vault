...
type1: "[[command]], [[envision]] ([[teleportation]])"
frequency1: "once per hour"
requirement1:
trigger1:
activate1: 
duration1: 
mechanics1: "You and the weapon flash to a perfect attacking position, then return to where you started. Make a Strike with the etched weapon against one creature you can see, even if the target is beyond the weapon's reach or range. On this Strike, ignore any circumstance penalty, status penalty, and range increment penalty."
