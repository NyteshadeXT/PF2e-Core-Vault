...
trigger1:
mechanics1: "You remove your headband, which teleports you to a space adjacent to the other Invested wearer's location, if you are within 1 mile of each other."
powerTitle2:
actionEconomy2:
type2:
frequency2:
