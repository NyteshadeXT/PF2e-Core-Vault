...
**Success** The creature takes a -5-foot status penalty to its Speed for 1 minute or until it [[Actions/escape dc=18|escape dc=18]]{Escapes} (DC 18).

**Failure** As success, but the penalty is -10 feet.

**Critical Failure** As success, but the penalty is -20 feet.

[[Equipment Effects/Effect_ Hobbling Snare|Effect: Hobbling Snare]]
