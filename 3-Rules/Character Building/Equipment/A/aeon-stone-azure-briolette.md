...
type: ([[envision]])
frequency:
trigger1: "An enemy fails its save against a mental spell you cast using one of your spell slots"
mechanics1: "This aeon stone must be activated to provide a benefit. You gain temporary Hit Points equal to twice the spell's rank until your next turn.  "
powerTitle2: "Resonant Power"
actionEconomy2: 2
type2: ([[command]], [[Interact]])
frequency2: "once per day"
trigger2:
mechanics2: "The resonant power grants a separate activation. You gain the effect of a [[Void Warp]] arcane cantrip."
craft:
