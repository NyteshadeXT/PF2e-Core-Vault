...
powerTitle1: "Nourshment"
actionEconomy1:
type1:
frequency1:
trigger1:
mechanics1: "After you've invested and worn this transparent stone for a week continuously, you no longer need to eat or drink. This time resets if you remove the _aeon stone_ or it's invested by someone else."
powerTitle2: "Resonant Power"
actionEconomy2:
type2:
frequency2:
trigger2:
mechanics2: "The resonant power allows you to cast [[Air Bubble]] as a primal innate spell once per day."
craft:
