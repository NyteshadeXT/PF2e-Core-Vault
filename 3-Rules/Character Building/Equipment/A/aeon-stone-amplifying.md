...
powerTitle: "Activate—Amplify"
actionEconomy: 1
type: ([[concentrate]], [[spellshape-roe|Spellshape]])
frequency:
trigger:
mechanics: "An _Amplifying aeon stone_ must be activated to provide a benefit. If your next action is to Cast a Spell, that spell's rank is 1 higher (maximum 10th rank) for the purposes of counteracting and being counteracted."
