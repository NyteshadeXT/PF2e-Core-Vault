...
powerTitle1: "Anchoring"
actionEconomy1:
type1:
frequency1:
trigger1:
mechanics1: "This rune prevents enemies from escaping your grasp by [[Fleeing]] to other planes. If you critically hit a target with an anchoring weapon, the weapon casts [[Planar Tether]] on the target (DC 27 Will, counteract modifier +17)."
powerTitle2:
actionEconomy2:
type2:
frequency2:
