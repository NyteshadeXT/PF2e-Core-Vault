...
frequency1: 
trigger1:
mechanics1: "This aeon stone must be activated to provide a benefit.  You activate the aeon stone to gain the effects of a 1st-rank [[Illusory Disguise]]."
powerTitle2: "Resonant Power"
actionEconomy2:
type2:
frequency2:
trigger2:
mechanics2: "The resonant power allows you to render all of your aeon stones and your wayfinder [[Invisible]] whenever you use the activation to gain the effects of illusory disguise."
craft:
