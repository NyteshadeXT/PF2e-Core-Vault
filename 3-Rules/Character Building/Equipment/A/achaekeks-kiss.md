...
frequency: 
trigger1: 
mechanics1: "**Saving Throw** DC 42 Fortitude check  **Maximum Duration** 6 rounds  <br>**Stage 1** `dice: 7d12` 7d12 poison and [[Doomed 1]] (1 round)  <br>**Stage 2** `dice: 9d12` 9d12 poison and [[Doomed|Doomed 2]] (1 round)  <br>**Stage 3** `dice: 11d12` 11d12 poison and [[Doomed|Doomed 3]] (1 round)"
powerTitle2: 
actionEconomy2: 
type2: 
frequency2: 
