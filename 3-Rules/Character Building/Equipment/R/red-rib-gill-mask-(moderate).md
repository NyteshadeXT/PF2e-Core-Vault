...
description: "**Activate** `pf2:1` Interact  * * *  This mask is made from the gills
  ...
  other similar volcanic gases at the GM's discretion.  * * *  **Type: Moderate**\
  \  The item bonus is +2, or +3 against Dead Man's Breath, and the duration is 1
  hour.  [[Equipment Effects/Effect_ Red-Rib Gill Mask (Moderate)|Effect: Red-Rib
  Gill Mask (Moderate)]]"
powerTitle1:
actionEconomy1:
type1:
