...
description: "**Activate** `pf2:1` Strike  * * *  Made from the acidic flesh of an
  ...
  oxidize, and season whatever they touch. You gain a +1 item bonus to attack rolls.\
  \  On a successful Strike, a tenderizer grenade deals the 2d6 acid damage to the
  target and the 2 acid splash damage. Any resistances the target has against bludgeoning,
