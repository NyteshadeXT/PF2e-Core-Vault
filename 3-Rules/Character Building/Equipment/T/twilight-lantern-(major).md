...
description: "This elegant hooded lantern is made from onyx-black metal. In dim light,
  ...
  can have a minimum radius of 5 feet and a maximum radius equal to quadruple the
  light's standard radius.  * * *  **Activate** `pf2:2` envision, Interact  **Frequency**
  ...
  the effect with a counteract modifier of +28."
powerTitle1:
actionEconomy1:
type1:
frequency1:
