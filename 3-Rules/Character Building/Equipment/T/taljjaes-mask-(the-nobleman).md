...
cssclasses:
  ...
  - pf2e-item-base
notetype: pf2e-item
name: "taljjaes-mask-(the-nobleman)"
...
description: "Those who gain one of Taljjae's masks, either by defeating Taljjae or
  ...
  gluttony on the creature as long as it wears the mask.  **Activate** `pf2:2`  **Frequency**
  once per 10 minutes  * * *  **Effect** You hold out a hand and attempt to take something
  that doesn't belong to you. You telekinetically attracts an unattended, unsecured
  object of up to 5 Bulk within 100 feet. If the object is in a creature's possession,
  you must critically succeed at an attempt to [[Actions/Disarm|Disarm]] that creature,
  but you can't critically fail."
powerTitle1:
actionEconomy1:
type1:
frequency1:
