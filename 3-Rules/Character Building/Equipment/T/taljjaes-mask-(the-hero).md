...
description: "Those who gain one of Taljjae's masks, either by defeating Taljjae or
  ...
  once per day  * * *  **Effect** The Hero grants its wearer a +3 status bonus to
  attack rolls with bows for 1 minute.  [[Equipment Effects/Effect_ Taljjae's Mask
  (The Hero)|Effect: Taljjae's Mask (The Hero)]]"
powerTitle1:
actionEconomy1:
type1:
frequency1:
