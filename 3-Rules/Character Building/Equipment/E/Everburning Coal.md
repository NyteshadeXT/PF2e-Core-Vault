...
In addition, an _everburning coal_ is a planar key for [[Interplanar Teleport|Interplanar Teleport]] and similar magic to travel to the Plane of Fire. When using it this way, you can attune it to the fires of your destination to make it more likely to arrive where you intend to be, appearing 1d6×25 miles from your intended destination instead of 1d10×25 miles away.
...
**Effect** The _everburning coal_ creates a towering wall of hot coals. This has the effect of [[Wall of Ice|Wall of Ice]], except for the following adjustments.
