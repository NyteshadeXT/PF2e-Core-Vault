...
description: "This long, shoddy cloak bears a hood and a simple brass clasp. While
  wearing the cloak, you gain a +3 item bonus to Deception checks to Impersonate an
  individual and to Lie while in character as that individual.  * * *  **Activate**
  1 minute (envision, Interact)  **Frequency** once every 10 minutes  **Requirements**
  You are Impersonating someone else  * * *  **Effect** While conversing or otherwise
  ...
  with you. Each creature must attempt a DC 38 Will check save.  * * *  **Critical
