...
description: "**Activate** `pf2:1` envision  * * *  Blood offered from a willing donor
  ...
  Feast|Vampiric Feast]] spell of up to 5th level, instead of gaining temporary Hit
  Points based on the damage dealt, you recover half of the damage dealt as Hit Points.
  If the amount of Hit Points that would be restored by the spell exceeds your Hit
  Point maximum, you gain the excess as temporary Hit Points."
powerTitle1:
actionEconomy1:
type1:
frequency1:
