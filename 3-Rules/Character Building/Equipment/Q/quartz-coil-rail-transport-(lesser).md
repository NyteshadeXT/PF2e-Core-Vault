...
aliases: "Quartz-Coil Rail Transport (Lesser)"
...
description: "**Activate** `pf2:2` (manipulate)  * * *  This odd metal rod is often
  ...
  unoccupied space up to 20 feet away that you can see. If this would bring another
  ...
  and your destination take 2 electricity damage."
powerTitle1:
actionEconomy1:
type1:
frequency1:
