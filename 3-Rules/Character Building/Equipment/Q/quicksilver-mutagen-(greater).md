...
description: "**Activate** `pf2:1` (manipulate)  * * *  You become swifter and nimbler
  but also fragile.  **Benefit** You gain a +3 item bonus to Acrobatics checks, Stealth
  checks, Thievery checks, Reflex saves, and Dexterity-based attack rolls, and you
  gain a +15 foot status bonus to your Speed.  **Drawback** You take damage equal
  ...
  \  [[Equipment Effects/Effect_ Quicksilver Mutagen (Greater)|Effect: Quicksilver
  Mutagen (Greater)]]"
powerTitle1:
actionEconomy1:
type1:
