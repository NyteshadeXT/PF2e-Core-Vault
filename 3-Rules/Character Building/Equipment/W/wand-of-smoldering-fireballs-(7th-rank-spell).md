...
description: "This blackened, heavily burned stick smells faintly of saltpeter.  *
  * *  **Activate** Cast a Spell  **Frequency** once per day, plus overcharge  **Effect**
  You cast [[Spells/Fireball|Fireball]] at 7th-rank. Each creature that fails its
  save takes 3d6 persistent fire damage.  * * *  **Craft Requirements** Supply a casting
  of _fireball_ at 7th-rank."
powerTitle1:
actionEconomy1:
type1:
frequency1:
