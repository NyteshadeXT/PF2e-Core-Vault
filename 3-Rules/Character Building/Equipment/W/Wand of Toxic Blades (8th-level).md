...
**Effect** You cast 8th-rank [[Blade Barrier|Blade Barrier]]. Damage from the wall also exposes the damaged creature to [[Cerulean Scourge|Cerulean Scourge]]. The poison uses its normal DC. A creature can be exposed to the poison no more than once per turn.
