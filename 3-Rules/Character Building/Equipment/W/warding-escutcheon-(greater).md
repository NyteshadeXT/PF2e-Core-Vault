...
description: "An image of a keyhole adorns the coat of arms of this stone tower shield
  (Hardness 20, HP 80, BT 40).  **Activate** `pf2:2` Interact  **Frequency** once
  ...
  with DC 43 Athletics check and DC 43 Thievery check to open.. The door remains in
  ...
  bricks quickly fly from it to form a tall stone keep around it. You cast [[Spells/Resplendent
  Mansion|Resplendent Mansion]], with the shield becoming the door."
powerTitle1:
actionEconomy1:
type1:
frequency1:
