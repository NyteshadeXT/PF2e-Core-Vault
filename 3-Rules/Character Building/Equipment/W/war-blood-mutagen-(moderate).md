...
description: "Upon drinking this mutagen, you can feel your blood surge through your
  ...
  Choose one melee weapon you're holding in one or both hands. You gain a +2 item
  bonus to your attack rolls with this weapon and to Will saves against fear effects
  for 10 minutes. Any attempt to [[Actions/Disarm|Disarm]] or otherwise remove the
  weapon from your hands must exceed DC 30 or the attempt fails.  [[Equipment Effects/Effect_
  War Blood Mutagen (Moderate)|Effect: War Blood Mutagen (Moderate)]]  **Drawback**
  You can't voluntarily remove the weapon unless you succeed at a DC 30 Athletics
