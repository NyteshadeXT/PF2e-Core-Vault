...
cssclasses:
  ...
  - pf2e-item-base
notetype: pf2e-item
name: "shell-of-easy-breathing-(greater)"
...
description: "This large salt-encrusted seashell is more than 2 feet across, with
  ...
  it uses for breathing) as a 3-action activity. For the next 8 hours, the creature
  can breathe underwater. The creature is then temporarily immune to _shells of easy
  breathing_ until the next time it makes its daily preparations."
powerTitle1:
actionEconomy1:
type1:
frequency1:
