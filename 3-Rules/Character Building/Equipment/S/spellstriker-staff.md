...
description: "A _spellstriker staff_ is wrought iron with gleaming arcane sigils etched
  ...
  a _+1 striking shifting staff_.  * * *  **Activate** `pf2:0` envision  **Frequency**
  ...
  Arrow|Acid Arrow]], [[Spells/Telekinetic Maneuver|Telekinetic Maneuver]]  * * *\
  \  **Craft Requirements** You have the magus's Spellstrike activity. Supply one
