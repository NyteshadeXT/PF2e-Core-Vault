...
description: "**Activate** `pf2:1` (manipulate)  * * *  Your features become striking,
  ...
  \  **Benefit** You gain a +1 item bonus to Deception, Diplomacy, Intimidation and
  ...
  Knowledge]] become critical failures.  **Duration** 1 minute.  [[Equipment Effects/Effect_
  Silvertongue Mutagen (Lesser)|Effect: Silvertongue Mutagen (Lesser)]]"
powerTitle1:
actionEconomy1:
type1:
frequency1:
