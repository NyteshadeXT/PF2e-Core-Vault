...
description: "**Activate** `pf2:1` (manipulate)  * * *  On the Elemental Plane of
  ...
  burst within 60 feet of you. The cloud dissipates after 1 minute.  A blue cloud
  protects against lightning. Creatures gain resistance 5 to electricity while in
  the cloud.  [[Equipment Effects/Effect_ Spun Cloud (Blue)|Effect: Spun Cloud (Blue)]]"
powerTitle1:
actionEconomy1:
type1:
frequency1:
