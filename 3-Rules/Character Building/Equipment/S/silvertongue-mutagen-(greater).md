...
description: "**Activate** `pf2:1` (manipulate)  * * *  Your features become striking,
  ...
  \  **Benefit** You gain a +3 item bonus to Deception, Diplomacy, Intimidation and
  ...
  Knowledge]] become critical failures.  **Duration** 1 hour.  [[Equipment Effects/Effect_
  Silvertongue Mutagen (Greater)|Effect: Silvertongue Mutagen (Greater)]]"
powerTitle1:
actionEconomy1:
type1:
frequency1:
