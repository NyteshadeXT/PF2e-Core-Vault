...
description: "**Activate** `pf2:1` Interact  Sometimes, an enemy's dangerous special
  ...
  package and slipped over the head. The mask grants you a +4 item bonus to saving
  throws against auditory, olfactory, and visual effects for 1 hour. Since it dulls
  your senses without depriving you of them, the mask also imposes a –1 penalty to
  rolls and checks using Perception for the same duration.  [[Equipment Effects/Effect_
  Sense-Dulling Hood (Greater)|Effect: Sense-Dulling Hood (Greater)]]"
powerTitle1:
actionEconomy1:
type1:
frequency1:
