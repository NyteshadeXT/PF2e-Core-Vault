...
tags:
  ...
  - trait/magical
  - trait/unique
aliases: "Compendium.pf2e.equipment-srd.Item.TYdFnzhhTlpUdtty"
license: OGL
---
# Starless Scope
## Item 9
...
Without a functional lens, a _starless scope_ doesn't function. You can replace a shattered lens with a functional lens by taking a two-action activity with the manipulate trait. If you know the formula for the _starless scope_, you can Craft a new lens with a DC 25 Crafting check (master) check.

[[Starless Scope Lens|Starless Scope Lens]]
...
**Activate** `pf2:2` (abjuration, divine) Interact
