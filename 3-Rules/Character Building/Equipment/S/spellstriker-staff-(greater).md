...
description: "A _spellstriker staff_ is wrought iron with gleaming arcane sigils etched
  ...
  a _+2 striking shifting staff_.  * * *  **Activate** `pf2:0` envision  **Frequency**
  ...
  Arrow|Acid Arrow]], [[Spells/Weapon Storm|Weapon Storm]]  * * *  **Craft Requirements**
  You have the magus's Spellstrike activity. Supply one casting of all listed ranks
