...
description: "**Activate** `pf2:1` Interact  Soothing powders are remedies made to
  ...
  \  In addition to the effects described above, the powder persists for 1 minute,
  lowering the DCs of flat checks against that type of persistent damage due to particularly
