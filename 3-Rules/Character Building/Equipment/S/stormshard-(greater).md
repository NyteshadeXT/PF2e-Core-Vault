...
cssclasses:
  ...
  - pf2e-item-base
notetype: pf2e-item
name: "stormshard-(greater)"
aliases: "Stormshard (Greater)"
...
description: "These shards of coalesced necromantic essence are sometimes found in
  ...
  you gain a +2 item bonus to Intimidation checks to influence the undead. In addition,
  ...
  *  **Effect** You briefly release the spirits from the _stormshard_ before drawing
  them back into the glass. Each creature in a 10-foot emanation takes 8d8 void damage
  (DC 29 Fortitude check save). You treat the result of your saving throw as one degree
  of success better than its outcome. You can choose to increase the radius of the
  emanation by up to 10 feet."
powerTitle1:
actionEconomy1:
type1:
frequency1:
