...
description: "**Activate** `pf2:1` Interact  This glistening oil has a green hue and
  tiny snake scales floating within. If you slather serpent oil on a Large object
  that is snakelike in shape, from a stick to a scarf, the object transforms into
  a [[Bestiary 2/Emperor Cobra|Emperor Cobra]], keeping some of the same colors and
