...
license: "ORC"
identify:
description: "**Activate** `pf2:1` (manipulate)  * * *  For 1 minute after drinking a potion of fire retaliation, you glow with a faint aura of fire energy, and a creature that touches you (such as by making an unarmed attack or using a spell with a range of touch against you) takes fire damage.  The aura deals 1d4 fire damage."
powerTitle:
actionEconomy:
type:
frequency:
