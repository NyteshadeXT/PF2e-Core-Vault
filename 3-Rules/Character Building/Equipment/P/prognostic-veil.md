...
description: "This gauzy purple veil is embroidered with symbols of divinatory significance.
  ...
  a +2 item bonus to Religion checks.  **Activate—Remember the Future** `pf2:0` (concentrate)\
  ...
  about to attempt a saving throw  **Requirements** You have the [[Conditions/Cursebound|Cursebound]]
  condition  * * *  **Effect** The ally gains a status bonus to the saving throw equal
  to the value of your cursebound condition.  [[Equipment Effects/Effect_ Twist the
  Skeins of Fate|Effect: Twist the Skeins of Fate]]  * * *  **Craft Requirements**
  You're an oracle."
powerTitle1:
actionEconomy1:
type1:
