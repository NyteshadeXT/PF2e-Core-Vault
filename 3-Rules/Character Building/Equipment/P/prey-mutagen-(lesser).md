...
description: "**Activate** `pf2:1` Interact  * * *  A mixture of fey blood and rare
  ...
  attractive to predators.  **Benefit** You gain a +10 status bonus to your speed
  and are able to use the following reaction:  **Timely Dodge** `pf2:r`  **Trigger**
  You are targeted by a Strike  **Effect** You dart aside, gaining a +1 circumstance
  ...
  a +2 circumstance bonus to attack rolls against you.  The duration is 1 minute.\
  \  [[Equipment Effects/Effect_ Prey Mutagen (Lesser)|Effect: Prey Mutagen (Lesser)]]"
powerTitle1:
actionEconomy1:
type1:
frequency1:
