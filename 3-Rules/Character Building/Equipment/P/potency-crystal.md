...
description: "**Activate** `pf2:0` (concentrate)  **Trigger** You make an attack with
  ...
  a _+1 striking weapon_ on the Strike and until the end of this turn, gaining a +1
  item bonus to the attack roll and increasing the damage to two weapon damage dice.\
