...
description: "These runes always come in pairs and can be applied to a garment's pockets
  ...
  on the same plane as each other  * * *  **Effect** Items in the pockets (up to 10
  negligible Bulk items or 1 light Bulk item per pocket) trade places via teleportation."
powerTitle1:
actionEconomy1:
type1:
frequency1:
