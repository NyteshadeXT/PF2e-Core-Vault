...
description: "**Activate** `pf2:0` (concentrate)  **Trigger** You make an attack with
  ...
  a _+2 greater striking weapon_ on the Strike and until the end of this turn, gaining
  a +2 item bonus to the attack roll and increasing the damage to three weapon damage
