...
description: "This soporific chemical comes in liquid form and is virtually undetectable by taste or scent. It's most commonly slipped into a victim's drink to quickly induce a deep unconsciousness.\n\n**Saving Throw** DC 23 Fortitude check  **Onset** 1 minute  **Maximum Duration** 10 hours  **Stage 1** fall [[Unconscious]] and can't attempt [[Skills#Perception|Perception]] checks to wake up (1 minute)  **Stage 2** sleep normally (`dice: 1d4` hours)"
powerTitle1:
actionEconomy1:
type1:
frequency1:
