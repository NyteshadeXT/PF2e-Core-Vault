...
description: "**Activate** `pf2:1` (manipulate)  * * *  Every _marvelous miniature_
  ...
  description.  * * *  When activated, this miniature transforms into an active campfire.
  The campfire doesn't require attending and remains fully lit for 8 hours, though
  it can be quenched as any other campfire."
powerTitle1:
actionEconomy1:
type1:
frequency1:
