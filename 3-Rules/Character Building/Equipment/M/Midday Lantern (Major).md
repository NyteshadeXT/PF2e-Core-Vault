...
**Effect** You raise the lantern and unleash a blast of powerful sunlight. The blast has the effects of 8th-rank [[Blazing Bolt|Blazing Bolt]] using a spell attack roll of +32, with its effect determined by the number of actions you used to activate the lantern.
