...
**Amp** You transfer some of the magical luminescence from the mind's light circlet to one of the creatures. Choose a creature targeted by the spell or in its area. Until the start of your next turn, that creature sheds bright light in a 20-foot radius (and dim light to the next 20 feet) and can't be [[3-Rules/Conditions/Concealed|Concealed]]. If the creature is [[Invisible|Invisible]], it's concealed while alight, rather than being undetected.

[[Equipment Effects/Effect_ Mind's Light Circlet|Effect: Mind's Light Circlet]]
