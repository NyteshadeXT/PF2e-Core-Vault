...
description: "More of a field projector than a scope, this small cylinder of magnetite
  ...
  allies' locations. The magnetite scope grants you a +2 item bonus to Survival checks
  ...
  the gun to which the scope is attached has its scatter radius increased by 5 feet."
powerTitle1:
actionEconomy1:
type1:
frequency1:
