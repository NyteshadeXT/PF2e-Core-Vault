...
description: "**Ammunition** any  **Activate** `pf2:1` command  Shiny gray metal that
  ...
  The activated ammunition grants a +2 circumstance bonus to attack rolls against
  such targets. Due to magnetic acceleration, the ammunition deals four additional
  weapon damage dice and is deadly d12."
powerTitle1:
actionEconomy1:
type1:
frequency1:
