...
trigger1:
mechanics1: "You turn the key in the air and create a magic glyph. The key casts 3rd-rank [[Summon Construct]]."
powerTitle2: "Effect"
actionEconomy2: "1 minute"
type2: "([[command]], [[envision]], [[interact]])"
frequency2: "once per day"
trigger2:
mechanics2: "You place the key on a Small object and turn it, creating a simple animated object for 1 hour. The animated object has the statistics of an [[3-Rules/Bestiaries/Monster Core/A/Animated Broom|Animated Broom]] but has no bristles Strike and can't attack. It performs simple and broad menial tasks for you in exploration or downtime but is too slow to react to individual commands to assist you in a combat encounter."
craft:
