...
tags:
  ...
  - trait/magical
  - trait/common
aliases: "Compendium.pf2e.equipment-srd.Item.ifAp8wHKBZltgHG0"
license: OGL
---
...
Sewn from several long strips of luxurious brown and black silk, this cloak grants you a +3 item bonus to Stealth checks as well as to Acrobatics checks to [[Actions/Maneuver in Flight|Maneuver in Flight]]. You can also use your feet to hang from any surface that can support your weight, without requiring any check, though you still must attempt Athletics checks to [[Actions/Climb|Climb]] in order to move around while inverted.
