...
tags:
  ...
  - trait/uncommon
  - category/martial
aliases: "Compendium.pf2e.equipment-srd.Item.Gfu13B6b9eDdHCtV"
license: OGL
---
# Drake Rifle (Fire)
## Item 4
...
| **Damage** 1d10 fire  | **Usage** held-in-two-hands |
...
*   **Fire** A massive explosion knocks the target back. The target is pushed 10 feet away from you, and if it's on the ground, it falls [[Conditions/Prone|Prone]].
