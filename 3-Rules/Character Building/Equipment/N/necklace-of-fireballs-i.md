...
description: "This string of beads appears to be a hemp string with lustrous red beads
  ...
  has one 6d6 fire damage and two 4d6 fire damage beads with a DC 21 Reflex check
  save. When all the beads are gone, the necklace becomes a non-magical hemp string.\
  \  **Activate** `pf2:1` Interact  * * *  **Effect** You detach a sphere from the
  necklace, causing it to glow with orange light. After you activate a sphere, if
  you or anyone else hurls it (an Interact action with the ranged trait), it detonates
