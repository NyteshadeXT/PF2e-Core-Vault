...
**Effect** You smash the spear into the ground or another nearby surface, shattering it into thousands of duskwood splinters in your choice of a @Template\[cone|distance:30\] or a @Template\[emanation|distance:10\]. Each creature in the area takes 12d6 piercing damage with a DC 30 Reflex check save. A creature that fails also takes the same amount of persistent bleed damage as the spear deals on a hit. The spear regrows into its full form at the end of this turn.
