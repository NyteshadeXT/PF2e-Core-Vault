---
title: "Cleansed Cultist"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.kingmaker-bestiary.Actor.UfB3NfSgZIkN5Rjx" 
tags:
...
skills:
  - name: "Skills"
    desc: "Athletics: +13, Deception: +13, Intimidation: +13, Occultism: +11, Society: +11, Stealth: +14"
abilityMods: [2, 4, 2, 0, 2, 2]
speed: 25 feet
...
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Dagger|Dagger]], [[Equipment/Shortsword|+1 Shortsword]], [[Equipment/Leather Armor|Leather Armor]], [[Equipment/Hourglass|Hourglass]]"
abilities_mid:
  - name: ""
attacks:
  - name: ""
  ...
  - name: "Twin Feint"
    desc: "`pf2:2`  The cultist makes two Strikes, one with their shortsword and one with their dagger, both against the same target. The target is automatically [[Conditions/Off-Guard|Off-Guard]] against the second attack. Apply the cultist's multiple attack penalty to the Strikes normally."
