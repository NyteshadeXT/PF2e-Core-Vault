...
health:
  - name: ""
  - name: "HP"
    desc: "106, recovery; __Hardness__ 27; __Immunities__  object immunities,  critical hits,  precision"
perception:
  - name: ""
  - name: "Stealth DC 10" 
    desc: " +0"
abilities_top:
  - name: ""
  - name: "Description"
    desc: "A spiral shape suggesting the curling religious symbol of Pharasma is carved into the stone floor."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 37 Occultism check (master) or DC 40 Religion check (master) to unmake the Spiral Seal through occult ritual or prayer performed as a 10 minute activity with the Concentrate trait, or [[Spells/Dispel Magic|Dispel Magic]] (9th level, counteract DC 40) to counteract the Spiral Seal."
attacks:
  - name: ""
