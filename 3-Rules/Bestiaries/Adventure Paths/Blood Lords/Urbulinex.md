...
cssClasses: pf2e
aliases: "Compendium.pf2e.blood-lords-bestiary.Actor.pqlqDWVOtPxJ2oRn" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +28, Athletics: +35, Deception: +31, Intimidation: +31, Nature: +28, Religion: +31, Stealth: +30"
abilityMods: [9, 5, 6, 5, 6, 5]
speed: 50 feet,  fly 180 feet
sourcebook: "_Pathfinder #185: A Taste of Ashes_"
ac: 41
armorclass:
  - name: AC
    desc: "41; __Fort__ +31, __Ref__ +29, __Will__ +31; +1 status to all saves vs. magic"
hp: 345
health:
  - name: ""
  - name: HP
    desc: "345, Soul Ward; __Immunities__  death effects,  disease,  paralyzed,  poison,  sleep,  unconscious; __Weaknesses__ holy 15"
abilities_top:
  - name: ""
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Jaws +34 (magical, reach 15 feet)\n__Damage__  3d10 + 15 piercing 5d6 void"

  - name: "Melee"
    desc: "`pf2:1` Claw +34 (agile, magical, reach 10 feet)\n__Damage__  3d10 + 15 slashing 2d6 void"

  - name: "Melee"
    desc: "`pf2:1` Tail +32 (magical, reach 20 feet)\n__Damage__  3d12 + 15 slashing 2d6 void"

  - name: "Melee"
    desc: "`pf2:1` Wing +32 (agile, magical, reach 15 feet)\n__Damage__  2d10 + 15 slashing 2d6 void"
  ...
  - name: "Draconic Momentum"
    desc: "  The ravener recharges their Breath Weapon whenever they score a critical hit with a Strike."
...
Female adult umbral dragon ravener
