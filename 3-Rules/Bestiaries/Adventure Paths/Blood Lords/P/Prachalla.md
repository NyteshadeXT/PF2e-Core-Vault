...
cssClasses: pf2e
aliases: "Compendium.pf2e.blood-lords-bestiary.Actor.624fuRv6nLi31THS" 
tags:
...
token: [[modules/pf2e-ap183-field-of-maidens/assets/art/PZO90183_prachallaDoll.webp| ]]
...
health:
  - name: ""
  - name: HP
    desc: "205; __Immunities__  mental,  bleed,  death effects,  disease,  doomed,  drained,  fatigued,  healing,  nonlethal attacks,  paralyzed,  poison,  sickened,  spirit,  unconscious,  vitality,  void; __Weaknesses__ bludgeoning 10"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "Soul Focus Gem"
  - name: "Personality Fragments"
    desc: "  A soulbound doll shares fragments of the donor's soul personality, though none of that creature's memories. The Prachalla doll is animated by the soul of a spy who worked for an organized crime ring in Kaer Maga; she was working undercover as a maid when she died."
...
attacks:
  ...
  - name: "[[Bestiary Ability Glossary/Sneak Attack|Sneak Attack]]"
    desc: "  Prachalla deals an additional 2d6 precision damage to [[Conditions/Off-Guard|Off-Guard]] creatures."

  - name: "Surprise Attack"
    desc: "  On the first round of combat, creatures that haven't acted are [[Conditions/Off-Guard|Off-Guard]] to Prachalla."
