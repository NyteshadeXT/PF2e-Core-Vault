...
armorclass:
  - name: AC
    desc: "42; __Fort__ +36, __Ref__ +39, __Will__ +0"
hp: 80
health:
  - name: ""
  - name: "HP"
...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 48 Athletics check (legendary) or Acrobatics (master) to tie one tentacle into a knot, rendering it useless, or [[Spells/Dispel Magic|Dispel Magic]] (8th level; counteract DC 44) to counteract one tentacle.\nThe death of the Daemonic Rumormonger permanently dispels all the inky tendrils."
attacks:
  - name: ""
  - name: "Melee"
