---
title: "Rivka (Cimurlian)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.fists-of-the-ruby-phoenix-bestiary.Actor.k5UjbiYr87NVK7qp" 
tags:
...
health:
  - name: ""
  - name: HP
    desc: "220; __Resistances__ cold 10"
abilities_top:
  - name: ""
...
attacks:
  ...
  - name: "Kaiju Ray"
    desc: "`pf2:2` (primal) The rivka opens its maw and projects a 60-foot line of primal energy that deals 14d6 cold damage (DC 32 Reflex check save). The type of damage dealt by the ray depends on which kaiju the rivka has most recently fed from (see above). The rivka can't use Kaiju Ray again for 1d4 rounds."
