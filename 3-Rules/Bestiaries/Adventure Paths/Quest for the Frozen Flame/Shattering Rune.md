...
abilities_top:
  - name: ""
  - name: "Description"
    desc: "A magical rune is inscribed on the tarry earth at the entrance to the hut, buried beneath snow, with an [[Conditions/Invisible|Invisible]] sensor that detects creatures within a 10-foot-radius sphere."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 30 Thievery check (master) to erase the rune without triggering the sensor or [[Spells/Dispel Magic|Dispel Magic]] (5th level; counteract DC 28) to dispel the rune"
attacks:
  - name: ""
