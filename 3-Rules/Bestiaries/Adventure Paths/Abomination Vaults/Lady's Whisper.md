---
title: "Lady's Whisper"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.abomination-vaults-bestiary.Actor.dWOK0nzGWyc5NkNz" 
tags:
...
perception:
  - name: "Perception"
    desc: "+25; Darkvision, See the Unseen, Truesight"
languages: "Aklo, Common, Necril, Sakvroth"
skills:
  - name: "Skills"
    desc: "Acrobatics: +22, Athletics: +20, Deception: +21, Diplomacy: +21, Intimidation: +21, Occultism: +21, Religion: +23, Society: +21, Stealth: +22"
abilityMods: [3, 5, 3, 4, 8, 4]
speed: 25 feet
sourcebook: "_Pathfinder #165: Eyes of Empty Death_"
ac: 31
armorclass:
  - name: AC
    desc: "31; __Fort__ +18, __Ref__ +20, __Will__ +25; +1 status to all saves vs. magic"
hp: 195
health:
  - name: ""
  - name: HP
...
attacks:
  ...
  - name: "Gatekeeper's Will"
    desc: "`pf2:1` (concentrate) Lady's Whisper mentally causes any doors or portals within the Gate of Nhimbaloth (areas B60 to B64 and areas C1 through C18) to open or shut. If Lady's Whisper wills a door closed, it must be Forced Open or battered down."

  - name: "Unwilling Teleportation"
    desc: " (divine,teleportation) When Lady's Whisper hits and damages a creature with its claw Strike, it can choose to teleport that creature to any open space within 15 feet, even if Lady's Whisper can't see the destination. The target can attempt a DC 30 Will check saving throw to resist this effect."
