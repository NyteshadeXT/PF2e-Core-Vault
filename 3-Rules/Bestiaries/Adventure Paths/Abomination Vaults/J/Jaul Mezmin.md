...
cssClasses: pf2e
aliases: "Compendium.pf2e.abomination-vaults-bestiary.Actor.EN3mp0sVObP8ou3p" 
tags:
...
abilityMods: [5, 2, 0, -1, 4, 2]
speed: 25 feet
sourcebook: "_Pathfinder #163: Ruins of Gauntlight_"
ac: 24
armorclass:
  - name: AC
    desc: "24; __Fort__ +12, __Ref__ +14, __Will__ +16; +1 status vs. poison"
hp: 120
health:
  - name: ""
  - name: HP
    desc: "120; __Weaknesses__ silver 7; __Resistances__ poison 3"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "2x [[Equipment/Katar|+1 Striking Katar]], Bejeweled Necklace featuring a Porpoise"
  - name: "Wolf Empathy"
    desc: " (primal) Jaul can communicate with lupines."
...
attacks:
  ...
  - name: "**Melee** `pf2:1` Katar"
    desc: "+17 (agile, deadly d6, magical, monk)\n__Damage__  2d4 + 7 piercing"

  - name: "**Melee** `pf2:1` Claw"
    desc: "+16 (agile, unarmed)\n__Damage__  2d6 + 7 slashing"

  - name: "**Melee** `pf2:1` Jaws"
    desc: "+16 (unarmed)\n__Damage__  2d8 + 7 piercing plus werecreature-curse-of-the-werecreature"

  - name: "Primal Prepared Spells"
    desc: "DC 24, attack +15; __3rd __  _[[Spells/Lightning Bolt|Lightning Bolt]]_, _[[Spells/Wall of Thorns|Wall of Thorns]]_; __2nd __  _[[Spells/Water Breathing|Water Breathing]]_; __1st __  _[[Spells/Gentle Landing|Feather Fall]]_, _[[Spells/Grease|Grease]]_, _[[Spells/Heal|Heal]]_, _[[Spells/Runic Body|Magic Fang]]_, _[[Spells/Summon Animal|Summon Animal]]_\n__Cantrips__  __(3rd)__ _[[Spells/Acid Splash|Acid Splash]]_, _[[Spells/Detect Magic|Detect Magic]]_, _[[Compendium.pf2e.spells-srd.Item.O9w7r4BKgPogYDDe|Produce Flame]]_, _[[Spells/Tangle Vine|Tanglefoot]]_"
