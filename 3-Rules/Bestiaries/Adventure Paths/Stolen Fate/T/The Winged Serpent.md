...
cssClasses: pf2e
aliases: "Compendium.pf2e.stolen-fate-bestiary.Actor.o8DGfZKaz1TELyzU" 
tags:
...
attacks:
  ...
  - name: "Interpose Tail"
    desc: "`pf2:r`  **Trigger** A creature within 15 feet uses a move action or leaves a square during a move action it's using\n* * *\n\n**Effect** The Winged Serpent uses its tail to attempt to [[Actions/Trip|Trip]] the triggering creature. On a success, the triggering movement is disrupted and the creature is Tripped as normal."
