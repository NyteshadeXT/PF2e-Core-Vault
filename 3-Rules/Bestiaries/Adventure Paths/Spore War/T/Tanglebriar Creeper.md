---
title: "Tanglebriar Creeper"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.spore-war-bestiary.Actor.DBJgwqVDuM44Wd7Z" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +29, Athletics: +30, Crafting: +29, Deception: +27, Occultism: +29, Religion: +27, Stealth: +29"
abilityMods: [7, 8, 6, 8, 6, 6]
speed: 40 feet,  climb 40 feet,  fly 40 feet
sourcebook: "_Pathfinder #211: The Secret of Deathstalk Tower_"
ac: 37
armorclass:
  - name: AC
    desc: "37; __Fort__ +25, __Ref__ +29, __Will__ +27; +1 status to all saves vs. magic"
hp: 235
health:
  - name: ""
  - name: HP
    desc: "235, fast healing 15; __Immunities__  cold,  confused; __Resistances__ poison 15, sonic 15"
abilities_top:
  - name: ""
...
attacks:
  ...
  - name: "**Melee** `pf2:1` Web War Flail"
    desc: "+30 (disarm, magical, reach 15 feet, sweep, trip)\n__Damage__  3d10 + 15 bludgeoning 1d6 poison"

  - name: "**Melee** `pf2:1` Fangs"
    desc: "+30 (reach 10 feet)\n__Damage__  3d12 + 15 piercing plus leng-spider-venom"

  - name: "**Melee** `pf2:1` Leg"
    desc: "+30 (agile, reach 10 feet)\n__Damage__  3d8 + 15 slashing"

  - name: "**Ranged** `pf2:1` Web Bola"
    desc: "+30 (magical, nonlethal, ranged trip, thrown 20 ft.)\n__Damage__  3d6 + 15 bludgeoning"

  - name: "Occult Innate Spells"
    desc: "DC 36, attack +28; __8th __  _[[Spells/Dispel Magic|Dispel Magic]]_, _[[Spells/Illusory Disguise|Illusory Disguise]]_, _[[Spells/Warp Mind|Warp Mind]]_; __7th __  _[[Spells/Illusory Scene|Illusory Scene]]_, _[[Spells/Mislead|Mislead]]_; __4th __  _[[Spells/Charm|Charm (x3)]]_, _[[Spells/Unfettered Movement|Unfettered Movement]]_\n__Cantrips__  __(8th)__ _[[Spells/Detect Magic|Detect Magic]]_\n__Constant__  __(8th)__ _[[Spells/Fly|Fly]]_, _[[Spells/Truespeech|Truespeech]]_"

  - name: "Create Web Weaponry"
    desc: "`pf2:1` (manipulate) The Leng spider creates a weapon by applying a cord of webbing to heavy objects, such as rocks or chunks of metal, either attaching two heavy objects together to create a web bola or fastening one to its leg to create a web war flail.\n\nAny melee weapon created by a Tanglebriar creeper also becomes saturated with toxin and inflicts an additional 1d6 poison damage on a hit."
