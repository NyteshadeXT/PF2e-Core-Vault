---
title: "Forger of Tanglebriar"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.spore-war-bestiary.Actor.QbzfloiHZrxBLYDK" 
tags:
...
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Trident|+3 Greater Striking Astral Greater Decaying Trident]], [[Equipment/Full Plate|+2 Greater Resilient Duskwood Full Plate]]"
...
attacks:
  ...
  - name: "**Melee** `pf2:1` Trident"
    desc: "+34 (magical)\n__Damage__  3d8 + 16 piercing plus bloodbird 1d6 spirit plus bloodbird 1d4 void plus bloodbird"
  ...
  - name: "Feed the Forge"
    desc: "`pf2:2`  **Requirements** The Forger's last action was a successful Strike with their trident against a Medium or smaller creature\n* * *\n\n**Effect** The Forger attempts to [[Actions/Reposition|Reposition]] the creature, which remains impaled on the trident. The creature takes 3d8+16 piercing damage (DC 37 Fortitude check save) regardless of the result of the Reposition attempt. If the creature is Repositioned into a space occupied by a fungal forge, that fungal forge is triggered and uses its Defile and Pollute reaction."
