...
cssClasses: pf2e
aliases: "Compendium.pf2e.outlaws-of-alkenstar-bestiary.Actor.rN4Q66R0601txrHg" 
tags:
...
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Shortsword|+1 Shortsword]], [[Equipment/Glue Bomb (Moderate)|Tanglefoot Bag (Moderate)]], [[Equipment/Flintlock Pistol|+1 Flintlock Pistol]], [[Equipment/Studded Leather Armor|Studded Leather Armor]], [[Equipment/Healing Potion (Minor)|Healing Potion (Minor)]], 10x [[Equipment/Rounds (Flintlock Pistol)|Rounds (Flintlock Pistol)]]"
abilities_mid:
  - name: ""
  - name: "Deny Advantage"
...
attacks:
  ...
  - name: "**Ranged** `pf2:1` Flintlock Pistol"
    desc: "+19 (concussive, fatal d8, magical, range increment 40 feet, reload 1)\n__Damage__  1d4 + 4 piercing"
