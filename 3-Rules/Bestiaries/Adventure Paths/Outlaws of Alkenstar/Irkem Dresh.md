...
cssClasses: pf2e
aliases: "Compendium.pf2e.outlaws-of-alkenstar-bestiary.Actor.GyrL5Q66shXthhZL" 
tags:
...
armorclass:
  - name: AC
    desc: "19; __Fort__ +8, __Ref__ +9, __Will__ +8"
hp: 37
health:
  - name: ""
  - name: HP
...
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Flintlock Pistol|Flintlock Pistol]], [[Equipment/Clothing (Fine)|Clothing (Fine)]], Manager's keys, [[Equipment/Elixir of Life (Minor)|Elixir of Life (Minor)]], 10x [[Equipment/Rounds (Flintlock Pistol)|Rounds (Flintlock Pistol)]], 37x [[Equipment/Silver Pieces|Silver Pieces]]"
abilities_mid:
  - name: ""
  - name: "Defying Glare"
