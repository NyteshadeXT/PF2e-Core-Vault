---
title: "Augusta Wormwood"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.curtain-call-bestiary.Actor.8L1GpUj3eJgaeFUk" 
tags:
...
skills:
  - name: "Skills"
    desc: "Athletics: +22, Deception: +27, Intimidation: +25, Occultism: +24, Society: +22, Thievery: +24, Vyre Lore: +26"
abilityMods: [4, 2, 1, 2, 4, 5]
speed: 25 feet
sourcebook: "_Pathfinder #204: Stage Fright_"
ac: 34
armorclass:
  - name: AC
    desc: "34; __Fort__ +22, __Ref__ +25, __Will__ +27"
hp: 250
health:
  - name: ""
  - name: HP
...
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Hatchet|+2 Greater Striking Corrosive Decaying Hatchet]], [[Equipment/Hide Armor|+1 Resilient Hide Armor]], [[Equipment/Spacious Pouch (Type III)|Spacious Pouch (Type III)]]"
abilities_mid:
  - name: ""
attacks:
  - name: ""
  ...
  - name: "Quickened Casting"
    desc: " (concentrate,spellshape) **Frequency** once per day\n* * *\n\n**Effect** If Augusta's next action is to cast a 5th-rank or lower occult spell or cantrip, reduce the number of actions to cast it by 1 (minimum 1 action)."
...
Female hellspawn nephilim human occultist
