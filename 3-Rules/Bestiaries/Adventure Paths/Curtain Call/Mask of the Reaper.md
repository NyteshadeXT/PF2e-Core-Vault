---
title: "Mask of the Reaper"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.curtain-call-bestiary.Actor.AIcxTXQjR0Y70oNE" 
tags:
...
attacks:
  ...
  - name: "Divine Innate Spells"
    desc: "DC 37, attack +29; __8th __  _[[Spells/Heal|Heal (x3)]]_, _[[Spells/Shadow Blast|Shadow Blast]]_, _[[Spells/Suggestion|Suggestion]]_; __7th __  _[[Spells/Cleanse Affliction|Cleanse Affliction]]_, _[[Spells/Divine Decree|Divine Decree]]_, _[[Spells/Warp Mind|Warp Mind]]_; __6th __  _[[Spells/Sending|Sending (x3)]]_, _[[Spells/Spellwrack|Spellwrack]]_; __4th __  _[[Spells/Invisibility|Invisibility (x3)]]_, _[[Spells/Silence|Silence (x3)]]_\n__Cantrips__  __(8th)__ _[[Spells/Daze|Daze]]_, _[[Spells/Detect Magic|Detect Magic]]_, _[[Spells/Message|Message]]_\n__Constant__  __(8th)__ _[[Spells/Truesight|Truesight]]_, _[[Spells/Truespeech|Truespeech]]_"

  - name: "Aspect's Agony"
    desc: "  When a mask of Norgorber Strikes a foe with a weapon, they inflict an additional 1d6 persistent mental damage. As long as a creature is taking this persistent damage, they're [[Conditions/Off-Guard|Off-Guard]]."

  - name: "Insidious Secrets"
    desc: "`pf2:1` (auditory,divine,emotion,fear,linguistic,mental) **Frequency** once per day\n* * *\n\n**Effect** The mask whispers, then targets a creature within 30 feet. The target must then attempt a DC 37 Will check save.\n* * *\n\n**Critical Success** The target fails to hear the secret whispered and is unaffected.\n\n**Success** The mask whispers a horrific secret to the target, and though their mind recoils and forgets, the target still takes 8d6 mental damage and is [[Conditions/Frightened|Frightened 1]].\n\n**Failure** As failure, but 17d6 mental damage and [[Conditions/Frightened|Frightened 2]]; the target is [[Conditions/Confused|Confused]] as long as they are frightened.\n\n**Critical Failure** As failure, but 30d6 mental damage and the target is confused for 1 minute."
