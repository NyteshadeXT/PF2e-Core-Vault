---
title: "Delaraius Solzakarr"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.curtain-call-bestiary.Actor.ar9K6cpiG6G3v2wZ" 
tags:
...
perception:
  - name: "Perception"
    desc: "+36; Darkvision"
languages: "Aklo, Common, Daemonic, Diabolic, Halfling, Kelish, Sakvroth"
skills:
  - name: "Skills"
    desc: "Acrobatics: +35, Deception: +39, Diplomacy: +37, Intimidation: +37, Medicine: +36, Occultism: +36, Religion: +38, Society: +34, Stealth: +37, Thievery: +37, Norgorber Lore: +38, Vyre Lore: +38"
abilityMods: [4, 9, 6, 8, 10, 9]
speed: 25 feet
sourcebook: "_Pathfinder #206: Bring the House Down_"
ac: 45
armorclass:
  - name: AC
    desc: "45; __Fort__ +32, __Ref__ +35, __Will__ +38"
hp: 375
health:
  - name: ""
  - name: HP
    desc: "375; __Immunities__  bleed; __Weaknesses__ vulnerable to sunlight 50"
abilities_top:
  - name: ""
  - name: "Items"
...
attacks:
  ...
  - name: "Cleric Domain Spells"
    desc: "3 Focus Points, DC 42, attack +34; __10th __  _[[Spells/Death's Call|Death's Call]]_, _[[Spells/Sudden Shift|Sudden Shift]]_, _[[Spells/Trickster's Twin|Trickster's Twin]]_"

  - name: "Rituals"
    desc: "_Geas_, _Planar Servitor_, _Resurrect_, _Teleportation Circle_"

  - name: "King of Keys"
    desc: "  Delaraius's magic is more powerful when he's located in Vyre or Duskfathom. The counteract DC for all of his spells increases by 2 as long as the spell effect is located in either of these locations, and Delaraius gains a +2 status bonus on counteract checks while in either location."

  - name: "Skinsaw Strike"
    desc: "`pf2:1` (divine) Delaraius focuses his attention on a target he can see, causing his Skinsaw Eye to glow red for a moment as he seeks out the most painful place to attack that target. He then attempts a Medicine check check against the target's Fortitude DC; on a success, that target is [[Conditions/Off-Guard|Off-Guard]] to Delaraius until the end of his turn. On a critical success, that target is off-guard to Delaraius until the end of his next turn."

  - name: "Sneak Attack"
    desc: "  Delaraius deals 3d6 extra precision damage to creatures who are [[Conditions/Off-Guard|Off-Guard]]."
...
name: Delaraius Solzakarr
creatures:
  - 1: Delaraius Solzakarr
```


Male human priest of Norgorber
