---
title: "Karumzek Priest (Divine Immolation)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.curtain-call-bestiary.Actor.9qFTRSaEYnrYDVHH" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +27, Crafting: +23, Intimidation: +27, Religion: +31, Stealth: +29"
abilityMods: [6, 6, 5, 2, 8, 6]
speed: 40 feet,  climb 30 feet
sourcebook: "_Pathfinder #205: Singer, Stalker, Skinsaw Man_"
ac: 37
armorclass:
  - name: AC
    desc: "37; __Fort__ +24, __Ref__ +27, __Will__ +31"
hp: 275
health:
  - name: ""
  - name: HP
    desc: "275; __Immunities__  poison; __Weaknesses__ holy 15"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "Planar Keys, [[Equipment/Magic Wand (7th-Rank Spell)|Wand of Divine Immolation (Rank 7)]]"
...
abilities_mid:
  ...
  - name: "Poison Sense (Precise) 30 feet"
    desc: "  A karumzek senses any poisoned creature. It can spend an action with the concentrate trait to determine the poison's type and current stage."
...
attacks:
  ...
  - name: "Occult Innate Spells"
    desc: "DC 36, attack +28; __8th __  _[[Spells/Vision of Death|Vision of Death]]_, _[[Spells/Vomit Swarm|Vomit Swarm]]_; __2nd __  _[[Spells/Invisibility|Invisibility (At Will, Self Only)]]_"

  - name: "[[Bestiary Ability Glossary/Change Shape|Change Shape]]"
    desc: "`pf2:1` (arcane,concentrate,polymorph) A karumzek can take the shape of a Tiny spider. This doesn't change its Speed or Strikes."

  - name: "Karumzek Venom"
    desc: " (poison,virulent) **Saving Throw** DC 36 Fortitude check\n\n**Maximum Duration** 6 rounds\n\n**Stage 1** 1d6 poison (1 round)\n\n**Stage 2** 1d6 poison + 1d6 spirit, and [[Conditions/Enfeebled|Enfeebled 1]] (1 round)\n\n**Stage 3** 2d6 poison + 2d6 spirit, [[Conditions/Clumsy|Clumsy 1]], and enfeebled 1 (1 round)"
...
name: Karumzek Priest (Divine Immolation)
creatures:
  - 1: Karumzek Priest (Divine Immolation)
```
