...
cssClasses: pf2e
aliases: "Compendium.pf2e.seven-dooms-for-sandpoint-bestiary.Actor.UqQwDPkaVhh3Ehht" 
tags:
...
armorclass:
  - name: AC
    desc: "28; __Fort__ +18, __Ref__ +22, __Will__ +21"
hp: 150
health:
  - name: ""
  - name: HP
    desc: "150, void healing, rejuvenation; __Immunities__  death effects,  disease,  paralyzed,  poison,  precision,  unconscious,  blinded,  visual; __Resistances__ all damage 10 (except force, ghost touch, or vitality; double resistance vs. non-magical)"
abilities_top:
  - name: ""

  - name: "[[Creature Family Ability Glossary/(Ghost) Site Bound|Trinket Bound]]"
    desc: "  Jervis Stoot can normally stray only a short distance from the underground chambers atop Chopper's Isle just north of Sandpoint, but when the head of the clockwork songbird is brought out of that area, Stoot can follow. As long as a creature he possesses carries the head, he can travel as he wishes, but no further than 5 miles from the town of Sandpoint."

abilities_mid:
  - name: ""
  - name: "Avian Vulnerability"
