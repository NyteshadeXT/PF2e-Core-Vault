...
attacks:
  ...
  - name: "Routine"
    desc: "`pf2:2` If there are fewer wemmuths than open flowers, the flowers create more wemmuths (so there as many wemmuths as open flowers) as their first action.\nFor their second action, the flowers produce a mind-addling pollen. Each non-plant creature within 30 feet of a flower must succeed at a DC 41 Fortitude check save or become [[Conditions/Slowed 1|Slowed 1]] for 1 round (or [[Conditions/Confused|Confused]] for 1 round, on a critical failure). The pollen is an emotion, mental, and olfactory effect."
  - name: "Reset"
