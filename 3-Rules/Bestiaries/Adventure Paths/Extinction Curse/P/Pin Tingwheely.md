---
title: "Pin Tingwheely"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.extinction-curse-bestiary.Actor.2Ey2VZ3aQlN4FGHJ" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +18, Deception: +16, Nature: +15, Performance: +18, Stealth: +21"
abilityMods: [0, 6, 1, 2, 3, 4]
speed: 15 feet,  fly 45 feet
sourcebook: "_Pathfinder #153: Life&#x27;s Long Shadows_"
ac: 29
armorclass:
  - name: AC
    desc: "29; __Fort__ +15, __Ref__ +20, __Will__ +17; +1 status to all saves vs. magic"
hp: 95
health:
  - name: ""
  - name: HP
    desc: "95; __Weaknesses__ cold iron 10"
abilities_top:
  - name: ""
  - name: "Items"
...
abilities_mid:
  - name: ""
  - name: "Evasion"
    desc: "  When Pin rolls a success on a Reflex save, he gets a critical success instead."

  - name: "[[Bestiary Ability Glossary/Nimble Dodge|Nimble Dodge]]"
    desc: "`pf2:r`  **Trigger** Pin is targeted with a melee or ranged attack by an attacker he can see.\n* * *\n\nPin gains a +2 circumstance bonus to AC against the triggering attack."
