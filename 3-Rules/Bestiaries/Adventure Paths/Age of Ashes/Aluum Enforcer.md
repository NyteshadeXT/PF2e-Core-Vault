...
attacks:
  ...
  - name: "Soul Shriek"
    desc: "`pf2:2` (arcane,auditory,mental,sonic) The aluum enforcer emits a keening wail in a 15-foot cone that deals 9d6 sonic damage (DC 27 Fortitude check save). A creature that fails its save is [[Conditions/Stunned|Stunned 1]], or [[Conditions/Stunned|Stunned 3]] on a critical failure.\n\nThe aluum can't use Soul Shriek again for 1d4 rounds."
