---
title: "Candlaron's Echo"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.age-of-ashes-bestiary.Actor.53lk7ek73j65A09B" 
tags:
...
perception:
  - name: "Perception"
    desc: "+35; Darkvision"
languages: "Draconic, Elven, Fey"
skills:
  - name: "Skills"
    desc: "Arcana: +40, Diplomacy: +36, Occultism: +40, Religion: +36, Stealth: +34"
abilityMods: [-5, 10, 0, 10, 7, 8]
speed:  fly 25 feet
sourcebook: "_Pathfinder #150: Broken Promises_"
ac: 46
armorclass:
  - name: AC
    desc: "46; __Fort__ +30, __Ref__ +33, __Will__ +36"
hp: 315
health:
  - name: ""
  - name: HP
    desc: "315, void healing, rejuvenation; __Immunities__  death effects,  disease,  paralyzed,  poison,  precision,  unconscious; __Resistances__ all damage 15 (except force, ghost touch, or vitality; double resistance vs. non-magical)"
abilities_top:
  - name: ""

  - name: "Site Bound"
    desc: "  The Echo cannot leave the clearing.\n* * *\n\nA typical ghost can stray only a short distance from where it was killed or the place it haunts. A typical limit is 120 feet. Some ghosts are instead bound to a room, building, item, or creature that was special to it rather than a location."

abilities_mid:
  - name: ""
  - name: "Rejuvenation"
    desc: " (divine) Candlaron's echo rejuvenates so long as Dahak's manifestation lives.\n* * *\n\nWhen a ghost is destroyed, it re-forms after 2d4 days within the location it's bound to, fully healed. A ghost can be permanently destroyed only if someone determines the reason for its existence and sets right whatever prevents the spirit from resting."
