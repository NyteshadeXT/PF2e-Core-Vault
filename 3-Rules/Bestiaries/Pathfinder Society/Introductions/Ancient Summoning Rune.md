...
health:
  - name: ""
  - name: "HP"
    desc: "24; __Hardness__ 7; __Immunities__  object immunities,  critical hits,  precision"
perception:
  - name: ""
  - name: "Stealth DC 7" 
    desc: "(trained)"
abilities_top:
  - name: ""
  - name: "Description"
    desc: "A cloud of invisible magical sensors in a 10-foot radius surrounds the central column of the room."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 15 Acrobatics check to approach without triggering the trap followed by DC 17 Thievery check (trained) to erase the rune, or DC 19 Athletics check to remove enough stones from the pillar to disrupt the magic, or [[Spells/Dispel Magic|Dispel Magic]] (1st level; counteract DC 15) to counteract the rune."
attacks:
  - name: ""

  - name: "Summon Weak Monster"
