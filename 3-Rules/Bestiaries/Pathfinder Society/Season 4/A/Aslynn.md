...
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-4-bestiary.Actor.IMeWlbCAMJRKc5Ao" 
tags:
...
skills:
  - name: "Skills"
    desc: "Arcana: +19, Deception: +19, Diplomacy: +17, Intimidation: +19, Occultism: +21, Religion: +19"
...
armorclass:
  - name: AC
    desc: "27; __Fort__ +18, __Ref__ +16, __Will__ +19; +2 status to all saves vs. magic, -2 to all saves (if heartstone is lost)"
hp: 160
health:
  - name: ""
  - name: HP
    desc: "160; __Immunities__  sleep; __Weaknesses__ cold iron 10; __Resistances__ mental 10, cold 10, fire 10"
abilities_top:
  - name: ""
  - name: "Items"
...
attacks:
  ...
  - name: "Nightmarish Wounds"
    desc: " (occult) Wounds caused by Aslynn's claws cause creatures to dwell on their worst nightmares. A creature damaged by Aslynn's claw must succeed at a DC 25 Fortitude check save or be [[Conditions/Stupefied|Stupefied 1]] for 1 day. On a critical failure, or if it gets hit again and fails its save a second time, it's [[Conditions/Stupefied|Stupefied 2]] for 1 day."
...
A night hag is a canny mastermind and soul broker, willing to consider any deal as long as she is convinced she has the upper hand. Although a night hag finds it easy to travel the Ethereal Plane and prey upon helpless souls that can't fight back, these souls are also the least desirable to the evil outsiders the night hag bargains with, and so a night hag gathers allies and minions that allow her to prey on more potent souls without personally risking herself. Their favored minions are [[3-Rules/Bestiaries/Monster Core/N/Nightmare|Nightmares]], with whom they share a special bond.
