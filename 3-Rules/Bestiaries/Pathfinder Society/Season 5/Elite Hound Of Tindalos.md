---
title: "Elite Hound Of Tindalos"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-5-bestiary.Actor.uxnlSeL2HruddbcF" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +19, Athletics: +17, Occultism: +19, Stealth: +19, Survival: +15"
...
armorclass:
  - name: AC
    desc: "27; __Fort__ +15, __Ref__ +19, __Will__ +17"
hp: 110
health:
  - name: ""
  - name: HP
    desc: "110; __Immunities__  controlled,  emotion; __Resistances__ mental 10, poison 10, physical 10"
abilities_top:
  - name: ""
...
abilities_mid:
  ...
  - name: "Otherworldly Mind"
    desc: " (mental) Whenever a creature targets the hound with a mental effect, that creature takes 4d6+2 mental damage (DC 25 Will check save). On a critical failure, it also becomes [[Conditions/Confused|Confused]] for 1d4 rounds."

  - name: "Ripping Gaze"
    desc: " (aura,occult,visual) 30 feet. The hound of Tindalos's eyes glow balefully, causing painful but bloodless wounds to rip open in the body of a creature that meets its awful gaze. When a creature ends its turn in the aura's emanation, it takes 4d6+2 slashing damage (DC 25 Fortitude check save).\n\nA creature that critically succeeds at its save is temporarily immune for 24 hours."
