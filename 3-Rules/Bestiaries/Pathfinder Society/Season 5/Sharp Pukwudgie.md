---
title: "Sharp Pukwudgie"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-5-bestiary.Actor.5XCozjNbo5j47UEQ" 
tags:
...
skills:
  - name: "Skills"
    desc: "Crafting: +17, Deception: +16, Medicine: +17, Nature: +19, Stealth: +19, Thievery: +17"
...
armorclass:
  - name: AC
    desc: "27; __Fort__ +14, __Ref__ +17, __Will__ +19"
hp: 120
health:
  - name: ""
  - name: HP
    desc: "120; __Weaknesses__ cold iron 10; __Resistances__ poison 5"
abilities_top:
  - name: ""
  - name: "Items"
...
abilities_mid:
  ...
  - name: "Defensive Quills"
    desc: "  A creature that hits a pukwudgie with an unarmed Strike or a non-reach melee Strike takes 3d8 piercing damage (DC 23 Reflex check save). On a critical failure, the creature also takes 1d6 persistent poison from the poisoned quills.\n* * *\n\n_Note: A DC was not provided for this ability by Paizo. The DC present here is a moderate DC for the creature level according to the Gamemastery Guide creature building Tables_"

attacks:
  - name: ""

  - name: "Melee"
    desc: "`pf2:1` Hatchet +19 (agile, magical, sweep)\n__Damage__  1d6 + 12 slashing plus pukwudgie-poison"

  - name: "Ranged"
    desc: "`pf2:1` Hatchet +21 (magical, thrown 10 ft.)\n__Damage__  1d6 + 12 slashing plus pukwudgie-poison"

  - name: "Ranged"
    desc: "`pf2:1` Shortbow +20 (deadly d10, range increment 60 feet)\n__Damage__  1d6 + 8 piercing plus pukwudgie-poison"
  ...
  - name: "[[Bestiary Ability Glossary/Change Shape|Change Shape]]"
    desc: "`pf2:1` (concentrate,polymorph,primal) The pukwudgie takes on the physical form of a [[Bestiary 3/Giant Porcupine|Giant Porcupine]]. Their size changes to Medium, they lose their weapon Strikes, and they gain a quill Strike (+20 for 2d8+8 piercing plus 1d8 persistent poison).\n\n* * *\n"
