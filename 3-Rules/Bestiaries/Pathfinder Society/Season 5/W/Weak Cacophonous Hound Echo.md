---
title: "Weak Cacophonous Hound Echo"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-5-bestiary.Actor.Hysy3I3yiYsUZHxY" 
tags:
...
statblock: inline
name: "Weak Cacophonous Hound Echo"
level: 3
license: OGL
---
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +10, Athletics: +9, Occultism: +10, Stealth: +10, Survival: +6"
...
health:
  - name: ""
  - name: HP
    desc: "23; __Immunities__  controlled,  emotion; __Resistances__ mental 3, poison 3, physical 3"
abilities_top:
  - name: ""
...
abilities_mid:
  - name: ""
  - name: "Churning Gaze"
    desc: " (aura,occult,visual) 30 feet. The hound echo's eyes glow balefully, causing the internal organs of a creature that meets its awful gaze to churn and spasm. When a creature ends its turn in the aura's emanation, it must succeed at a DC 21 Fortitude check save or be [[Conditions/Sickened|Sickened 1]] (or [[Conditions/Sickened|Sickened 2]] on a critical failure). A creature that critically succeeds at its save is temporarily immune for 24 hours."

  - name: "Otherworldly Mind"
    desc: " (mental) Whenever a creature targets the hound with a mental effect, that creature takes 1d6+2 mental damage (DC 21 Will check save). On a failure, it also becomes [[Conditions/Frightened|Frightened 1]] (or [[Conditions/Frightened|Frightened 2]] on a critical failure)."
...
attacks:
  ...
  - name: "**Melee** `pf2:1` Claw"
    desc: "+13 (agile, unarmed)\n__Damage__  1d10 + 2 slashing"

  - name: "Occult Innate Spells"
    desc: "DC 24, attack +16; __8th __  _[[Spells/Pinpoint|Discern Location]]_; __4th __  _[[Spells/Planar Tether|Dimensional Anchor]]_; __3rd __  _[[Spells/Haste|Haste]]_, _[[Spells/Slow|Slow]]_; __2nd __  _[[Spells/Invisibility|Invisibility (Self only)]]_"
