---
title: "Barnacle Barnaby (5-6)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-5-bestiary.Actor.YKy7KS3pxT9tuRWp" 
tags:
...
attacks:
  ...
  - name: "**Melee** `pf2:1` Jaws"
    desc: "+13 (finesse, unarmed)\n__Damage__  1d6 + 7 piercing plus ghoul-ghoul-fever"
  ...
  - name: "[[Creature Family Ability Glossary/(Ghoul) Consume Flesh|Consume Flesh]]"
    desc: "`pf2:1` (manipulate) **Requirements** The lacedon is adjacent to the corpse of a creature that died within the last hour.\n* * *\n\n**Effect** The lacedon devours a chunk of the corpse and regains 3d6 healing Hit Points. It can regain Hit Points from any given corpse only once."
