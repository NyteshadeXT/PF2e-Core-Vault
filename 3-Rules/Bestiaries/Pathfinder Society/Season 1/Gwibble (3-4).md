...
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-1-bestiary.Actor.oQmjMw2MTQDSGRs7" 
tags:
...
armorclass:
  - name: AC
    desc: "20; __Fort__ +7, __Ref__ +11, __Will__ +9"
hp: 44
health:
  - name: ""
  - name: HP
    desc: "44; __Weaknesses__ cold iron 2"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "10x [[Equipment/Dart|Dart]], [[Equipment/Shortsword|Shortsword]], [[Equipment/Black Adder Venom|Black Adder Venom]]"
  - name: "Self-Loathing"
...
attacks:
  ...
  - name: "Ranged"
    desc: "`pf2:1` Dart +11 (agile, range increment 20 feet, thrown)\n__Damage__  1d4 piercing plus black-adder-venom"

  - name: "Primal Innate Spells"
    desc: "DC 20, attack +12; __2nd __ (1 slots) _[[Spells/Speak with Animals|Speak with Animals (At Will) (Arthropods only)]]_; __1st __ (1 slots) _[[Spells/Bane|Bane]]_\n__Cantrips__  __(2nd)__ _[[Spells/Prestidigitation|Prestidigitation]]_"

  - name: "Baleful Blade"
    desc: "  Any creature affected by the [[Spells/Bane|Bane]] spell is [[Conditions/Off-Guard|Off-Guard]] to Gwibble."

  - name: "Hidden Movement"
    desc: "  If Gwibble starts his turn [[Conditions/Undetected|Undetected]] by a creature or merely [[Conditions/Hidden|Hidden]] from it, that creature is [[Conditions/Off-Guard|Off-Guard]] against Gwibble's attacks until the end of Gwibble's turn."
