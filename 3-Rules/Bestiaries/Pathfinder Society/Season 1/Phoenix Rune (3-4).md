...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 18 Acrobatics check to approach without triggering the trap followed by DC 18 Thievery check (trained) to erase the rune, or [[Spells/Dispel Magic|Dispel Magic]] (1st level, counteract DC 18) to counteract the rune."
attacks:
  - name: ""
