---
title: "Manifestation of Qxal (3-4)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-1-bestiary.Actor.lvWJic1WYdyJATa0" 
tags:
...
statblock: inline
name: "Manifestation of Qxal (3-4)"
level: 6
license: OGL
---
...
skills:
  - name: "Skills"
    desc: "Arcana: +15, Athletics: +15, Deception: +18, Intimidation: +16, Nature: +18, Society: +15, Bhopan Lore: +16"
abilityMods: [5, 5, 4, 2, 4, 4]
...
health:
  - name: ""
  - name: HP
    desc: "125, bloodsoaked soil (regeneration 20); __Weaknesses__ fire 8; __Resistances__ acid 5"
abilities_top:
  - name: ""
...
abilities_mid:
  ...
  - name: "Blood Siphon"
    desc: "`pf2:r`  **Trigger** A creature within 60 feet takes [[Conditions/Persistent Damage|Persistent Bleed Damage]].\n* * *\n\n**Effect** The shed blood disperses into a fine mist that the manifestation siphons up with its proboscis. The manifestation regains 10 healing HP."

  - name: "Hallucinatory Scale Dust"
    desc: " (aura,illusion,mental) 30 feet. Fey glamours shed from Qxal's wings like scale dust, causing hallucinations. A creature entering the aura or starting its turn in the area must attempt a DC 21 Will check save.\n* * *\n\n**Critical Success** The creature is unaffected and is temporarily immune to the scale dust for 24 hours.\n\n**Success** The creature is unaffected.\n\n**Failure** The creature hallucinates that it is beginning to transform into a plant or animal native to their homeland, becoming either [[Conditions/Clumsy|Clumsy 1]], [[Conditions/Enfeebled|Enfeebled 1]], or [[Conditions/Stupefied|Stupefied 1]], at Qxal's choice. The condition lasts for 1 hour. Each time a creature fails this save, Qxal can choose an additional condition.\n\n**Critical Failure** As failure, but the condition value is 2 ([[Conditions/Clumsy|Clumsy 2]], [[Conditions/Enfeebled|Enfeebled 2]], or [[Conditions/Stupefied|Stupefied 2]])."

attacks:
  - name: ""

  - name: "**Melee** `pf2:1` Proboscis"
    desc: "+17 (deadly d12, reach 10 feet)\n__Damage__  2d12 + 7 piercing"

  - name: "**Melee** `pf2:1` Tendril"
    desc: "+17 (agile, reach 15 feet)\n__Damage__  2d10 + 5 slashing 1d4 bleed"

  - name: "**Ranged** `pf2:1` Thorn"
    desc: "+17 (range 60 feet)\n__Damage__  2d4 + 5 piercing 1d4 bleed"

  - name: "Primal Innate Spells"
    desc: "DC 21, attack +13; __3rd __  _[[Spells/Wall of Thorns|Wall of Thorns (At Will)]]_; __2nd __  _[[Spells/Entangling Flora|Entangle (At Will)]]_\n__Cantrips__  __(3rd)__ _[[Spells/Tangle Vine|Tanglefoot]]_"

  - name: "Capsize"
    desc: "`pf2:2` (manipulate) **Requirements** The manifestation is standing on the deck of the _Unsinkable_.\n* * *\n\n**Effect** The manifestation shakes the ship violently. [[Actions/Trip|Trip]] every foe on the _Unsinkable_ (roll one Athletics check check and compare the result to each foe's Fortitude DC)."

  - name: "Flutter"
    desc: "`pf2:1`  The manifestation Flies. Any creature it passes within 30 feet of during its Flutter is exposed to its hallucinatory scale dust."
