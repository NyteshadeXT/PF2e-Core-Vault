---
title: Collapsing Barricade (1-2)
...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 18 Thievery check (trained) to carefully trigger the collapse without entering the tunnel or DC 22 Thievery check (trained) to brace the tunnel so it is safe to pass through."
attacks:
  - name: ""
