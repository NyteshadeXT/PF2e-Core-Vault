...
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-1-bestiary.Actor.ihm2nXJtzcgFUJRN" 
tags:
...
speed: 30 feet
sourcebook: "_Pathfinder Society Quest #1: The Sandstone Secret_"
ac: 24
armorclass:
  - name: AC
    desc: "24 (20 when broken); construct armor; __Fort__ +15, __Ref__ +8, __Will__ +7"
hp: 80
health:
  - name: ""
  - name: HP
    desc: "80; __Hardness__ 10; __Immunities__  bleed,  death effects,  disease,  doomed,  drained,  fatigued,  healing,  nonlethal attacks,  paralyzed,  poison,  sickened,  spirit,  unconscious,  vitality,  void,  mental"
abilities_top:
  - name: ""
...
attacks:
  ...
  - name: "**Melee** `pf2:1` Stone Fist"
    desc: "+17 (magical)\n__Damage__  2d12 + 4 bludgeoning plus grab"

  - name: "**Ranged** `pf2:1` Flaming Coal"
    desc: "+17 (fire, magical, range increment 80 feet)\n__Damage__  2d6 + 4 bludgeoning"
  ...
  - name: "Burn Alive"
    desc: "`pf2:1` (fire) The statue grinds a creature it has [[Conditions/Grabbed|Grabbed]] into the red-hot coals of its brazier. The target takes 3d6 fire + 1d8 persistent fire damage."
