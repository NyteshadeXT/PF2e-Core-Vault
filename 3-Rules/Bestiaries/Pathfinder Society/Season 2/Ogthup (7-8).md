...
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-2-bestiary.Actor.3VXbICsrBiOGnxiz" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +13, Stealth: +15, Survival: +17"
...
health:
  - name: ""
  - name: HP
    desc: "84; __Resistances__ cold 6"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Dagger|+1 Striking Dogpiercer Knife]], [[Equipment/Leather Armor|Leather Armor]]"
  - name: "Handout Information"
    desc: "  In combat, Ogthup is a minion. Once per round, any PC can spend an action to command Ogthup (this has the auditory, concentrate, and linguistic traits), and have her take two actions. If reduced below 15 HP, Ogthup scampers away and dives into a snowdrift, to return once the coast is clear. If reduced to 0 HP, she falls unconscious rather than dying immediately."
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Dogpiercer Knife +16 (agile, finesse, versatile s)\n__Damage__  2d6 + 5 piercing"
