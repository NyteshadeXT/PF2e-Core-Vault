...
abilities_top:
  - name: ""
  - name: "Description"
    desc: "Abyssal fire rains from the sky."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 31 Arcana check, DC 31 Nature check, DC 31 Occultism check, or DC 31 Religion check (trained) twice or [[Spells/Dispel Magic|Dispel Magic]] (4th level; counteract DC 24) to cause a temporary, local disruption to the Disciple of Urxehl's ritual. Checks to disrupt the firestorm require two actions. Defeating the Disciple of Urxehl also disables the hazard."
attacks:
  - name: ""
  ...
  - name: "Melee"
    desc: "Corrupted Fire Bolt +20 (fire, magical, unholy) No MAP applies to strikes made by corrupted fire bolt attacks"
