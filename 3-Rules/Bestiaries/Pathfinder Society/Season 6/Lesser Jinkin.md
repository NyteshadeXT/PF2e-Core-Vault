...
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-6-bestiary.Actor.D7XibY38wx9AjopU" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +5, Crafting: +3, Deception: +3, Nature: +3, Stealth: +5, Thievery: +7"
...
armorclass:
  - name: AC
    desc: "13; __Fort__ +4, __Ref__ +8, __Will__ +5"
hp: 9
health:
  - name: ""
  - name: HP
...
attacks:
  ...
  - name: "**Melee** `pf2:1` Shortsword"
    desc: "+7 (agile, finesse, reach 0 feet, versatile s)\n__Damage__  1d6 - 4 piercing"

  - name: "Primal Innate Spells"
    desc: "DC 15, attack +7\n__Cantrips__  __(1st)__ _[[Spells/Prestidigitation|Prestidigitation]]_"

  - name: "Sneak Attack"
    desc: "  The jinkin deals 1d4 extra precision damage to [[Conditions/Off-Guard|Off-Guard]] creatures."
