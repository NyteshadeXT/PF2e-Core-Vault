---
title: "Enraged Bun the Black"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-6-bestiary.Actor.wcgXXXDuc8RzUl3P" 
tags:
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +14, Athletics: +13, Intimidation: +9, Stealth: +12, Survival: +10"
abilityMods: [4, 5, 3, -1, 3, 0]
...
health:
  - name: ""
  - name: HP
    desc: "75; __Immunities__  paralyzed,  sleep; __Resistances__ acid 10"
abilities_top:
  - name: ""
...
abilities_mid:
  - name: ""
  - name: "Tail Lash"
    desc: "`pf2:r`  **Trigger** A creature within reach of Bun the Black's tail uses an action to Strike or attempt a skill check\n* * *\n\n**Effect** Bun the Black attempts to Strike the triggering creature with their tail. If it hits, the target takes a –2 circumstance penalty to the triggering roll.\n\n[[Bestiary Effects/Effect_ Tail Lash|Effect: Tail Lash]]"
...
attacks:
  ...
  - name: "Caustic Mucus"
    desc: "`pf2:2` (acid,primal) Bun the Black spits a ball of caustic mucus up to a range of 50 feet that explodes in a 10-foot burst. Creatures within the burst take 4d8 acid damage (DC 21 Reflex check save). Those that fail this save also take 1d6 persistent acid damage and take a –5-foot status penalty to their Speed. This Speed reduction ends with the persistent acid damage. Bun the Black can't use Caustic Mucus again for 1d6 rounds.\n\n[[Bestiary Effects/Effect_ Caustic Mucus|Effect: Caustic Mucus]]"

  - name: "Draconic Frenzy"
    desc: "`pf2:2`  Bun the Black makes one fangs Strike and two tail Strikes in any order."

  - name: "Speed Surge"
    desc: "`pf2:1` (move) **Frequency** three times per day\n* * *\n\n**Effect** Bun the Black Strides or Flies twice."
