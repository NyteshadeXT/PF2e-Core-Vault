---
title: "Elite Wood Scamp"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-6-bestiary.Actor.hcHtUbPVInjQ5TEb" 
tags:
...
armorclass:
  - name: AC
    desc: "6; __Fort__ +8, __Ref__ +6, __Will__ +12"
hp: 34
health:
  - name: ""
  - name: HP
    desc: "34; __Immunities__  bleed,  paralyzed,  poison,  sleep; __Weaknesses__ fire 3, slashing 3"
abilities_top:
  - name: ""
...
attacks:
  ...
  - name: "Breathe Pollen"
    desc: "`pf2:2` (arcane,plant) The wood scamp breathes choking pollen in a 15-foot cone that deals 2d6+4 poison damage to each creature within the area (DC 19 Reflex check save; creatures who don't need to breathe are immune). The wood scamp can't Breathe Pollen again for 1d4 rounds."
