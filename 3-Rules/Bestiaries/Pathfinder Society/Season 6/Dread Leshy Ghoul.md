---
title: "Dread Leshy Ghoul"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-6-bestiary.Actor.59X4JpNNQTOg2Fsp" 
tags:
...
skills:
  - name: "Skills"
    desc: "Athletics: +10, Nature: +10, Stealth: +12, Survival: +13"
abilityMods: [3, 6, 2, -1, 3, 0]
speed: 25 feet,  burrow 5 feet
sourcebook: "_Pathfinder Society Scenario #6-06: Rotten Apples_"
ac: 23
armorclass:
  - name: AC
    desc: "23; __Fort__ +12, __Ref__ +14, __Will__ +10"
hp: 52
health:
  - name: ""
  - name: HP
    desc: "52, void healing; __Immunities__  death effects,  disease,  paralyzed,  poison,  unconscious,  bleed"
abilities_top:
  - name: ""
...
attacks:
  ...
  - name: "**Melee** `pf2:1` Claw"
    desc: "+14 (agile, finesse, unarmed)\n__Damage__  1d8 + 5 slashing plus grab"

  - name: "**Ranged** `pf2:1` Spore Pod"
    desc: "+14 (range increment 30 feet)\n__Damage__  1d8 + 5 bludgeoning plus spores"

  - name: "Primal Innate Spells"
    desc: "DC 19, attack +11; __3rd __  _[[Spells/Speak with Plants|Speak with Plants (Constant, Fungi Only)]]_"
  ...
  - name: "Spore Cloud"
    desc: "`pf2:2`  A leshy ghoul can unleash a cloud of spores that irritates the eyes and throats of non-fungus creatures in a 15-foot emanation. Each creature must succeed at a DC 19 Fortitude check save or take 1 persistent poison damage. A creature has its vision reduced as long as the persistent damage continues and can see only within 20 feet."
