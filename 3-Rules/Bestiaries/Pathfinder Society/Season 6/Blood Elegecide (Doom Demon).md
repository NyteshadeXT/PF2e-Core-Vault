---
title: "Blood Elegecide (Doom Demon)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-6-bestiary.Actor.JEaWYZM9W9wH0jLj" 
tags:
  ...
  - remaster
statblock: inline
name: "Blood Elegecide (Doom Demon)"
level: 5
license: ORC
---
...
skills:
  - name: "Skills"
    desc: "Deception: +13, Diplomacy: +12, Intimidation: +13"
abilityMods: [4, 2, 1, 0, 0, 5]
speed: 15 feet,  swim 25 feet
sourcebook: "_Pathfinder Society Scenario #6-00: Salt of the Ocean_"
ac: 22
armorclass:
  - name: AC
    desc: "22; __Fort__ +7, __Ref__ +7, __Will__ +6"
hp: 95
health:
  - name: ""
  - name: HP
    desc: "95; __Weaknesses__ cold iron 6, holy 6"
abilities_top:
  - name: ""
...
abilities_mid:
  - name: ""
  - name: "Doom Aura"
    desc: " (aura,divine,fear) 30 feet\n\nThe elegecide constantly emits telepathic warnings about future dangers and harm. When a non-demon creature ends its turn in the aura, it must attempt a DC 22 Will check save. If it fails, it becomes [[Conditions/Frightened|Frightened 1]] ([[Conditions/Frightened|Frightened 2]] on a critical failure)."
