...
aliases: "Compendium.pf2e.pfs-season-3-bestiary.Actor.1NWTUcGckuJ2qC5I" 
level: 7
license: OGL
statblock: inline
---
...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 27 Thievery check (trained) or DC 25 Arcana check, DC 25 Nature check, DC 25 Occultism check, or DC 25 Religion check (trained) to seal each of the four time rifts, DC 27 Crafting check (trained) to divert the lightning to another source, or [[Spells/Dispel Magic|Dispel Magic]] (3rd level; counteract DC 23) to counteract each time rift."
attacks:
  - name: ""
