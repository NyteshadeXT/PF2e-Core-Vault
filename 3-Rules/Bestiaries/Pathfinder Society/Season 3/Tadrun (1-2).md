...
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-3-bestiary.Actor.WGi99nXZYSv7U92M" 
tags:
...
abilities_top:
  - name: ""
  - name: "Items"
    desc: "[[Equipment/Battle Axe|Battle Axe]], [[Equipment/Spiked Gauntlet|Spiked Gauntlet]], [[Equipment/Leather Armor|Leather Armor]]"
abilities_mid:
  - name: ""
  ...
  - name: "Formation"
    desc: "  When he's adjacent to at least two other allies, Tadrun gains a +1 circumstance bonus to AC and saving throws. This bonus increases to +2 to Reflex saves against area effects."

attacks:
  - name: ""

  - name: "Melee"
    desc: "`pf2:1` Battle Axe +9 (sweep)\n__Damage__  1d8 + 5 slashing"

  - name: "Melee"
    desc: "`pf2:1` Spiked Gauntlet +9 (agile, free-hand)\n__Damage__  1d4 + 5 piercing"
