---
title: "Thick Pelagastr Tail"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pfs-season-3-bestiary.Actor.tVsrWl9kfVIGG5OW" 
tags:
...
skills:
  - name: "Skills"
    desc: "Athletics: +13, Deception: +11, Diplomacy: +11, Religion: +9, Stealth: +13, Thievery: +13"
abilityMods: [4, 4, 2, 3, 1, 3]
speed: 10 feet
sourcebook: "_Pathfinder Society Scenario #3-18: Dacilane Academy&#x27;s Delightful Disaster_"
ac: 20
armorclass:
  - name: AC
    desc: "20; __Fort__ +11, __Ref__ +13, __Will__ +10; +1 Status to All Saves vs. Magic"
hp: 88
health:
  - name: ""
  - name: HP
    desc: "88, fast healing 2; __Resistances__ precision 5, protean anatomy 8"
abilities_top:
  - name: ""
...
abilities_mid:
  ...
  - name: "Discordant Diversion"
    desc: "`pf2:r`  **Trigger** A creature within 30 feet attempts to Communicate from Beyond.\n* * *\n\n**Effect** A shimmer of distracting chaos flashes out from the pelagastr tail. Unless the triggering creature succeeds at a DC 19 Will check save, the activity is disrupted."
...
attacks:
  ...
  - name: "**Melee** `pf2:1` Tail Slap"
    desc: "+12 (magical, reach 10 feet)\n__Damage__  1d12 + 6 bludgeoning plus grab 1d6 spirit plus grab"
