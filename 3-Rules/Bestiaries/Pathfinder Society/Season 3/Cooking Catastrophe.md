...
attacks:
  ...
  - name: "Revolting Mixture"
    desc: "`pf2:0` **Trigger** A creature fails an attempt to Disarm the trap\n**Effect** The incorrect execution of the recipe releases a nauseating odor. The triggering creature must succeed at a DC 20 Fortitude check save or be [[Conditions/Sickened 1|Sickened 1]]."
  - name: "Melee"
