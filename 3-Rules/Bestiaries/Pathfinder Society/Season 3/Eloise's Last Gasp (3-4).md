...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 23 Acrobatics check to maneuver through the fog, DC 21 Religion check to ward off the spirit, or DC 23 Stealth check to move through the fog without attracting attention. Disabling the haunt requires two successful checks, and each attempt takes two actions."
attacks:
  - name: ""
