...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 27 Diplomacy check (expert) to urge the statues to work together, DC 30 Intimidation check (expert) to Coerce the statues away, or DC 33 Occultism check (trained) to oppose the psychic influence. Each check to disable the haunt is a two-action activity; three total successes are required to disable the haunt."
attacks:
  - name: ""
