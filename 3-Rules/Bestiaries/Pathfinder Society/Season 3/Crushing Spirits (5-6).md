...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 18 Religion check or DC 18 Occultism check (trained) to exorcise the spirits, or DC 22 Diplomacy check to provide them with comfort. Each check requires 2 actions, which have the verbal trait, and three successful checks are required to address all ofthe spirits."
attacks:
  - name: ""
