...
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 14 Cooking Lore check (trained) or DC 17 Crafting check to add the proper ingredients to finish the dish. DC 17 Diplomacy check or DC 17 Occultism check to communicate with students when to stir or adjust the heat on a dish. Each disable attempt requires two actions, and three successful checks are required to disable the hazard."
attacks:
  - name: ""
