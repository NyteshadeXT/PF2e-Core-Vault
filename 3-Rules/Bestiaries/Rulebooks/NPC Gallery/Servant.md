...
cssClasses: pf2e
aliases: "Compendium.pf2e.npc-gallery.Actor.1iz7O6DLDJqStojd" 
tags:
...
armorclass:
  - name: AC
    desc: "15 (16 with platter raised); __Fort__ +5, __Ref__ +7, __Will__ +3"
hp: 9
health:
  - name: ""
  - name: HP
...
abilities_mid:
  - name: ""
  - name: "Raise a Shield"
    desc: "`pf2:1`  The serving platter has the same statistics as a [[Equipment/Buckler|Buckler]], but requires a hand to hold.\n**Requirements** You are wielding a shield\nYou position your shield to protect yourself. When you have Raised a Shield, you gain its listed circumstance bonus to AC. Your shield remains raised until the start of your next turn.\n[[Action Macros/Raise a Shield|Raise a Shield]]"

attacks:
  - name: ""

  - name: "Melee"
    desc: "`pf2:1` Cutlery +5 (agile, versatile s)\n__Damage__  1d4 + 1 piercing"

  - name: "Ranged"
    desc: "`pf2:1` Cutlery +5 (agile, thrown 15 ft., versatile s)\n__Damage__  1d4 + 1 piercing"
