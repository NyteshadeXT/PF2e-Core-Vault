---
title: "Kothogaz, Dance Of Disharmony"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.lost-omens-bestiary.Actor.RqdL0YzNF1dG163i" 
tags:
...
perception:
  - name: "Perception"
    desc: "+41; Darkvision, Scent (Imprecise) 120 Feet"
languages: "Aklo; (can&#x27;t speak any language)"
skills:
  - name: "Skills"
    desc: "Acrobatics: +43, Athletics: +41, Stealth: +35"
abilityMods: [10, 10, 9, -3, 8, 6]
speed: 80 feet,  fly 60 feet,  swim 60 feet
sourcebook: "_Pathfinder Lost Omens Monsters of Myth_"
ac: 49
armorclass:
  - name: AC
    desc: "49; __Fort__ +32, __Ref__ +39, __Will__ +35"
hp: 400
health:
  - name: ""
  - name: HP
    desc: "400, regeneration 30; __Immunities__  acid,  clumsy,  disease,  drained,  enfeebled,  mental,  paralyzed,  petrified,  poison,  polymorph,  stupefied; __Resistances__ sonic 20"
abilities_top:
  - name: ""

abilities_mid:
  - name: ""
  - name: "[[Bestiary Ability Glossary/Regeneration|Regeneration 30]]"
  ...
  - name: "Tympanic Heartbeat"
    desc: " (auditory,aura) 120 feet. Kothogaz's heartbeat booms like a deity's drum. A creature that enters or begins its turn in the emanation must attempt a DC 41 Will check save. On a failure, its next two actions must be move actions to move at least half its Speed away from Kothogaz. A creature that critically succeeds is temporarily immune to tympanic heartbeat for 1 minute."

attacks:
  - name: ""

  - name: "**Melee** `pf2:1` Jaws"
    desc: "+39 (reach 20 feet, unarmed, versatile b)\n__Damage__  4d8 + 18 piercing plus many-eyed-blight 2d12 sonic plus many-eyed-blight"

  - name: "**Melee** `pf2:1` Claw"
    desc: "+39 (agile, reach 20 feet, unarmed, versatile b)\n__Damage__  4d6 + 18 slashing plus improved-grab 2d6 acid plus improved-grab"

  - name: "**Ranged** `pf2:1` Bezoar"
    desc: "+39 (range increment 100 feet)\n__Damage__  4d8 + 8 bludgeoning plus many-eyed-blight 2d6 acid plus many-eyed-blight"

  - name: "Disharmonic Door"
