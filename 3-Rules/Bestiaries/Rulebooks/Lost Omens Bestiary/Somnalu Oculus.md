---
title: "Somnalu Oculus"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.lost-omens-bestiary.Actor.hLyLnBn7lEFstUG2" 
tags:
...
health:
  - name: ""
  - name: HP
    desc: "240, regeneration 10 (deactivated by mental); __Weaknesses__ piercing 10"
abilities_top:
  - name: ""
...
abilities_mid:
  - name: ""
  - name: "[[Bestiary Ability Glossary/Regeneration|Regeneration 10 (Deactivated by Mental)]]"
...
attacks:
  ...
  - name: "**Melee** `pf2:1` Dream Tendril"
    desc: "+22 (finesse, magical, reach 10 feet)\n__Damage__  2d10 + 9 bludgeoning"

  - name: "**Ranged** `pf2:1` Dream Bolt"
    desc: "+22 (magical, range 60 feet)\n__Damage__  2d12 + 7 piercing"
...
When Somnalu is defeated, its central eye abandons its dying body to create an ethereal body from the wisps of dreams. Over centuries-or sooner, if it can find a powerful source of nightmares-it can re-form a full body and return to its corporeal self.
