...
cssClasses: pf2e
aliases: "Compendium.pf2e.lost-omens-bestiary.Actor.K2AOcLMDOVNbgPXp" 
tags:
...
attacks:
  ...
  - name: "Surgical Detachment"
    desc: "`pf2:1` (concentrate,manipulate,morph,occult) The conformer detaches part of their body to serve them as an autonomous organism. For the next 24 hours, the conformer gains the loyal service of a fleshforged [[Lost Omens Bestiary/Skinskitter|Skinskitter]]. As long as they remain within 1 mile of each other, the conformer can use the Surgical Detachment action again to empathically direct the actions of their skinskitter servant as well as perceive through its senses. Due to how taxing this process is, the conformer can have only one skinskitter servant at a time."
