...
abilities_top:
  - name: ""
  - name: "Description"
    desc: "Warding magic attempts to trap intruders or would-be thieves in a disrupted time flow."
abilities_mid:
  - name: ""
  - name: "Disable"
    desc: "DC 38 Thievery check (legendary) to rapidly disassemble the spell's myriad components in a single blink of an eye; or [[Spells/Dispel Magic|Dispel Magic]] (9th level; counteract DC 36) to counteract the trap before it triggers or to counteract the effect on one creature after the trap is triggered"
attacks:
  - name: ""
