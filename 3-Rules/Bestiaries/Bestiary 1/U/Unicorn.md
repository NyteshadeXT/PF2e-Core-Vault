...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.c3iA9lkU1QY4YCY6" 
tags:
...
abilities_top:
  ...
  - name: "Wild Empathy"
    desc: "  The unicorn has a connection to the creatures of the natural world that allows it to communicate with them. The unicorn can use Diplomacy to [[Actions/Make an Impression|Make an Impression]] on animals and to make very simple [[Actions/Request|Requests]] of them."
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Horn +12 (holy, magical)\n__Damage__  1d10 + 4 piercing 1d6 spirit"

  - name: "Melee"
    desc: "`pf2:1` Hoof +12 (agile, magical)\n__Damage__  1d8 + 4 bludgeoning"

  - name: "Primal Innate Spells"
    desc: "DC 21, attack +13; __5th __  _[[Spells/Nature's Pathway|Tree Stride]]_; __3rd __  _[[Spells/Heal|Heal (x2)]]_, _[[Spells/Cleanse Affliction|Neutralize Poison]]_; __1st __  _[[Spells/Detect Alignment|Detect Alignment (At Will) (Good Only)]]_\n__Cantrips__  __(2nd)__ _[[Spells/Light|Light]]_"
