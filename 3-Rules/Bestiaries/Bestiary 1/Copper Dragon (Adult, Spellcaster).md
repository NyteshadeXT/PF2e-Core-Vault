...
attacks:
  ...
  - name: "**Melee** `pf2:1` Jaws"
    desc: "+26 (acid, magical, reach 10 feet, unarmed)\n__Damage__  3d8 + 12 piercing 2d8 acid"

  - name: "**Melee** `pf2:1` Claw"
    desc: "+26 (agile, magical, unarmed)\n__Damage__  3d8 + 12 slashing"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2`  The copper dragon breathes in one of two ways.\n\nThe dragon can't use Breath Weapon again for 1d4 rounds.\n\n*   **Acid** (acid, arcane) The dragon breathes acid in a 80-foot line that deals 13d6 acid damage (DC 32 Reflex check save).\n*   **Slowing Gas** (arcane) The dragon breathes a 80-foot line of slowing gas. Each creature in the area must succeed at a DC 32 Fortitude check save or be [[Conditions/Slowed|Slowed 1]] for 1 round (or [[Conditions/Slowed|Slowed 2]] on a critical failure)."
