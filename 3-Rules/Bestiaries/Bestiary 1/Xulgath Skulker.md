...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.4zXn6xaaxo1DtIRk" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/humanoid/darklands/xulgath-skulker.webp| ]]
...
armorclass:
  - name: AC
    desc: "19; __Fort__ +8, __Ref__ +10, __Will__ +5"
hp: 28
health:
  - name: ""
  - name: HP
...
abilities_mid:
  ...
  - name: "Stench Suppression"
    desc: "`pf2:0`  A xulgath skulker can suppress its stench aura as a free action to better hide its presence. The skulker can resume its stench aura as a free action."
...
attacks:
  ...
  - name: "Hidden Movement"
    desc: "  If a xulgath skulker starts its turn [[Conditions/Undetected|Undetected]] by a creature or merely [[Conditions/Hidden|Hidden]] from it, that creature is [[Conditions/Off-Guard|Off-Guard]] against the skulker's attacks until the end of the skulker's turn."
