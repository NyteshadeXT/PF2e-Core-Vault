...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.NgCKGq28Qvt6ZOSr" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/dragons/dragon-gold-adult.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Jaws +30 (fire, magical, reach 15 feet)\n__Damage__  3d12 + 15 piercing 3d6 fire"
  ...
  - name: "Melee"
    desc: "`pf2:1` Horns +28 (agile, magical, reach 15 feet)\n__Damage__  2d12 + 13 piercing"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane,fire) The gold dragon breathes in one of two ways.\n\nThe dragon can't use Breath Weapon again for 1d4 rounds.\n\n*   **Flame** The dragon breathes a blast of flame in a @Template[cone|distance:40|traits:arcane,evocation,fire,damaging-effect] that deals 15d6 fire damage (DC 37 Reflex check save).\n*   **Weakening Gas** The dragon breathes a blast of weakening gas. Each creature within a @Template[cone|distance:40|traits:arcane,necromancy] must succeed at a DC 37 Fortitude check save or become [[Conditions/Enfeebled|Enfeebled 2]] for 1 minute (or [[Conditions/Enfeebled|Enfeebled 3]] on a critical failure)."
