---
title: "Young Copper Dragon (Spellcaster)"
...
statblock: inline
name: "Young Copper Dragon (Spellcaster)"
level: 8
license: OGL
---
...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (acid,arcane) The copper dragon breathes in one of two ways.\nThe dragon can't use Breath Weapon again for 1d4 rounds.\n*   **Acid** The dragon breathes acid in a 60-foot line that deals 8d6 acid damage (DC 26 Reflex check save).\n*   **Slowing Gas** The dragon breathes a 60-foot line of slowing gas. Each creature in the area must succeed at a DC 26 Fortitude check save or be [[Conditions/Slowed 1|Slowed 1]] for 1 round (or [[Conditions/Slowed 1|Slowed 2]] on a critical failure)."
