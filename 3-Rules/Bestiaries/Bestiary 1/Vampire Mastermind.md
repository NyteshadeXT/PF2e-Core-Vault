...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.yxCmLBpw6xqWFU3E" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/undead/vampiric/vampire-mastermind.webp| ]]
...
skills:
  - name: "Skills"
    desc: "Acrobatics: +17, Arcana: +21, Athletics: +16, Deception: +20, Diplomacy: +20, Intimidation: +22, Society: +19, Stealth: +19"
...
health:
  - name: ""
  - name: HP
    desc: "115, coffin restoration, fast healing 10, void healing; __Immunities__  death effects,  disease,  paralyzed,  poison,  sleep; __Weaknesses__ vampire weaknesses 0; __Resistances__ physical 10 (except magical silver)"
abilities_top:
  - name: ""
  - name: "Items"
    desc: "Signet Ring"
...
attacks:
  ...
  - name: "Arcane Prepared Spells"
    desc: "DC 29, attack +19; __4th __  _[[Spells/Fire Shield|Fire Shield]]_, _[[Spells/Phantasmal Killer|Phantasmal Killer]]_, _[[Compendium.pf2e.spells-srd.Item.hkfH9Z53hPzcOwNB|Veil]]_, _[[Spells/Wall of Fire|Wall of Fire]]_; __3rd __  _[[Spells/Fireball|Fireball]]_, _[[Spells/Haste|Haste]]_, _[[Spells/Lightning Bolt|Lightning Bolt]]_; __2nd __  _[[Spells/Dispel Magic|Dispel Magic]]_, _[[Spells/Floating Flame|Flaming Sphere]]_, _[[Spells/Invisibility|Invisibility]]_, _[[Spells/Mirror Image|Mirror Image]]_, _[[Spells/Stupefy|Touch of Idiocy]]_; __1st __  _[[Spells/Dizzying Colors|Color Spray]]_, _[[Spells/Fleet Step|Fleet Step]]_, _[[Spells/Enfeeble|Ray of Enfeeblement]]_\n__Cantrips__  __(4th)__ _[[Spells/Detect Magic|Detect Magic]]_, _[[Spells/Telekinetic Hand|Mage Hand]]_, _[[Spells/Message|Message]]_, _[[Spells/Ray of Frost|Ray of Frost]]_, _[[Spells/Sigil|Sigil]]_"
  ...
  - name: "[[Creature Family Ability Glossary/(Vampire, True) Change Shape|Change Shape]]"
    desc: "`pf2:1` (concentrate,divine,polymorph) The vampire transforms into its animal form or back into its normal form.\n*   **Bat** The vampire changes into a [[Bestiary 1/Giant Bat|Giant Bat]]\n*   **Size** Large\n*   **Senses** Echolocation 40 feet\n*   **Speed** 20 feet, fly 30 feet\n*   **Melee** fangs +19/+14/+9, **Damage** 2d8 + 9 piercing damage\n"
  ...
  - name: "Drain Bonded Item"
    desc: " (arcane,wizard) **Frequency** Once per day.\n**Requirements** The vampire hasn't acted yet on this turn.\n**Effect** The vampire expends the power stored in its signet ring. This gives the vampire the ability to cast one prepared spell it had already previously cast today, without spending a spell slot. The vampire must still Cast the Spell and meet the spell's other requirements."

  - name: "[[Creature Family Ability Glossary/(Vampire, True) Drink Blood|Drink Blood]]"
    desc: "`pf2:1` (divine) **Requirements** A [[Conditions/Grabbed|Grabbed]], [[Conditions/Paralyzed|Paralyzed]], [[Conditions/Restrained|Restrained]], [[Conditions/Unconscious|Unconscious]], or willing creature is within the vampire's reach.\n**Effect** The vampire sinks its fangs into that creature to drink its blood. This requires an Athletics check check against the victim's Fortitude DC if the victim is grabbed and is automatic for any of the other conditions.\nThe victim is [[Conditions/Drained 1|Drained 2]] and the vampire regains 10 Hit Points, gaining any excess HP as temporary Hit Points. Drinking Blood from a creature that's already drained doesn't restore any HP to the vampire but increases the victim's drain value by 1. A vampire can also consume blood that's been emptied into a vessel for sustenance, but it gains no HP from doing so.\nA victim's drained condition decreases by 1 per week. A blood transfusion, which requires a DC 20 Medicine check check and sufficient blood or a blood donor, reduces the drain by 1 after 10 minutes."

  - name: "Steady Spellcasting"
    desc: "  If another creature's reaction would disrupt the vampire mastermind's spellcasting action, the vampire attempts a DC 15 Flat check check. If the vampire succeeds, its action isn't disrupted."
