...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.x6wfK4UCJ6wYok9t" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/linnorms/tor-linnorm.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Jaws +40 (magical, reach 30 feet)\n__Damage__  4d12 + 19 piercing plus tor-linnorm-venom"

  - name: "Melee"
    desc: "`pf2:1` Claw +40 (agile, magical, reach 30 feet)\n__Damage__  4d8 + 19 slashing"

  - name: "Melee"
    desc: "`pf2:1` Tail +40 (agile, magical, reach 30 feet)\n__Damage__  4d6 + 19 bludgeoning plus improved-grab"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (fire,primal) The tor linnorm expels a @Template[cone|distance:60] of flame and ash dealing 20d6 fire damage to creatures within the area (DC 46 Reflex check save). At the start of the tor linnorm's next turn, the area affected by the breath weapon is covered in thick, scorching smoke that burns both the lungs and eyes, dealing an additional 10d6 fire damage to all creatures in the area (DC 46 Reflex check save). A creature that spends an entire round in the smoke with open eyes must succeed at a DC 44 Fortitude check save or is [[Conditions/Blinded|Blinded]] for 1 minute. The smoke dissipates after 1 minute; in strong winds, the smoke dissipates in 5 rounds, and in more powerful winds, it may clear even more quickly.\n\nThe tor linnorm can't use Breath Weapon again for 1d4 rounds."

  - name: "[[Bestiary Ability Glossary/Constrict|Constrict]]"
    desc: "`pf2:1`  3d6+21 bludgeoning, DC 46 Fortitude check save\n\n* * *\n"

  - name: "Slashing Claws"
    desc: "`pf2:1`  A tor linnorm makes four Strikes with its claws, each against a different target. These attacks count toward the tor linnorm's multiple attack penalty, but the multiple attack penalty doesn't increase until after the tor linnorm makes all its attacks."

  - name: "Tor Linnorm Venom"
    desc: " (fire,injury,poison) **Saving Throw** DC 44 Fortitude check\n* * *\n\n**Maximum Duration** 10 rounds\n\n**Stage 1** 8d6 fire damage and [[Conditions/Drained|Drained 1]]\n\n**Stage 2** 12d6 fire damage and [[Conditions/Drained|Drained 2]]"
