...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.Fzn4jHusVeyytgfx" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/dragons/dragon-copper-adult.webp| ]]
...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (acid,arcane) The copper dragon breathes in one of two ways.\n\nThe dragon can't use Breath Weapon again for 1d4 rounds.\n\n*   **Acid** The dragon breathes acid in a @Template[line|distance:80|traits:acid,arcane,evocation,damaging-effect] that deals 13d6 acid damage (DC 32 Reflex check save).\n*   **Slowing Gas** The dragon breathes a @Template[line|distance:80|traits:arcane,transmutation] of slowing gas. Each creature in the area must succeed at a DC 32 Fortitude check save or be [[Conditions/Slowed|Slowed 1]] for 1 round (or [[Conditions/Slowed|Slowed 2]] on a critical failure)."
