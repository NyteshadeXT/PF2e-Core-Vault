---
title: "Chimera (Blue Dragon)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.x81PGKEsOtPquFVa" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/bestial/mythological/chimera-blue.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Dragon Jaws +20 ()\n__Damage__  2d6 + 9 piercing 2d6 electricity"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane) The chimera breathes a 60-foot line of electricity that deals 9d6 electricity damage to all creatures in the area (DC 26 Reflex check save).\nThe chimera can't use Breath Weapon again for 1d4 rounds."

  - name: "Draconic Bite"
    desc: "  A chimera's blue dragon head deals an extra 2d6 electricity damage _(already included)_."
