...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.DolNTN9s2p79N8Cy" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/dragons/dragon-gold-young.webp| ]]
...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane,fire) The gold dragon breathes in one of two ways.\n\nThe dragon can't use Breath Weapon again for 1d4 rounds.\n\n*   **Flame** The dragon breathes a blast of flame in a @Template[cone|distance:30|traits:arcane,evocation,fire,damaging-effect] that deals 11d6 fire damage (DC 31 Reflex check save).\n*   **Weakening Gas** The dragon breathes a blast of weakening gas. Each creature within a @Template[cone|distance:30|traits:arcane,necromancy] must succeed at a DC 31 Fortitude check save or become [[Conditions/Enfeebled|Enfeebled 1]] for 1 minute (or [[Conditions/Enfeebled|Enfeebled 2]] on a critical failure)."
