...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.VEnjCj4geJBzTgBJ" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/dragons/dragon-gold-ancient.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Jaws +38 (fire, magical, reach 20 feet)\n__Damage__  4d12 + 17 piercing 4d6 fire"
  ...
  - name: "Melee"
    desc: "`pf2:1` Horns +36 (agile, magical, reach 20 feet)\n__Damage__  2d12 + 15 piercing"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane,fire) The gold dragon breathes in one of two ways.\n\nThe dragon can't use Breath Weapon again for 1d4 rounds.\n\n*   **Flame** The dragon breathes a blast of flame in a @Template[cone|distance:50|traits:arcane,evocation,fire,damaging-effect] that deals 20d6 fire damage (DC 44 Reflex check save).\n*   **Weakening Gas** The dragon breathes a blast of weakening gas. Each creature within a @Template[cone|distance:50|traits:arcane,necromancy] must succeed at a DC 44 Fortitude check save or become [[Conditions/Enfeebled|Enfeebled 3]] for 1 minute (or [[Conditions/Enfeebled|Enfeebled 4]] on a critical failure)."
