...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.qHqhUWeNUZRET9xV" 
tags:
...
attacks:
  ...
  - name: "Worry"
    desc: "`pf2:1` (attack) **Requirements** The dire wolf has a creature [[Conditions/Grabbed|Grabbed]] with its jaws.\n**Effect** The dire wolf fiercely shakes the grabbed creature with its teeth, dealing 1d10+2 damage (DC 20 Fortitude check save)."
