...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (acid,arcane) The copper dragon breathes in one of two ways.\n\nThe dragon can't use Breath Weapon again for 1d4 rounds.\n\n*   **Acid** The dragon breathes acid in a @Template[line|distance:100|traits:acid,arcane,evocation,damaging-effect] that deals 18d6 acid damage (DC 38 Reflex check save).\n*   **Slowing Gas** The dragon breathes a @Template[line|distance:100|traits:arcane,transmutation] of slowing gas. Each creature in the area must succeed at a DC 38 Fortitude check save or be [[Conditions/Slowed|Slowed 1]] for 1 round (or [[Conditions/Slowed|Slowed 2]] on a critical failure)."

  - name: "Mass Laughter"
    desc: "`pf2:2` (arcane,emotion,mental) **Frequency** once per day\n* * *\n\n**Effect** The copper dragon tells a fantastic joke. Each creature in a @Template[emanation|distance:100] must succeed at a DC 39 Will check save or suffer the effects of a 9th-rank [[Spells/Laughing Fit|Laughing Fit]] spell for 1 minute."
