...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane) The chimera breathes a @Template[line|distance:60] of acid that deals 9d6 acid damage to all creatures in the area (DC 26 Reflex check save).\n\nThe chimera can't use Breath Weapon again for 1d4 rounds."
