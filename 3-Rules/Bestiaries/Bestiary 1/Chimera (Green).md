...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane) The chimera breathes a @Template[cone|distance:30] of poison that deals 9d6 poison damage to all creatures in the area (DC 26 Fortitude check save).\n\nThe chimera can't use Breath Weapon again for 1d4 rounds."
