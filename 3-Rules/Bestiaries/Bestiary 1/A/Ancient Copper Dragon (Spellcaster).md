---
title: "Ancient Copper Dragon (Spellcaster)"
obsidianUIMode: preview
noteType: pf2eMonster
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary.Actor.qGvK4f8Clc6dOwLU" 
tags:
...
statblock: inline
name: "Ancient Copper Dragon (Spellcaster)"
level: 17
license: OGL
---
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/dragons/dragon-copper-ancient.webp| ]]
...
abilities_mid:
  ...
  - name: "Slow Aura"
    desc: " (arcane,aura) 10 feet. Each creature that ends its turn in the aura must succeed at a DC 37 Will check saving throw or be [[Conditions/Slowed 1|Slowed 1]] for 1 round (or [[Conditions/Slowed 1|Slowed 2]] on a critical failure). The copper dragon can turn this aura on or off with a single action, which has the concentrate trait, and can choose not to affect allies within the aura."
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Jaws +33 (acid, magical, reach 15 feet)\n__Damage__  3d10 + 16 piercing 3d8 acid"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (acid,arcane) The copper dragon breathes in one of two ways.\nThe dragon can't use Breath Weapon again for 1d4 rounds.\n*   **Acid** The dragon breathes acid in a 100-foot line that deals 18d6 acid damage (DC 38 Reflex check save).\n*   **Slowing Gas** The dragon breathes a 100-foot line of slowing gas. Each creature in the area must succeed at a DC 38 Fortitude check save or be [[Conditions/Slowed 1|Slowed 1]] for 1 round (or [[Conditions/Slowed 1|Slowed 2]] on a critical failure)."
