...
token: [[modules/pf2e-tokens-bestiaries/portraits/fey/nuckelavee.webp| ]]
...
attacks:
  ...
  - name: "Blight Breath"
    desc: "`pf2:2` (disease,poison,primal) The nuckelavee breathes a @Template[cone|distance:30] of foulness, dealing 8d6 void damage to living creatures in the area with a DC 28 Fortitude check save. A creature that fails also takes 2d6 bleed damage.\n\nThe nuckelavee can't use Blight Breath again for 1d4 rounds."
