...
attacks:
  ...
  - name: "Sticky Spores"
    desc: "  A creature hit by a terotricus's spores takes a –10-foot status penalty to all its Speeds for 1 minute. If the Strike was a critical hit, the creature is also [[Conditions/Immobilized|Immobilized]] until it [[Actions/escape dc=40|escape dc=40]]{Escapes (DC 40)}.\n\n[[Bestiary Effects/Effect_ Sticky Spores|Effect: Sticky Spores]]"
