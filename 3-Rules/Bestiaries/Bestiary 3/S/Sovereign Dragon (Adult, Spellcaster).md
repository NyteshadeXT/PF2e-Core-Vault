...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary-3.Actor.WPRjynFmJ2p1MnT3" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/dragons/dragon-sovereign-adult.webp| ]]
...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (mental,occult) The dragon unleashes a roar charged with psychic energy, dealing 16d6 mental damage in a @Template[cone|distance:40] (DC 36 Will check save).\n\nThe dragon can't use Breath Weapon again for 1d4 rounds."

  - name: "Gleaming Armor"
    desc: "`pf2:1` (light,occult) **Frequency** once per hour\n* * *\n\n**Effect** The dragon's golden armor glows with a protective golden light. The dragon gains a +2 status bonus to AC and resistance 15 to energy damage. Each enemy in a @Template[emanation|distance:20] must succeed at a DC 36 Fortitude check save or be [[Conditions/Dazzled|Dazzled]].\n\nAll these effects last until the end of the dragon's next turn.\n\n[[Bestiary Effects/Effect_ Gleaming Armor|Effect: Gleaming Armor]]"
