...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary-3.Actor.mbu0D45HPRNAwgEU" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/fiendish/devil/munagola.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Flaming Greataxe +24 (fire, magical, sweep, unholy)\n__Damage__  2d12 + 13 slashing 1d6 spirit"

  - name: "Melee"
    desc: "`pf2:1` Horn +23 (agile, magical, unarmed, unholy)\n__Damage__  2d8 + 13 piercing 1d6 spirit"

  - name: "Ranged"
    desc: "`pf2:1` Flaming Composite Longbow +23 (deadly d10, fire, magical, range increment 100 feet, reload 0, unholy, volley 30 ft.)\n__Damage__  2d8 + 6 piercing 1d6 spirit"
