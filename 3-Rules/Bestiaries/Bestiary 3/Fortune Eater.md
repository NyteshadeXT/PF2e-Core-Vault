...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary-3.Actor.kU0ZXzbHqHUIND6m" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/undead/ghostly/fortune-eater.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Ghostly Longsword +17 (finesse, magical, versatile p)\n__Damage__  1d8 + 8 slashing 1d8 void"

  - name: "Melee"
    desc: "`pf2:1` Ghostly Light Mace +17 (agile, finesse, magical, shove)\n__Damage__  1d4 + 8 bludgeoning 1d8 void"

  - name: "Ranged"
    desc: "`pf2:1` Ghostly Longbow +17 (deadly d10, magical, range increment 100 feet, volley 30 ft.)\n__Damage__  1d8 + 4 piercing 1d8 void"
