...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary-3.Actor.OiMWiQQuBYt6Yc73" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/dragons/dragon-underworld-adult.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Jaws +24 (magical, reach 10 feet)\n__Damage__  2d8 + 13 piercing"

  - name: "Melee"
    desc: "`pf2:1` Claw +24 (adamantine, agile, magical)\n__Damage__  2d8 + 13 slashing plus adamantine-claws,grab"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane,fire) The dragon breathes a blast of fire that explodes in a @Template[burst|distance:25] within 50 feet, dealing 10d6 fire damage (DC 30 Reflex check save). Creatures that fail the save also take 2d6 persistent fire.\n\nThe dragon can't use Breath Weapon again for 1d4 rounds."
