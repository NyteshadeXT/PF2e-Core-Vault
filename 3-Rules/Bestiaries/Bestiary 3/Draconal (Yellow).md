...
token: [[modules/pf2e-tokens-bestiaries/portraits/divine/agathion/draconal-yellow.webp| ]]
...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (divine) The draconal breathes a blast of energy that deals 21d6 acid damage to creatures they choose to damage in a @Template[cone|distance:60] (DC 44 Reflex check save).\n\nThey can make this effect nonlethal for selected creatures in the area or choose not to damage certain creatures at all.\n\nThey can't use Breath Weapon again for 1d4 rounds."
