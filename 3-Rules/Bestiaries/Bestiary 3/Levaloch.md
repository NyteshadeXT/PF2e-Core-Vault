...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary-3.Actor.e6r8AGxfp8PDXaZk" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/fiendish/devil/levaloch.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Trident +19 (magical, unholy)\n__Damage__  2d8 + 9 piercing plus merciless-thrust 1d6 spirit plus merciless-thrust"

  - name: "Ranged"
    desc: "`pf2:1` Trident +16 (magical, thrown 20 ft., unholy)\n__Damage__  2d8 + 9 piercing 1d6 spirit"

  - name: "Ranged"
    desc: "`pf2:1` Barbed Net +16 (magical, range increment 20 feet, unholy)\n__Damage__ "
