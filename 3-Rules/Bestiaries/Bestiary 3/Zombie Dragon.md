...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/undead/zombie-dragon.webp| ]]
...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2`  The zombie dragon breathes a wave of fetid viscera that deals 5d6 bludgeoning + 5d6 poison damage (DC 28 Reflex check save). A creature that critically fails is also [[Conditions/Sickened|Sickened 2]].\n\nThe zombie dragon can't use Breath Weapon again for 1d4 rounds."
