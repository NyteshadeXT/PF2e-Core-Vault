...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary-3.Actor.YfosnJUwR0fSV7a8" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/dragons/dragon-underworld-young.webp| ]]
...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane,fire) The dragon breathes a blast of fire that explodes in a @Template[burst|distance:20] within 40 feet, dealing 7d6 fire damage (DC 25 Reflex check save). Creatures that fail the save also take 1d6 persistent fire.\n\nThe dragon can't use Breath Weapon again for 1d4 rounds."
