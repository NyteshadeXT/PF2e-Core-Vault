...
attacks:
  ...
  - name: "**Melee** `pf2:1` Fist"
    desc: "+25 (agile, nonlethal, reach 10 feet, unarmed)\n__Damage__  3d8 + 13 bludgeoning"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane) **Frequency** once per day.\n* * *\n\n**Effect** The calikang breathes a blast of energy that deals 13d6 damage to creatures in a 60-foot line (DC 28 Reflex check save). The calikang can choose the damage type each time: acid, cold, electricity, fire, or sonic.\n\nIncrease the die size to d8 if the calikang chooses electricity."
