...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-npc-core.Actor.a36bfgbqp1lt2bik" 
tags:
...
attacks:
  ...
  - name: "Pickpocket"
    desc: "  For an urchin, the DC to [[Actions/steal|steal]] or [[Actions/palm-an-object|palm-an-object]] isn't increased by 5 for an item that's closely guarded. They can Steal objects that would be extremely noticeable or time-consuming to remove (like worn shoes, armor, or actively wielded objects)."
