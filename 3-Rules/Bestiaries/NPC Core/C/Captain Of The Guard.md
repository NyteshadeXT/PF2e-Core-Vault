...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-npc-core.Actor.vEdg4AXGWfet1Cgy" 
tags:
...
attacks:
  ...
  - name: "Shielded Advance"
    desc: "`pf2:1`  **Requirements** The captain of the guard has their shield raised\n* * *\n\n**Effect** The captain of the guard presses forward, using their shield to push back foes. The captain Strides and Shoves, in either order. The multiple attack penalty doesn't apply to this [[Actions/Shove|Shove]], though the Shove does count toward the captain's multiple attack penalty."
