...
abilities_mid:
  ...
  - name: "Deafening Reverb"
    desc: "`pf2:r` (divine,sonic) **Trigger** A creature sensed by the curtain caller Casts a Spell with the auditory or sonic trait;\n* * *\n\n**Effect** The curtain caller bounces some of the sound waves into a powerful echo, hitting the triggering creature with a deafening reverb that deals 6d6 sonic damage. The creature must attempt a DC 26 Fortitude save.\n* * *\n\n**Critical Success** The creature takes no damage.\n\n**Success** The creature takes half damage.\n\n**Failure** The creature takes full damage and is [[Conditions/Clumsy|Clumsy 1]] for 1 minute.\n\n**Critical Failure** The creature takes double damage and is [[Conditions/Clumsy|Clumsy 2]] and [[Conditions/Deafened|Deafened]] for 1 minute."
