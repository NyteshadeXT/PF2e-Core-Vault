...
abilities_mid:
  ...
  - name: "Tortoise Formation"
    desc: "`pf2:1`  The arrongtata swarm aligns its shield faces effectively in every direction to protect itself. When the arrongtata swarm gets into Tortoise Formation, it gains a +2 circumstance bonus to AC and Reflex saves. While in Tortoise Formation, the arrongtata swarm is [[undefined]]. The Tortoise Formation remains in effect until the start of the swarm's next turn. If necessary, the arrongtata swarm can exit Tortoise Formation as a free action.\n\n[[Effects/Effect_ Tortoise Formation|Effect: Tortoise Formation]]"
