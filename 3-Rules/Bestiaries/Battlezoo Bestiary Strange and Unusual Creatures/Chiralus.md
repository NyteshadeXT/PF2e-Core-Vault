...
abilities_top:
  ...
  - name: "Reversed Speech"
    desc: "  A chiralus speaks and writes backwards, which makes it exceedingly difficult to understand what it's saying, requiring a successful DC 20 Society check check (to Decipher Writing when used on written text)"
