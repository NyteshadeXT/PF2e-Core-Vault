...
abilities_top:
  ...
  - name: "Cloud of Possibility"
    desc: " (arcane,teleportation) A possibility golem simultaneously exists and does not exist in every space within a 60 foot by 60 foot square area. Because of this, other creatures can move through its space freely, though the space is difficult terrain for other creatures. As it continually exists and doesn't exist in each space, the possibility golem is always Hidden. Even _See Invisibility_ won't reveal it, although _Dimensional Lock_ or similar magic reduces the possibility golem to the usual space of a Large creature, 10 feet by 10 feet. A possibility golem's reach extends from and within its Cloud of Possibility."
