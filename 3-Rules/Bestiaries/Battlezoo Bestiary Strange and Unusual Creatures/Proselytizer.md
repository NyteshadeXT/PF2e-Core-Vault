...
abilities_top:
  ...
  - name: "Painsight"
    desc: " (divine) A proselytizer automatically knows whether a creature it sees has any of the Doomed, Dying, and Wounded conditions, as well as the value of those conditions."

abilities_mid:
  - name: ""
  - name: "Pain Link"
    desc: "`pf2:r` (divine,nonlethal) **Trigger** The proselytizer takes damage and has a creature Grabbed or Restrained with its chain\n**Effect** The proselytizer shares its pain with the grappled creature, causing the creature to take mental damage equal to the total triggering damage the proselytizer took, with a DC 36 Fortitude check save."

  - name: "Unnerving Gaze"
    desc: " (aura,divine,fear,mental,visual) 30 feet. When a creature ends its turn in the aura, it must succeed at a DC 33 Will check save or become Frightened 1."
