...
attacks:
  - name: "Melee Jaws"
    desc: "`pf2:1` Jaws +17 ([[magical]], [[poison]]) __Damage__ 2d10+5 piercing plus 1d4 persistent poison"

  - name: "Melee Claw"
    desc: "`pf2:1` Claw +15 ([[magical]], [[agile]]) __Damage__ 2d6+5 slashing"

  - name: "Melee Tail Swipe"
    desc: "`pf2:1` Tail Swipe +14 ([[magical]], [[reach|Reach 10ft.]], [[trip]]) __Damage__ 2d8+5 bludgeoning <br><br><blockquote>__Breakable__ **AC** 22; **HP** 18; **Effect** The Wroggi loses access to its **Tail Swipe** attack. It also becomes [[Off-Guard]] for 1 round after the break due to imbalance.</blockquote>"

sourcebook: "Monster Hunter Conversion"
```


## Encounter Table: Great Wroggi
```encounter-table
name: Great Wroggi
creatures:
  - 1: Great Wroggi
