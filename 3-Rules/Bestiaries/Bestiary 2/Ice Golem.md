...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary-2.Actor.tieZOKf2qX7GsL9H" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/constructed/golem/ice-golem.webp| ]]
...
abilities_mid:
  ...
  - name: "Icy Demise"
    desc: " (arcane,cold) When an ice golem is destroyed, its body explodes in a blast of frigid air and razor-sharp ice, dealing 2d6 slashing damage and 2d6 cold damage to creatures in a @Template[emanation|distance:20], with a DC 19 Reflex check save."
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Fist +15 (magical, versatile p)\n__Damage__  2d6 + 7 bludgeoning 1d6 cold"

  - name: "Breath Weapon"
    desc: "`pf2:2` (arcane,cold) The ice golem exhales a blast of freezing mist that deals 6d6 cold damage in a @Template[cone|distance:30] (DC 22 Reflex check save).\n\nIt can't use Breath Weapon again for 1d4 rounds."
