...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary-2.Actor.Y5uPBnABTaAnpdqz" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/dragons/dragon-umbral-young.webp| ]]
...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (primal,void) The dragon breathes a blast of darkness that deals 12d6 void damage in a @Template[cone|distance:30] (DC 30 Reflex check save).\n\nThey can't use Breath Weapon again for 1d4 rounds.\n\nUndead creatures take 14d6 force damage instead of the void damage."
