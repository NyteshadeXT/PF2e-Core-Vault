...
token: [[modules/pf2e-tokens-bestiaries/portraits/elemental/air/behir.webp| ]]
...
attacks:
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (electricity,primal) The behir breathes lightning that deals 9d6 electricity damage in an @Template[line|distance:60] (DC 27 Reflex check save).\n\nIt can't use Breath Weapon again for 1d4 rounds."
