...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary-2.Actor.wxBQsGLdti2xcGVT" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/aberrant/eldritch/neothelid.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Rasping Tongue +28 (agile, fatal d10, reach 25 feet)\n__Damage__  3d8 + 13 slashing"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (acid,occult) The neothelid breathes a spray of acid that deals 16d6 acid damage in a @Template[cone|distance:60] (DC 38 Reflex check save).\n\nThe neothelid can't use Breath Weapon again for 1d4 rounds."
