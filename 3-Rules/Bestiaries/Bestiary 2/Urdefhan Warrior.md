...
token: [[modules/pf2e-tokens-bestiaries/portraits/humanoid/darklands/urdefhan-warrior.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Rhoka Sword +12 (deadly d8, two-hand d10)\n__Damage__  1d8 + 6 slashing"

  - name: "Melee"
    desc: "`pf2:1` Jaws +12 ()\n__Damage__  1d6 + 6 piercing plus wicked-bite"

  - name: "Ranged"
    desc: "`pf2:1` Composite Longbow +10 (deadly d10, propulsive, range increment 100 feet, volley 30 ft.)\n__Damage__  1d8 + 4 piercing"
