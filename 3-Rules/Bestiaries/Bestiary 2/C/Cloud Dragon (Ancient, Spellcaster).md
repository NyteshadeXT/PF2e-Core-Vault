...
cssClasses: pf2e
aliases: "Compendium.pf2e.pathfinder-bestiary-2.Actor.8MQXM56Rm0rmzaxY" 
tags:
...
token: [[modules/pf2e-tokens-bestiaries/portraits/draconic/dragons/dragon-cloud-ancient.webp| ]]
...
attacks:
  ...
  - name: "Melee"
    desc: "`pf2:1` Horn +34 (deadly d12, magical, reach 20 feet)\n__Damage__  3d12 + 17 piercing"
  ...
  - name: "Breath Weapon"
    desc: "`pf2:2` (electricity,primal) The dragon breathes a thundercloud that deals 20d6 electricity damage in a @Template[cone|distance:60] (DC 41 Reflex check save). This cloud remains in the area for 1d4 rounds, with the effects of [[Spells/Mist|Mist]]. A creature that ends its turn inside of the cloud takes 10d6 electricity damage (DC 41 Reflex check save).\n\nThe cloud dragon can't use Breath Weapon again for 1d4 rounds."
