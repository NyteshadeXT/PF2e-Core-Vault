...
Illusions create the semblance of something real, fooling the eyes, ears, and other senses. They almost always have the [mental](3-rules/trait%20reference/m/mental.md "Mental Effect Trait") trait, and depending on how the illusion is perceived, they might also have the [auditory](3-rules/trait%20reference/a/auditory.md "Auditory Effect Trait") or [visual](3-rules/trait%20reference/v/visual.md "Visual Effect Trait") trait.
