...
You're sleeping or have been knocked out. You can't act. You take a –4 status penalty to AC, [[Skills#Perception|Perception]], and Reflex saves, and you have the [[Blinded]] and [[Off-Guard]] conditions. When you gain this condition, you fall [[Prone]] and drop items you're holding unless the effect states otherwise or the GM determines you're positioned so you wouldn't.
...
*   Loud noise around you might wake you. At the start of your turn, you automatically attempt a [[Skills#Perception|Perception]] check against the noise's DC (or the lowest DC if there is more than one noise), waking up if you succeed. If creatures are attempting to stay quiet around you, this Perception check uses their [[Skills#Stealth|Stealth]] DCs. Some effects make you sleep so deeply that they don't allow you this Perception check.
